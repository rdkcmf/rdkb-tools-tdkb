...
class CosaMTA : public RDKTestStubInterface, public AbstractServer<CosaMTA>
{
	public:
        ...
        CosaMTA(TcpSocketServer &ptrRpcServer) : AbstractServer <CosaMTA>(ptrRpcServer)
		{
			...
			this->bindAndAddMethod(Procedure("CosaMTA_DectGetEnable", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "Value", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectGetEnable);
			this->bindAndAddMethod(Procedure("CosaMTA_DectSetEnable", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "Value", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectSetEnable);
			this->bindAndAddMethod(Procedure("CosaMTA_DectGetRegistrationMode", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "Value", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectGetRegistrationMode);
			this->bindAndAddMethod(Procedure("CosaMTA_DectSetRegistrationMode", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "Value", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_DectSetRegistrationMode);
			this->bindAndAddMethod(Procedure("CosaMTA_GetDect", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "bufferType", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_GetDect);
			this->bindAndAddMethod(Procedure("CosaMTA_GetDectPIN", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "bufferType", JSON_INTEGER, NULL), &CosaMTA::CosaMTA_GetDectPIN);
			this->bindAndAddMethod(Procedure("CosaMTA_SetDectPIN", PARAMS_BY_NAME, JSON_STRING, "handleType", JSON_INTEGER, "bufferType", JSON_INTEGER, "value", JSON_STRING, NULL), &CosaMTA::CosaMTA_SetDectPIN);
