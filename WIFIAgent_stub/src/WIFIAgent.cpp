...
void WIFIAgent::WIFIAgent_SetMultiple(IN const Json::Value& req, OUT Json::Value& response)
{
   ...
   if ((!strncmp(paramlist[0], "Device.WiFi.Radio.1.", 20)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.1.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.1.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.3.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.3.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.5.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.5.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.7.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.7.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.9.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.9.", 19)))
    ...
    else if ((!strncmp(paramlist[0], "Device.WiFi.Radio.2.", 20)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.2.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.2.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.4.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.4.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.6.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.6.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.8.", 26)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.8.", 19)) || (!strncmp(paramlist[0], "Device.WiFi.AccessPoint.10.", 27)) || (!strncmp(paramlist[0], "Device.WiFi.SSID.10.", 20)))
    {
        printf("Apply the wifi settings for 5GHZ\n");
        retVal = ssp_setParameterValue((char *)"Device.WiFi.Radio.2.X_CISCO_COM_ApplySetting",(char *)"true",(char *)"boolean",commit);
    }
