...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_MTAAGENT_GetHealth</name>
  <primitive_test_id/>
  <primitive_test_name>MTA_agent_GetHealth</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_MTAAGENT_13 - To Validate "Get Component Helath" API for MTA Agent</synopsis>
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_MTAAGENT_GetHealth</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MTAAGENT_GetHealth');
