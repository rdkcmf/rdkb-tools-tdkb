...
<xml>
  ...
  <name>TS_DSLHAL_GetXRdk_Nlm</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id> </primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>DSLHAL_GetXRdk_Nlm</primitive_test_name>
  <!--  -->
  <primitive_test_version>1</primitive_test_version>
  <!--  -->
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the RDK NLM value of DSL HAL</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get the RDK NLM value of DSL HAL</test_objective>
...
7. Unload the DSL HAL Module</automation_approch>
    <expected_output>Should be able to get the DSL RDK NLM value</expected_output>
    <priority>High</priority>
    <test_stub_interface>dslhal</test_stub_interface>
    <test_script>TS_DSLHAL_GetXRdk_Nlm</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_DSLHAL_GetXRdk_Nlm');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj = obj.createTestStep('DSLHAL_GetXRdk_Nlm');
        ...
        if expectedresult in actualresult:
            ...
            print "EXPECTED RESULT 2: dslGetXRdk_Nlm operation should be success ";
            print "ACTUAL RESULT 2: dslGetXRdk_Nlm operation was success ,echotonoiseratio value is: ",details
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
            ...
            print "TEST STEP 2: Get the DSL Line Stats";
            print "EXPECTED RESULT 2: dslGetXRdk_Nlm operation should be success ";
            print "ACTUAL RESULT 2: dslGetXRdk_Nlm operation was Failed ";
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
    else:
        #Set the result status of execution
