...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_ADVANCEDCONFIG_11</test_case_id>
    <test_objective>To verify, Advanced -&gt; Port Triggering -&gt; ADD rule must have options to configure port Triggering</test_objective>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ADVANCEDCONFIG_CheckAddRuleOptionsOfPortTriggering.py)
3.Execute the generated Script(TS_ADVANCEDCONFIG_CheckAddRuleOptionsOfPortTriggering.py) using execution page of  Test Manager GUI
...
Check if Advanced -&gt; Port Triggering -&gt; ADD rule must have options to configure port Triggering functionality works.
CheckPoint 2:
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_CheckAddRuleOptionsOfPortTriggering</test_script>
    <skipped>No</skipped>
			...
			temp = details.split(':');
				...
				## Enable Trigger 1 ##
		  		    ...
		  		    print "[TEST STEP 4]: Enabling the rule added";
		                    print "[EXPECTED RESULT 4]: Should enable the rule added successfully";
				    ...
				    print "[TEST STEP 4]: Enabling the rule added";
                                    ...
                                    print "[ACTUAL RESULT 4]: %s" %details;
                                    print "[TEST EXECUTION RESULT] : %s" %actualresult;
                                    print "Failed to enable the new rule added\n"
				...
				print "[TEST STEP 3]: Setting external port";
                                ...
                                print "[ACTUAL RESULT 3]: %s" %details;
                                print "[TEST EXECUTION RESULT] : %s" %actualresult;
                                print "Failure to add the port forwarding rule\n"
                        else:
