...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_ADVANCEDCONFIG_14</test_case_id>
...
Check if Port Triggering Rule with space and blank functionality works.
CheckPoint 2:
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_PortTriggeringRuleWithSpaceAndBlank</test_script>
    <skipped>No</skipped>
			...
			details = tdkTestObj.getResultDetails();
			    ...
			    alias = " ";
                            ...
                            if expectedresult in actualresult:
                                ...
                                tdkTestObj.setResultStatus("SUCCESS");
                                details = tdkTestObj.getResultDetails();
                                print "[TEST STEP 3]: Setting external port with whitespace as value";
                                print "[EXPECTED RESULT 3]: Should not set external port with whitespace as value";
                                print "[ACTUAL RESULT 3]: %s" %details;
                                print "[TEST EXECUTION RESULT] : %s" %actualresult;
                                print "Whitespace value cannot be set to port mapping rule\n"
                            else:
                                ...
                                print "[ACTUAL RESULT 3]: %s" %details;
                                print "[TEST EXECUTION RESULT] : %s" %actualresult;
                                print "Failed to validate whitespace value set \n "
                        else:
