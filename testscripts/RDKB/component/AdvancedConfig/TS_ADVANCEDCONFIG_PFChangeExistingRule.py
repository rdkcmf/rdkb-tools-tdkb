...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_ADVANCEDCONFIG_22</test_case_id>
    <test_objective>To validate "Advanced -&gt; Port Forwarding -&gt; Editing option for added services</test_objective>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ADVANCEDCONFIG_PFChangeExistingRule.py)
3.Execute the generated Script(TS_ADVANCEDCONFIG_PFChangeExistingRule.py) using execution page of  Test Manager GUI
