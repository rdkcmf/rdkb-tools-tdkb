...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_ADVANCEDCONFIG_8</test_case_id>
    <test_objective>To Validate  "Adding rule when Port Forwarding is disabled" functionality</test_objective>
...
( eg: "Device.NAT.PortMapping." )</input_parameters>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ADVANCEDCONFIG_PFDisabledAddRule.py)
3.Execute the generated Script(TS_ADVANCEDCONFIG_PFDisabledAddRule.py) using execution page of  Test Manager GUI
4.advancedconfigstub which is a part of TDK Agent process, will be in listening mode to execute TDK Component function named AdvancedConfig_Set,AdvancedConfig_AddObject through registered TDK advancedconfigstub function along with necessary Entry Values as arguments and AdvancedConfig_GetNames Will find the instance number of the row added and will process the function for the instance number generated..
...
Check if Adding rule when Port Forwarding is disabled functionality works.
CheckPoint 2:
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_PFDisabledAddRule</test_script>
    <skipped>No</skipped>
