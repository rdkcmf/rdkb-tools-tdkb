...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ADVANCEDCONFIG_TelnetEnable</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ADVANCEDCONFIG_20</test_case_id>
    <test_objective>To verify, Advanced -&gt; Remote Management -&gt; Global Management -&gt; Telnet -&gt; Enable/Disable</test_objective>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ADVANCEDCONFIG_TelnetEnable.py)
...
Check if "Advanced -&gt; Remote Management -&gt; Global Management -&gt; Telnet -&gt; Enable/Disable" functionality works.
CheckPoint 2:
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_TelnetEnable</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ADVANCEDCONFIG_TelnetEnable');
