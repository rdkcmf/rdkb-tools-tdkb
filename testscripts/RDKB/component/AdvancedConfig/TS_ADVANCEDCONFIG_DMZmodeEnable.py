...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>10</version>
  <name>TS_ADVANCEDCONFIG_DMZmodeEnable</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ADVANCEDCONFIG_1</test_case_id>
    <test_objective>To Validate "Enable or Disable DMZ mode" functionality</test_objective>
...
Type: bool, Value: True</input_parameters>
    <automation_approch>1.Configure the Function info in Test Manager GUI  which needs to be tested  
(AdvancedConfig_Set - func name - "If not exists already"
 advancedconfig - module name
 Necessary I/P args as Mentioned in Input)
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ADVANCEDCONFIG_DMZmodeEnable.py)
3.Execute the generated Script(TS_ADVANCEDCONFIG_DMZmodeEnable.py) using execution page of  Test Manager GUI
...
Check if DMZ mode is enabled or disabled.
CheckPoint 2:
...
TestManager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ADVANCEDCONFIG_DMZmodeEnable</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ADVANCEDCONFIG_DMZmodeEnable');
