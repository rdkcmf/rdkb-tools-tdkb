...
<xml>
  ...
  <name>TS_WEBPA_NotifyComp_SetInvalid_NotifyValue</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify that set-attributes request with notify value other than 0 and 1 should return "Invalid attributes" error message</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_30</test_case_id>
    <test_objective>To verify that set-attributes request with notify value other than 0 and 1 should return "Invalid attributes" error message</test_objective>
...
5. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_NotifyComp_SetInvalid_NotifyValue</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_NotifyComp_SetInvalid_NotifyValue');
