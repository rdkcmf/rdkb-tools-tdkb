...
<xml>
  ...
  <name>TS_WEBPA_EPON_GetDPoE_OamFrameRate_Entries</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check whether the number of entries in the table Device.DPoE.DPoE_OamFrameRate. is same as the value of Device.DPoE.DPoE_OamFrameRateNumberOfEntries</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_13</test_case_id>
    <test_objective>Check whether the number of entries in the table Device.DPoE.DPoE_OamFrameRate. is same as the value of Device.DPoE.DPoE_OamFrameRateNumberOfEntries</test_objective>
...
parseWebpaResponse</api_or_interface_used>
    <input_parameters>Device.DPoE.DPoE_OamFrameRate.
Device.DPoE.DPoE_OamFrameRateNumberOfEntries</input_parameters>
    <automation_approch>1. Load sysutil module
2. Configure WEBPA server to send get request for Device.DPoE.DPoE_OamFrameRateNumberOfEntries
3. Parse the WEBPA response
4. If webpa response status is SUCCESS, get operation was success otherwise failure
5. Check if no: of entries in Device.DPoE.DPoE_OamFrameRate. is the same as Device.DPoE.DPoE_OamFrameRateNumberOfEntries
6. Unload sysutil module</automation_approch>
    <except_output>the number of entries in the table Device.DPoE.DPoE_OamFrameRate. should be the same as the value of Device.DPoE.DPoE_OamFrameRateNumberOfEntries</except_output>
    <priority>High</priority>
    <test_stub_interface>sysutil</test_stub_interface>
    <test_script>TS_WEBPA_EPON_GetDPoE_OamFrameRate_Entries</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_EPON_GetDPoE_OamFrameRate_Entries');
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        queryParam = {"name":"Device.DPoE.DPoE_OamFrameRateNumberOfEntries"}
