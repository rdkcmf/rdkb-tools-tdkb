...
<xml>
  ...
  <name>TS_WEBPA_EPON_GetDPoE_FirmwareInfo</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Using webpa get the device firmware info from EPON parameters</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_7</test_case_id>
    <test_objective>Using webpa get the device firmware info from EPON parameters</test_objective>
...
parseWebpaResponse</api_or_interface_used>
    <input_parameters>Device.DPoE.DPoE_FirmwareInfo.bootVersion,Device.DPoE.DPoE_FirmwareInfo.bootCrc32,Device.DPoE.DPoE_FirmwareInfo.appVersion,Device.DPoE.DPoE_FirmwareInfo.appCrc32</input_parameters>
    <automation_approch>1. Load sysutil module
2. Configure WEBPA server to send get request for Device.DPoE.DPoE_FirmwareInfo.bootVersion,Device.DPoE.DPoE_FirmwareInfo.bootCrc32,Device.DPoE.DPoE_FirmwareInfo.appVersion,Device.DPoE.DPoE_FirmwareInfo.appCrc32
...
5. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_EPON_GetDPoE_FirmwareInfo</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_EPON_GetDPoE_FirmwareInfo');
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        queryParam = {"name":"Device.DPoE.DPoE_FirmwareInfo.bootVersion,Device.DPoE.DPoE_FirmwareInfo.bootCrc32,Device.DPoE.DPoE_FirmwareInfo.appVersion,Device.DPoE.DPoE_FirmwareInfo.appCrc32"}
