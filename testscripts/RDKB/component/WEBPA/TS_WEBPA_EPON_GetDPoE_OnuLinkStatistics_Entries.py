...
<xml>
  ...
  <name>TS_WEBPA_EPON_GetDPoE_OnuLinkStatistics_Entries</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check whether the number of entries in the table Device.DPoE.DPoE_OnuLinkStatistics. is same as the value of Device.DPoE.DPoE_OnuLinkStatisticsNumberOfEntries</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_14</test_case_id>
    <test_objective>Check whether the number of entries in the table Device.DPoE.DPoE_OnuLinkStatistics. is same as the value of Device.DPoE.DPoE_OnuLinkStatisticsNumberOfEntries</test_objective>
...
parseWebpaResponse</api_or_interface_used>
    <input_parameters>Device.DPoE.DPoE_OnuLinkStatistics.
Device.DPoE.DPoE_OnuLinkStatisticsNumberOfEntries</input_parameters>
...
5. Check if no: of entries in Device.DPoE.DPoE_OnuLinkStatistics. is the same as Device.DPoE.DPoE_OnuLinkStatisticsNumberOfEntries
6. Unload sysutil module</automation_approch>
    <except_output>the number of entries in the table Device.DPoE.DPoE_OnuLinkStatistics. is same as the value of Device.DPoE.DPoE_OnuLinkStatisticsNumberOfEntries</except_output>
    <priority>High</priority>
    <test_stub_interface>sysutil</test_stub_interface>
    <test_script>TS_WEBPA_EPON_GetDPoE_OnuLinkStatistics_Entries</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_EPON_GetDPoE_OnuLinkStatistics_Entries');
