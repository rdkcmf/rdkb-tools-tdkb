...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WEBPA_GetEthernetInterface</name>
  <primitive_test_id/>
  <primitive_test_name>WEBPA_Donothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Using webpa to get and set the Ethernet state.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_26</test_case_id>
    <test_objective>Using WEBPA get and set the state of Ethernet</test_objective>
...
10. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_GetEthernetInterface</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_GetEthernetInterface');
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        if "SUCCESS" in parsedResponse[0] and parsedResponse[1] != "":
              ...
              print "Ethernet Interface State: ",OrgValue;
              ...
              if "SUCCESS" in getResponse[0] and getResponse[1] != "" and getResponse[1]== flag:
                 ...
                 print "Ethernet Interface State: ",Value;
              else:
