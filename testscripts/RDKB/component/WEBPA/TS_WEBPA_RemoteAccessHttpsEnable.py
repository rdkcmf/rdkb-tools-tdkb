...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WEBPA_RemoteAccessHttpsEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WEBPA_Donothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Check the enable and disable feature  of remote management using https.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Using WEBPA get and set the state of Remote Management through Https.</test_objective>
...
webpaPreRequisite</api_or_interface_used>
    <input_parameters>Device.UserInterface.X_CISCO_COM_RemoteAccess.HttpsEnable</input_parameters>
...
10. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_RemoteAccessHttpsEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_RemoteAccessHttpsEnable');
