...
<xml>
  ...
  <name>TS_WEBPA_EPON_GetDPoE_ManufacturerInfo</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Using webpa get the device manufacturer info from EPON parameters</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_9</test_case_id>
    <test_objective>Using webpa get the device manufacturer info from EPON parameters</test_objective>
...
parseWebpaResponse</api_or_interface_used>
    <input_parameters>Device.DPoE.DPoE_ManufacturerInfo.info,Device.DPoE.DPoE_ManufacturerInfo.organizationName,Device.DPoE.DPoE_ManufacturerInfo.manufacturerDate</input_parameters>
    <automation_approch>1. Load sysutil module
2. Configure WEBPA server to send get request for Device.DPoE.DPoE_ManufacturerInfo.info,Device.DPoE.DPoE_ManufacturerInfo.organizationName,Device.DPoE.DPoE_ManufacturerInfo.manufacturerDate
...
5. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_EPON_GetDPoE_ManufacturerInfo</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_EPON_GetDPoE_ManufacturerInfo');
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        queryParam = {"name":"Device.DPoE.DPoE_ManufacturerInfo.info,Device.DPoE.DPoE_ManufacturerInfo.organizationName,Device.DPoE.DPoE_ManufacturerInfo.manufacturerDate"}
