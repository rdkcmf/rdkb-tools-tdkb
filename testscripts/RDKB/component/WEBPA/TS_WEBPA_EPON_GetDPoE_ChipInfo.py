...
<xml>
  ...
  <name>TS_WEBPA_EPON_GetDPoE_ChipInfo</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Using webpa get the device chip info from EPON parameters</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_6</test_case_id>
    <test_objective>Using webpa get the device chip info from EPON parameters</test_objective>
...
parseWebpaResponse</api_or_interface_used>
    <input_parameters>Device.DPoE.DPoE_ChipInfo.jedecId,Device.DPoE.DPoE_ChipInfo.chipModel,Device.DPoE.DPoE_ChipInfo.chipVersion</input_parameters>
    <automation_approch>1. Load sysutil module
2. Configure WEBPA server to send get request for Device.DPoE.DPoE_ChipInfo.jedecId,Device.DPoE.DPoE_ChipInfo.chipModel,Device.DPoE.DPoE_ChipInfo.chipVersion
...
5. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_EPON_GetDPoE_ChipInfo</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_EPON_GetDPoE_ChipInfo');
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        queryParam = {"name":"Device.DPoE.DPoE_ChipInfo.jedecId,Device.DPoE.DPoE_ChipInfo.chipModel,Device.DPoE.DPoE_ChipInfo.chipVersion"}
