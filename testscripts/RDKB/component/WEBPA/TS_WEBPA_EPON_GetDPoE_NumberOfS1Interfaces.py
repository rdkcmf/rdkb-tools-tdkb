...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WEBPA_EPON_GetDPoE_NumberOfS1Interfaces</name>
  <primitive_test_id/>
  <primitive_test_name>WEBPA_Donothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Using webpa get the device NumberOfS1Interfaces from EPON parameters</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_20</test_case_id>
    <test_objective>Using webpa get the device NumberOfS1Interfaces from EPON parameters</test_objective>
...
parseWebpaResponse</api_or_interface_used>
    <input_parameters>Device.DPoE.NumberOfS1Interfaces</input_parameters>
    <automation_approch>1. Load sysutil module
2. Configure WEBPA server to send get request for Device.DPoE.NumberOfS1Interfaces
...
5. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_EPON_GetDPoE_NumberOfS1Interfaces</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_EPON_GetDPoE_NumberOfS1Interfaces');
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        queryParam = {"name":"Device.DPoE.NumberOfS1Interfaces"}
