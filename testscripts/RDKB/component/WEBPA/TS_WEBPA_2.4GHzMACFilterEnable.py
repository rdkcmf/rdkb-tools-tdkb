...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WEBPA_2.4GHzMACFilterEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WEBPA_Donothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Check the enable and disable feature  of mac filter enable for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WEBPA_32</test_case_id>
    <test_objective>Using WEBPA get and set the state of Mac Filter for 2.4GHz</test_objective>
...
webpaPreRequisite</api_or_interface_used>
    <input_parameters>  Device.WiFi.AccessPoint.10001.X_CISCO_COM_MACFilter.Enable</input_parameters>
    <automation_approch>1. Load sysutil module
2. Configure WEBPA server to send get request for Device.WiFi.AccessPoint.10001.X_CISCO_COM_MACFilter.Enable.
...
10. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_2.4GHzMACFilterEnable</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        print "TEST STEP 1: Get and save the state of Mac Filter for 2.4 GHz"
        ...
        if "SUCCESS" in parsedResponse[0] and parsedResponse[1] != "":
              ...
              print "Mac Filter for 2.4 GHz's State: ",OrgValue;
              ...
              if "SUCCESS" in getResponse[0] and getResponse[1] != "" and getResponse[1]== flag:
                 ...
                 print "Mac Filter  for 2.4 GHz 's  State: ",Value;
              else:
