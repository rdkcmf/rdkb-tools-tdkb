...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WEBPA_ParentalControlManagedServicesEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WEBPA_Donothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Check the enable and disable feature  of parenatal control managed services</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Using WEBPA get and set the state of Managed Services</test_objective>
...
webpaPreRequisite</api_or_interface_used>
    <input_parameters>Device.X_Comcast_com_ParentalControl.ManagedServices.Enable</input_parameters>
    <automation_approch>1. Load sysutil module
2. Configure WEBPA server to send get request for  Device.X_Comcast_com_ParentalControl.ManagedServices.Enable
...
10. Unload sysutil module</automation_approch>
    ...
    <test_script>TS_WEBPA_ParentalControlManagedServicesEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBPA_ParentalControlManagedServicesEnable');
...
if "SUCCESS" in result.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        print "TEST STEP 1: Get and save the state of Parental Control Managed Services"
        queryParam = {"name":"Device.X_Comcast_com_ParentalControl.ManagedServices.Enable"}
        ...
        if "SUCCESS" in parsedResponse[0] and parsedResponse[1] != "":
              ...
              print "Parental Control Managed Service State: ",OrgValue;
              #toggling by using set
              print "TEST STEP 2: Toggling the value"
              if parsedResponse[1] == "false":
                 flag="true"
                 queryParam = {"name":"Device.X_Comcast_com_ParentalControl.ManagedServices.Enable","value":flag,"dataType":3}
              ...
              if "SUCCESS" in getResponse[0] and getResponse[1] != "" and getResponse[1]== flag:
                 ...
                 print "Parental Control Managed Service State: ",Value;
              else:
              ...
              queryParam = {"name":"Device.X_Comcast_com_ParentalControl.ManagedServices.Enable","value":OrgValue,"dataType":3}
              queryResponse = webpaQuery(obj, queryParam,"set")
              setResponse = parseWebpaResponse(queryResponse, 1,"set")
              tdkTestObj.executeTestCase("SUCCESS");
