...
<xml>
  ...
  <name>TS_SNMP_Set8MinusWifiPassphrase</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Wifi password can be from 8 to 64 characters. Test to set wifi passphrase with less than 8 characters</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_36</test_case_id>
    <test_objective>Wifi password can be from 8 to 64 characters. Test to set wifi passphrase with less than 8 characters</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_Set8MinusWifiPassphrase</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_Set8MinusWifiPassphrase');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if "=" in get_details:
        ...
        setDetails =snmplib.SnmpExecuteCmd("snmpset", commSetStr, "-v 2c", ".1.3.6.1.4.1.17270.50.2.2.3.3.1.3.10001 s pass", ipaddress);
