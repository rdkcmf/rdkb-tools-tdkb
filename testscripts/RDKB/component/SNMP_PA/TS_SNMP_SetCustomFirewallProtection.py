...
<xml>
  ...
  <name>TS_SNMP_SetCustomFirewallProtection</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To test whether the firewall protection can be customized or not</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_13</test_case_id>
    <test_objective>To set the custom firewall protection settings</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_SetCustomFirewallProtection</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_SetCustomFirewallProtection');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if "=" in actResponse :
        ...
        #Set the firewall protection as custom 
	print "snmpset to set the firewall protection as custom"
        actResponse =snmplib.SnmpExecuteCmd("snmpset", commSetStr, "-v 2c", "1.3.6.1.4.1.17270.50.2.4.1.1.0 i 4", ipaddress);
        sleep(5);
        actResponse =snmplib.SnmpExecuteCmd("snmpget", commGetStr, "-v 2c", "1.3.6.1.4.1.17270.50.2.4.1.1.0", ipaddress);
        ...
        if act_value and "4" in act_value:
            ...
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : SUCCESS"
	    #set the HttpBlockingEnable as true which is under custom settings 
	    ...
	    sleep(5);
            ...
            if act_value and "1" in act_value:
                ...
                print "EXPECTED RESULT 3: Command should return HttpBlockingEnable status as true";
