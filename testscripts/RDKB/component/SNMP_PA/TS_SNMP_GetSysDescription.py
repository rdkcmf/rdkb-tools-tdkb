...
<xml>
  ...
  <name>TS_SNMP_GetSysDescription</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>do snmpget for sysDescr</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_26</test_case_id>
    <test_objective>Test snmpget for sysDescr</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_GetSysDescription</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_GetSysDescription');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if "HW_REV" in actResponse and "VENDOR" in actResponse and "BOOTR" in actResponse and "SW_REV" in actResponse and "MODEL" in actResponse:
        ...
        print "TEST STEP 1:Execute snmpget for system description";
        print "EXPECTED RESULT 1: snmpget should get the system description values";
