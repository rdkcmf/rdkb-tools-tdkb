...
<xml>
  ...
  <name>TS_SNMP_GetErouter0MAC</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>With snmpget retrieve the Device eRouter0 MAC Address.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_21</test_case_id>
    <test_objective>With snmpget retrieve the Device eRouter0 MAC Address.</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_GetErouter0MAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_GetErouter0MAC');
