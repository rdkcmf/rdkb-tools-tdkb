...
<xml>
  ...
  <name>TS_SNMP_RemoteWebAccessEnable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To enable Remote Web Access via SNMP</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_04</test_case_id>
    <test_objective>To enable the Remote Web Access via snmp</test_objective>
...
snmpVersion : -v 2c
OID :1.3.6.1.4.1.17270.50.2.1.1.3.0</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_RemoteWebAccessEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_RemoteWebAccessEnable');
pamObj.configureTestCase(ip,port,'TS_SNMP_RemoteWebAccessEnable');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
    ...
    actResponse =snmplib.SnmpExecuteCmd("snmpget", commGetStr, "-v 2c", "1.3.6.1.4.1.17270.50.2.1.1.3.0", ipaddress);
    ...
    if "=" in actResponse :
        ...
        print "TEST STEP 1: snmpget request to get Remote WebAccess status";
        print "EXPECTED RESULT 1: Command should return Remote WebAccess status";
	...
	tdkTestObj = pamObj.createTestStep('pam_SetParameterValues');
        ...
        if expectedresult in actualresult:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Enable Remote WebAccess";
            print "EXPECTED RESULT 2: Should enable the Remote WebAccess successfully";
	    ...
	    actResponse =snmplib.SnmpExecuteCmd("snmpget", commGetStr, "-v 2c", "1.3.6.1.4.1.17270.50.2.1.1.3.0", ipaddress);
            ...
            if act_value and "1" in act_value:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 2: snmpget request to get  Remote WebAccess status";
                print "EXPECTED RESULT 2: Command should return  Remote WebAccess status as true";
	    ...
	    actResponse =snmplib.SnmpExecuteCmd("snmpset", commSetStr, "-v 2c", "1.3.6.1.4.1.17270.50.2.1.1.3.0 i %s" %org_value, ipaddress);
	    sleep(5);
            actResponse =snmplib.SnmpExecuteCmd("snmpget", commGetStr, "-v 2c", "1.3.6.1.4.1.17270.50.2.1.1.3.0", ipaddress);
		...
		#Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 3: snmpget request to get Remote WebAccess status";
                print "EXPECTED RESULT 3: Command should return  Remote WebAccess status";
