...
<xml>
  ...
  <name>TS_SNMP_v2cGETqueryInvalidCommString</name>
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_31</test_case_id>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_v2cGETqueryInvalidCommString</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_v2cGETqueryInvalidCommString');
