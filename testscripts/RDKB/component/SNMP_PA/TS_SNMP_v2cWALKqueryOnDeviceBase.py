...
<xml>
  ...
  <name>TS_SNMP_v2cWALKqueryOnDeviceBase</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify the snmpwalk command</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_12</test_case_id>
    <test_objective>To check the snmpwalk  query</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_v2cWALKquery</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_v2cWALKqueryOnDeviceBase');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    actResponse =snmplib.SnmpExecuteCmd("snmpwalk", communityString, "-v 2c", "1.3.6.1.4.1.17270.50.2.1.1", ipaddress);
    ...
    if "=" in actResponse :
        ...
        print "EXPECTED RESULT 1: Command should return all values";
