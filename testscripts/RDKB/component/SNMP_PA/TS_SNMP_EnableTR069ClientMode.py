...
snmpVersion : -v 2c
OID : 1.3.6.1.4.1.17270.50.3.1.1.0</input_parameters>
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
    ...
    if "=" in actResponse :
        ...
        print "TEST STEP 1: snmpget request to get TR069 Client Mode Status";
        print "EXPECTED RESULT 1: Command should return TR069 Client Mode status";
	...
	tdkTestObj = pamObj.createTestStep('pam_GetParameterValues');
	    ...
	    tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Get TR069 Client Mode Status";
            print "EXPECTED RESULT 2: Should get the TR069 Client Mode Status as true";
            ...
            if def_value and org_value in def_value:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 3: snmpget request to get TR069 Client Modestatus";
                print "EXPECTED RESULT 3: Command should return TR069 Client Mode status";
	    ...
	    #Set the result status of execution
            tdkTestObj.setResultStatus("FAILURE");
            print "TEST STEP 2: get TR069 Client Mode status";
            print "EXPECTED RESULT 2: Command should return TR069 Client Mode status as true";
