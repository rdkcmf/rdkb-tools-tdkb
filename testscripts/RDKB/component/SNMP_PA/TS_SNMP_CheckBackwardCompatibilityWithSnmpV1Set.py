...
<xml>
  ...
  <test_cases>
    ...
    <test_objective>To check the backward compatibility of snmpset</test_objective>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if "=" in actResponse :
        ...
        print "TEST STEP 1: snmpget request to get the values of given OID";
        print "EXPECTED RESULT 1: Command should return value of given OID";
