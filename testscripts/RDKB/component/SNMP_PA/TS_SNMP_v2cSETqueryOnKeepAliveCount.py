...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether value is being set successfully using snmpset</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_SNMP_PA_11</test_case_id>
    <test_objective>To check teh snmpset query</test_objective>
...
snmpVersion : -v 2c
OID : 1.3.6.1.4.1.17270.50.2.4.1.3.0</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_v2cSETquery</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if "=" in actResponse :
        ...
        print "TEST STEP 1: snmpget request to get current value of given OID";
        print "EXPECTED RESULT 1: Command should return current value of given OID";
        ...
        if act_value and "4" in act_value:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: snmpget request to get current value of given OID";
            print "EXPECTED RESULT 2: Command should return the value give to set";
            ...
            if def_value and org_value in def_value:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 3: snmpget request to get current value of given OID";
                print "EXPECTED RESULT 3: Command should return the value given to set";
