...
<xml>
  ...
  <name>TS_SNMP_SetXHSWifiPassword</name>
  ...
  <test_cases>
    ...
    <test_objective>To check if XHS wifi password can be reset</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SNMP_SetXHSWifiPassword</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_SNMP_SetXHSWifiPassword');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    pwd= "3571B4047466A01244";
    actResponse =snmplib.SnmpExecuteCmd("snmpset", communityString, "-v 2c", ".1.3.6.1.4.1.17270.50.2.2.3.1.1.2.10002 s %s" %pwd, ipaddress);
    tdkTestObj = obj.createTestStep('ExecuteCmd');
    tdkTestObj.executeTestCase("SUCCESS");
    sleep(5);
    if pwd not in actResponse:
	#Set the result status of execution
        tdkTestObj.setResultStatus("SUCCESS");
        print "TEST STEP 2: snmpset to set the XHS Wifi password";
        print "EXPECTED RESULT 2:  XHS Wifi password should not be modified";
