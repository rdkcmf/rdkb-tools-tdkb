...
<xml>
  ...
  <name>TDKB_PlatformHAL_SNMP_GetAllValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if all TR181 parameter values of Platform HAL (using SNMP) matching with its corresponding HAL API Values</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_HAL_10</test_case_id>
    <test_objective>To Check if all TR181 parameter values of Platform HAL (using SNMP) matching with its corresponding HAL API Values</test_objective>
...
PlatformHAL module's parameter xml should be available</pre_requisite>
    ...
    <automation_approch>1. Load tdkbtr181 module, PlatformHAL module and sysutil module
...
8. Unload modules</automation_approch>
    ...
    <test_script>TDKB_PlatformHAL_SNMP_GetAllValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
objhal.configureTestCase(ip,port,'TDKB_PlatformHAL_SNMP_GetAllValues');
obj.configureTestCase(ip,port,'TDKB_PlatformHAL_SNMP_GetAllValues');
sysobj.configureTestCase(ip,port,'TDKB_PlatformHAL_SNMP_GetAllValues');
