...
<xml>
  ...
  <name>TDKB_CMHAL_WEBPA_GetAllValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if all TR181 parameter values (using WEBPA) of CM matching with its corresponding HAL API Values</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_HAL_3</test_case_id>
    <test_objective>To Check if all TR181 parameter values (using WEBPA) of CM matching with its corresponding HAL API Values</test_objective>
...
8. Unload modules</automation_approch>
    ...
    <test_script>TDKB_CMHAL_WEBPA_GetAllValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
objhal.configureTestCase(ip,port,'TDKB_CMHAL_WEBPA_GetAllValues');
obj.configureTestCase(ip,port,'TDKB_CMHAL_WEBPA_GetAllValues');
sysobj.configureTestCase(ip,port,'TDKB_CMHAL_WEBPA_GetAllValues');
