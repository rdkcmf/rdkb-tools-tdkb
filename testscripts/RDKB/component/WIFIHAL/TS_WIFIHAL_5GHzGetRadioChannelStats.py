...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzGetRadioChannelStats</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetRadioChannelStats</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script is to find the radichannelstats of wifi_getRadioChannelStats() of 5ghz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_316</test_case_id>
    <test_objective>This test script is to find the radichannelstats of wifi_getRadioChannelStats() of 5ghz</test_objective>
...
2. Invoke wifi_getRadioPossibleChannels() and retrieve the possible radio channel list
3. Invoke wifi_getRadioChannelStats() for each of the radio channels and check if the stats are valid
4. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetRadioChannelStats</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetRadioChannelStats');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        if expectedresult in actualresult and details != "":
            ...
            valid_values = 0;
            failed_stats = [];
            print "\nTEST STEP 2 : Get the Radio channel statistics info for 5GHz using the HAL API wifi_getRadioChannelStats()";
            print "EXPECTED RESULT 2: wifi_getRadioChannelStats should return the radio channel statistics for 5GHz";
