...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_SetApAuthMode_Auto</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the authorization mode as auto for 2.4GHz and 5GHz and check if it is success</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_184</test_case_id>
    <test_objective>To set the authorization mode as auto for 2.4GHz and 5GHz and check if it is success</test_objective>
...
2. From Platform properities file, obtain the value for AP_AUTH_MODE_AUTO
...
5. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_SetApAuthMode_Auto</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_SetApAuthMode_Auto');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_SetApAuthMode_Auto');
