...
<xml>
  ...
  <name>TS_WIFIHAL_GetBSSColorEnabled_WithNullBuffer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Validate wifi_getBSSColorEnabled() with NULL buffer</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_473</test_case_id>
    <test_objective>Validate wifi_getBSSColorEnabled() with NULL buffer</test_objective>
...
2. Invoke wifi_getBSSColorEnabled() with NULL buffer
3. Check if api returns failure and exits gracefully
4. Unload wifihal module</automation_approch>
    <expected_output>wifi_getBSSColorEnabled() should return failure when invoked with a NULL buffer</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_GetBSSColorEnabled_WithNullBuffer</test_script>
    <skipped>No</skipped>
