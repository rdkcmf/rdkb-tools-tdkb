...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetApWpaEncryptionMode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check Wpa encryption mode enabled in device for 5GHz radio using wifi_getApWpaEncryptionMode and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_76</test_case_id>
    <test_objective>To check Wpa encryption mode enabled in device for 5GHz radio using wifi_getApWpaEncryptionMode HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetApWpaEncryptionMode.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetApWpaEncryptionMode.py) using execution page of  Test Manager GUI
...
5.WIFIHAL_GetOrSetParamStringValue function will call Ccsp Base Function named "ssp_WIFIHALGetOrSetParamStringValue", that inturn will call WIFIHAL Library Function wifi_getApWpaEncryptionMode() function
...
1:wifi_getApWpaEncryptionMode log from DUT should be available in Agent Console LogCheckPoint
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzGetApWpaEncryptionMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApWpaEncryptionMode');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApWpaEncryptionMode');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in sysloadmodulestatus.upper():
    ...
    if supportedApWpaEncryptionModes and expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            print "EXPECTED RESULT 2: Should successfully get the Ap Wpa EncryptionMode for 5GHz";
            print "ACTUAL RESULT 2: Successfully got the Ap Wpa EncryptionMode as %s for 5GHz"%mode;
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : SUCCESS";
            print "**************************************************";
            ...
            tdkTestObj.setResultStatus("FAILURE");
            print "**************************************************";
            print "TEST STEP 2: Get the Ap Wpa EncryptionMode for 5GHz";
            print "EXPECTED RESULT 2: Should successfully get the Ap Wpa EncryptionMode for 5GHz";
            print "ACTUAL RESULT 2: Failed to get the Ap Wpa EncryptionMode for 5GHz";
            print details;
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : FAILURE";
            print "**************************************************";
