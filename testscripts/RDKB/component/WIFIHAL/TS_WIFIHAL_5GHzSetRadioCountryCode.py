...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetRadioCountryCode</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get the RadioCountryCode for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_246</test_case_id>
    <test_objective>To set and get the RadioCountryCode for 5GHz</test_objective>
...
6.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetRadioCountryCode</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetRadioCountryCode');
	...
	if expectedresult in actualresult:
	    ...
	    if expectedresult in actualresult:
	        ...
	        if setCode == countryCode:
	            ...
	            print "TEST STEP: Compare the set and get Radio Country Codes for 5GHz"
