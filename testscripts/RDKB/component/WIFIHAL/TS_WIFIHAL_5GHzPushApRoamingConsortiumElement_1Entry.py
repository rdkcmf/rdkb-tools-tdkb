...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_WIFIHAL_5GHzPushApRoamingConsortiumElement_1Entry</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_446</test_case_id>
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzPushApRoamingConsortiumElement_1Entry</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPushApRoamingConsortiumElement_1Entry');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult :
        ...
        print "TEST STEP 2: Set RoamingConsortiumElement  with a single OUI for 5GHz";
        print "EXPECTED RESULT 2: Should successfully set RoamingConsortiumElement  with a single OUI for 5GHz";
