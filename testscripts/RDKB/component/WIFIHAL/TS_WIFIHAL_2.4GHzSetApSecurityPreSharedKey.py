...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIHAL_2.4GHzSetApSecurityPreSharedKey</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the Access point Security preShared key values for 2.4GHz radio using wifi_setApSecurityPreSharedKey HAL API and validate the same using wifi_getApSecurityPreSharedKey HAL API.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To set the Access point Security preShared key values for 2.4GHz radio using wifi_setApSecurityPreSharedKey HAL API and validate the same using wifi_getApSecurityPreSharedKey HAL API.</test_objective>
...
6.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetApSecurityPreSharedKey</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
