...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzAddandGetApAclDevice</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Add a new MAC in 2.4GHZ ACL list using wifi_addApAclDevice() and check using wifi_getApAclDevices() whether new MAC is available in ACL list</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_372</test_case_id>
    <test_objective>Add a new MAC in 2.4GHZ ACL list using wifi_addApAclDevice() and check using wifi_getApAclDevices() whether new MAC is available in ACL list</test_objective>
...
6. Unload Wifihal module</automation_approch>
    <expected_output>A new MAC added to 2.4GHZ ACL list using wifi_addApAclDevice() should be reflected in next wifi_getApAclDevices() </expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzAddandGetApAclDevice</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzAddandGetApAclDevice');
