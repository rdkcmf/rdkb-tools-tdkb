...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetApRetryLimit</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamUIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get the ApRetryLimit for 5GHz public wifi</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To set and get the ApRetryLimit for 5GHz public wifi</test_objective>
...
2.get the 5G public wifi index for platform property file
...
8. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetApRetryLimit</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApRetryLimit');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApRetryLimit');
