...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIHAL_2.4GHzSetApMaxAssociatedDevices</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamUIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get and set the ApMax Associated Devices value for 2.4GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_243</test_case_id>
    <test_objective>To get and set the ApMax Associated Devices value for 2.4GHz.</test_objective>
...
7.Unload the module.</automation_approch>
    <except_output>Set value should be equal to get value if the set value is less than 63 if value set is greater than 63 the get value should not be reflected in get</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetApMaxAssociatedDevices</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApMaxAssociatedDevices');
