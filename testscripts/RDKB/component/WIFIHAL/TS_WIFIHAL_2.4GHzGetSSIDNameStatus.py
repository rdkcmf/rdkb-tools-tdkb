...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzGetSSIDNameStatus</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the SSIDNameStatus for 2.4GHz radio using  wifi_getSSIDNameStatus HAL API to read the runtime ssid name and validate the same.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_298</test_case_id>
    <test_objective>To get the SSIDNameStatus for 2.4GHz radio using  wifi_getSSIDNameStatus HAL API to read the runtime ssid name and validate the same.</test_objective>
...
4. Check if the api returns the SSID name of 2.4GHz
5.Unload the module.</automation_approch>
    <except_output>The wifi_getSSIDNameStatus() api should return the 2.4GHz SSID name</except_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetSSIDNameStatus</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetSSIDNameStatus');
