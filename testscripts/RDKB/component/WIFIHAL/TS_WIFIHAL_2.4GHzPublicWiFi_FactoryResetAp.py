...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzPublicWiFi_FactoryResetAp</name>
...
10.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzPublicWiFi_FactoryResetAp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_FactoryResetAp');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_FactoryResetAp');
