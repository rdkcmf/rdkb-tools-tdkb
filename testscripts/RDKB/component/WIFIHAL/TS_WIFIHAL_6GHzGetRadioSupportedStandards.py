...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzGetRadioSupportedStandards</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the supported standards of 6GHZ and check whether the value is within the valid supported standard list.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_626</test_case_id>
    <test_objective>To get the supported standards of 6GHZ and check whether the value is within the valid supported standard list</test_objective>
...
2. Invoke "WIFIHAL_GetOrSetParamStringValue" to get the Supported Standards for 6GHz
3.Check if the value returned is valid or not
4. If not, return failure
5.Unload wifihal module</automation_approch>
    <expected_output>If the operating frequency is 6GHz, then Supported Standard should be [a, n, ac]</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzGetRadioSupportedStandards</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzGetRadioSupportedStandards');
    ...
    if idx == -1:
        ...
        tdkTestObjTemp.setResultStatus("FAILURE");
            ...
            if expectedresult in actualresult:
                ...
                print "TEST STEP 1: Get the Radio Supported Standards for 6GHz";
                ...
                if "0" in returnStatus:
                    ...
                    print "EXPECTED RESULT 2: Supported standards should be in ['b','g','n','ax'] when radio is 6G";
                ...
                tdkTestObj.setResultStatus("FAILURE");
                print "TEST STEP 1: Get the Radio Supported Standards for 6GHz";
                print "EXPECTED RESULT 1: Should get the Radio Supported Standards 6GHz";
                print "ACTUAL RESULT 1: %s" %SupportedStandards;
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : FAILURE";
