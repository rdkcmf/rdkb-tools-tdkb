...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetApSecurityModeEnabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the access point Security mode enabled for 2.4GHz radio using  wifi_getApSecurityModeEnabled HAL API and validate the same using wifi_getApSecurityModesSupported HAL API</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_38</test_case_id>
    <test_objective>To check if Access point Security mode enabled for 2.4GHz radio using  wifi_getApSecurityModeEnabled HAL API and validate the same using wifi_getApSecurityModesSupported HAL API</test_objective>
...
6. Unload the module.</automation_approch>
    <expected_output>Access point Security mode enabled for 2.4GHz radio should be from the list of Ap Security Modes Supported.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetApSecurityModeEnabled</test_script>
    <skipped>No</skipped>
