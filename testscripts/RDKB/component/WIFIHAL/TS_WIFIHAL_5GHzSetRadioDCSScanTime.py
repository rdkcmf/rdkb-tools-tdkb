...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetRadioDCSScanTime</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get and set Radio DCS Scan Time for 5GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_232</test_case_id>
    <test_objective>To set and get the DCS Scan Time for 5GHz</test_objective>
...
7. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetRadioDCSScanTime</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetRadioDCSScanTime');
