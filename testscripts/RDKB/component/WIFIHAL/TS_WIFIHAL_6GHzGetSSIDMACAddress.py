...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzGetSSIDMACAddress</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the SSID Mac Address and verify using BSSID for 6GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_613</test_case_id>
    <test_objective>To get the SSID Mac Address and verify using BSSID for 6GHz</test_objective>
...
methodName : getBaseBSSID</input_parameters>
...
5. Unload wifihal module</automation_approch>
    <expected_output>Return values of  wifi_getSSIDMACAddress() and wifi_getBaseBSSID() should be the same</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzGetSSIDMACAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzGetSSIDMACAddress');
