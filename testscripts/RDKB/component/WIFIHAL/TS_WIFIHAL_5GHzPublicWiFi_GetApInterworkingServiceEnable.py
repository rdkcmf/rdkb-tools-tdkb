...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_GetApInterworkingServiceEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke the HAL API wifi_getApInterworkingServiceEnable() for 5GHz Public WiFi and check the if Interworking Service is enabled or not.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To invoke the HAL API wifi_getApInterworkingServiceEnable() for 5GHz Public WiFi and check the if Interworking Service is enabled or not.</test_objective>
...
2. Invoke wifi_ getApInterworkingServiceEnable() HAL API for 5GHz Public WiFi. The API should return the enable status of Interworking Service.
...
6. Unload the module</automation_approch>
    <expected_output>The HAL API wifi_getApInterworkingServiceEnable() is invoked successfully for 5GHz Public WiFi and the enable status retrieved.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_GetApInterworkingServiceEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_GetApInterworkingServiceEnable');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    print "TEST STEP 1: Invoke the wifi_getApInterworkingServiceEnable api for 5GHz Public WiFi";
