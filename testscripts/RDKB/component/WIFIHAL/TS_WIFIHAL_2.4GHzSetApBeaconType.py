...
<xml>
  ...
  <test_cases>
    ...
    <test_objective>To set and get beacon type using the api's wifi_setApBeaconType() and wifi_getApBeaconType() with the corresponding Ap SecurityModeEnabled value for 2.4GHz</test_objective>
