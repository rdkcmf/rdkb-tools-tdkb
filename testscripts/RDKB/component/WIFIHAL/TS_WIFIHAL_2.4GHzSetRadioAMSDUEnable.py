...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_2.4GHzSetRadioAMSDUEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set AMSDU Enable status using wifi_setRadioAMSDUEnable() and verify it by getting with wifi_getRadioAMSDUEnable for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_116</test_case_id>
    <test_objective>To set AMSDU Enable status using wifi_setRadioAMSDUEnable() and verify it by getting with wifi_getRadioAMSDUEnable for 2.4GHz</test_objective>
...
6. Unload wifihal module
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetRadioAMSDUEnable</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_GetRadioAMSDUEnable');
