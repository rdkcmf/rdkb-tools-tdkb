...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_2.4GHzSetNeighborReportActivation</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_setNeighborReportActivation() to toggle the Neighbor Report Activation enable state from initial value and cross check if the value set is getting reflected in wifi_getNeighborReportActivation() for 2.4GHz radio private AP.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_714</test_case_id>
    <test_objective>Invoke the HAL API wifi_setNeighborReportActivation() to toggle the Neighbor Report Activation enable state from initial value and cross check if the value set is getting reflected in wifi_getNeighborReportActivation() for 2.4GHz radio private AP.</test_objective>
...
radioIndex : 2.4G Private AP index
param : 0 or 1</input_parameters>
    <automation_approch>1. Load the wifihal module.
2. Invoke the HAL API wifi_getNeighborReportActivation() with 2.4G radio index and get the initial enable state and save it.
...
6. Unload the module</automation_approch>
    <expected_output>The HAL API wifi_setNeighborReportActivation() should successfully toggle the Neighbor Report Activation enable set and it should be reflected in wifi_getNeighborReportActivation() for 2.4G radio private AP index.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetNeighborReportActivation</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetNeighborReportActivation');
