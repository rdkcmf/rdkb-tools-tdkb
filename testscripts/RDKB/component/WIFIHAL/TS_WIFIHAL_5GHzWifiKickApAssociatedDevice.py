...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To take the action to remove the existing wifi client connection for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To take the action to remove the existing wifi client connection for 5GHz</test_objective>
