...
3. Invoke the HAL API wifi_getApInterworkingServiceCapability() for 2.4GHz Public WiFi. If it is enabled return Success else return Failure.
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_GetApInterworkingServiceCapability');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_GetApInterworkingServiceCapability');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in actualresult and details != "":
        ...
        if expectedresult in actualresult:
            ...
            print "[TEST EXECUTION RESULT] : SUCCESS";
            print "TEST STEP 3: Check if value returned by wifi_getApInterworkingServiceCapability api is Enabled for 2.4GHz Public WiFi";
