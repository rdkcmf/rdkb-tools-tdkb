...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHz_SetApScanFiltermode_First</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_SetApScanFilter</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate the filter  mode WIFI_SCANFILTER_MODE_FIRST using WiFi HAL API wifi_setApScanFilter for 6GHz AccessPoint.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_704</test_case_id>
    <test_objective>To validate the filter  mode WIFI_SCANFILTER_MODE_FIRST using WiFi HAL API wifi_setApScanFilter for 6GHz AccessPoint</test_objective>
...
6.Unload wifihal module
    ...
    <test_script>TS_WIFIHAL_6GHz_SetApScanFiltermode_First</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHz_SetApScanFiltermode_First');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_6GHz_SetApScanFiltermode_First');
