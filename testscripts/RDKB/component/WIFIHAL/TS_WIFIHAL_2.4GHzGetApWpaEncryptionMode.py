...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetApWpaEncryptionMode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check Wpa encryption mode enabled in device for 2.4GHz radio using wifi_getApWpaEncryptionMode and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_42</test_case_id>
    <test_objective>To check Wpa encryption mode enabled in device for 2.4GHz radio using wifi_getApWpaEncryptionMode HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzGetApWpaEncryptionMode.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzGetApWpaEncryptionMode.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetApWpaEncryptionMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApWpaEncryptionMode');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApWpaEncryptionMode');
