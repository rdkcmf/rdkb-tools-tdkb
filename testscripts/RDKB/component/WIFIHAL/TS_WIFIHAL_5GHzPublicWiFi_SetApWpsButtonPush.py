...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetApWpsButtonPush</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_setApWpsButtonPush() for 5GHz Public WiFi after ensuring that WPS is enabled for the AP by invoking wifi_setApWpsEnable() and cross checking with wifi_getApWpsEnable().</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Invoke the HAL API wifi_setApWpsButtonPush() for 5GHz Public WiFi after ensuring that WPS is enabled for the AP by invoking wifi_setApWpsEnable() and cross checking with wifi_getApWpsEnable().</test_objective>
...
7. Unload the modules.</automation_approch>
    <expected_output>The HAL API wifi_setApWpsButtonPush() should be invoked successfully after enabling WPS using wifi_setApWpsEnable() for 5GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetApWpsButtonPush</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApWpsButtonPush');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApWpsButtonPush');
...
def ButtonPushWPS(idx, step):
    ...
    print "\nTEST STEP %d: Call the function wifi_setApWpsButtonPush() for 5 GHz Public WiFi" %step;
