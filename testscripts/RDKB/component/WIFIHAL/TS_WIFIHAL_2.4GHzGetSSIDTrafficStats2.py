...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzGetSSIDTrafficStats2</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetSSIDTrafficStats2</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the ssid traffic stat info for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_274</test_case_id>
    <test_objective>To get the ssid traffic stat info for 2.4GHz</test_objective>
...
5.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetSSIDTrafficStats2</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetSSIDTrafficStats2');
