...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzGetSSIDStatus</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To enable or disable the SSID for 2.4GHz and check whether the SSID status is updating accordingly</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_24</test_case_id>
    <test_objective>To enable or disable the SSID for 2.4GHz and check whether the SSID status is updating accordingly</test_objective>
...
2. Invoke "WIFIHAL_GetOrSetParamStringValue" to get the SSID Status for 5GHz
...
5.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetSSIDStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetSSIDStatus');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Set the SSID Enable status for 2.4GHz";
            print "EXPECTED RESULT 2: Should Set SSID enable status for 2.4GHz";
	...
	tdkTestObj = obj.createTestStep("WIFIHAL_GetOrSetParamBoolValue");
        ...
        if expectedresult in actualresult:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP : Set the SSID Enable status for 2.4GHz";
            print "EXPECTED RESULT : Should Set SSID enable status for 2.4GHz";
