...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetBasicTrafficStats</name>
...
3. Invoke wifi_getBasicTrafficStats() for 5G.
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetBasicTrafficStats</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetBasicTrafficStats');
	...
	if expectedresult in actualresult:
		...
		print "TEST EXECUTION RESULT 1: SUCCESS"
	        ...
	        if expectedresult in actualresult:
	            ...
	            tdkTestObj.setResultStatus("SUCCESS");
	            print "TEST STEP 2: Get the Basic Traffic statistics for 5GHz";
	            print "EXPECTED RESULT 2: wifi_getBasicTrafficStats should return the basic traffic statistics for 5GHz";
	            print "ACTUAL RESULT 2: wifi_getBasicTrafficStats operation returned SUCCESS";
	            print "Actual result is :",details;
	            print "[TEST EXECUTION RESULT] 2: SUCCESS";

                    print "TEST STEP 3: Check if the Basic Traffic statistics values for 5GHz are greater than 0";
                    print "EXPECTED RESULT 3: Basic Traffic statistics values for 5GHz should be greater than 0";
                    if int(ApNumDevices) == int(associations) and int(bytesSent) >0 and int(bytesReceived) >0 and int(packetsSent) >0 and int(packetsReceived) >0 :
                        print "ACTUAL RESULT 3: Basic Traffic statistics values for 5GHz are greater than 0";
                        print "[TEST EXECUTION RESULT] 3: SUCCESS";
                    else:
                        print "ACTUAL RESULT 3: Basic Traffic statistics values for 5GHz are not greater than 0";
                        print "[TEST EXECUTION RESULT] 3: FAILURE";
	        else:
		    tdkTestObj.setResultStatus("FAILURE");
  		    print "TEST STEP 2: Get the Basic Traffic statistics for 5GHz";
		    print "EXPECTED RESULT 2: wifi_getBasicTrafficStats should return the basic traffic statistics for 5GHz";
		    print "ACTUAL RESULT 2: Failed to get the Basic Traffic statistics values for 5GHz";
		    print "Actual result is :",details;
