...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzDisableApEncryption</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To invoke wifi_disableApEncryption() api and check whether the security mode is changed to "None" by invoking wifi_getApSecurityModeEnabled() api for 5GHz.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_281</test_case_id>
    <test_objective>To invoke wifi_disableApEncryption() api and check whether the security mode is changed to "None" by invoking wifi_getApSecurityModeEnabled() api for 5GHz.</test_objective>
...
6.Unload the module.</automation_approch>
    <except_output>The security mode should be changed to "None" after invoking the wifi_disableApEncryption() api for  5GHz,</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzDisableApEncryption</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzDisableApEncryption');
