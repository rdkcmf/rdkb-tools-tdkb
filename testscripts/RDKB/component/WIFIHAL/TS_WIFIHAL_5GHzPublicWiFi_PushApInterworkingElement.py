...
3. Invoke wifi_getApInterworkingElement() HAL API for 5GHz Public WiFi and save the initial values. The GET operation should return success.
4. Invoke  wifi_pushApInterworkingElement() HAL API for 5GHz Public WiFi and set the values for the Interworking element. The SET operation should return success.
...
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_PushApInterworkingElement');
