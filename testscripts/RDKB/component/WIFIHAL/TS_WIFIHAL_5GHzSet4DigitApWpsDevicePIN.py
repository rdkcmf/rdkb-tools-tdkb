...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSet4DigitApWpsDevicePIN</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the WpsDevicePIN to a 4 digit value and check whether it is able to set by getting  the  WpsDevicePIN for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_220</test_case_id>
    <test_objective>To set the  WpsDevicePIN to a 4 digit value and check whether it is set by getting it for for 5GHz</test_objective>
...
3. Using WIFIHAL_GetOrSetParamULongValue invoke wifi_setApWpsDevicePIN() and set a 4 digit value
...
7. Unload wifihal module</automation_approch>
    <except_output>Set operation should not be happen since it having invalid number of digits</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSet4DigitApWpsDevicePIN</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
