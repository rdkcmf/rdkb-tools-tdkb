...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzEnableCSIEngine_DisableWithClientMAC</name>
...
7. Unload the wifihal and sysutil module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzEnableCSIEngine_DisableWithClientMAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzEnableCSIEngine_DisableWithClientMAC');
obj1.configureTestCase(ip,port,'TS_WIFIHAL_5GHzEnableCSIEngine_DisableClientMAC');
