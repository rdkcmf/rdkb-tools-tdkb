...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_UpperBoundary</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_453</test_case_id>
...
3. Set a new RoamingConsortiumElement with  an OUI value of upper boundary length 15 using wifi_pushApRoamingConsortiumElement()
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_UpperBoundary</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_UpperBoundary');
	...
	print "[TEST EXECUTION RESULT] : SUCCESS";
	    ...
	    print "[TEST EXECUTION RESULT] : SUCCESS";
            ...
            if expectedresult in actualresult :
                ...
                #extract the newEntryCount, ouis and its length values to compare with pushed values
