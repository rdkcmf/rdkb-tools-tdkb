...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIHAL_2.4GHzSetInterworkingAccessNetworkType</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_545</test_case_id>
...
7. Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetInterworkingAccessNetworkType</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetInterworkingAccessNetworkType');
