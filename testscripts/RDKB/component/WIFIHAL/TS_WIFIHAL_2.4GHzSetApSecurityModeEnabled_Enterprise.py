...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzSetApSecurityModeEnabled_Enterprise</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set and get all the enterprise security modes for 2.4GHz.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_515</test_case_id>
    <test_objective>To set and get all the enterprise security modes for 2.4GHz.</test_objective>
...
3. Set all the Enterprise SecurityModes from supported SecurityModes list and using  WIFIHAL_GetOrSetParamStringValue invoke wifi_setApSecurityModeEnabled()
...
7. Unload wifihal module</automation_approch>
    <expected_output>Should be able to set and get all the enterprise security modes for 2.4GHz.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetApSecurityModeEnabled_Enterprise</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApSecurityModeEnabled_Enterprise');
	...
	tdkTestObj, actualresult, details = ExecuteWIFIHalCallMethod(obj, primitive, apIndex, "0", getMethod)
		...
		initMode = details.split(":")[1].strip()
		    ...
		    print "Initial ApSecurityMode is from the supported modes"
                    EnterpriseModes = list(filter(lambda x: 'Enterprise' in x, supportedModes))
                    print "Setting and checking the Enterprise security modes : ",EnterpriseModes
                    for setMode in EnterpriseModes :
