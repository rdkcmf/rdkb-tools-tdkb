...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzSetGuardInterval_400</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set guard interval value to 400 using wifi_setGuardInterval() and verify it using wifi_getGuardInterval()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_483</test_case_id>
    <test_objective>Set guard interval value to 400 using wifi_setGuardInterval() and verify it using wifi_getGuardInterval()</test_objective>
...
3. Using wifi_setGuardInterval() set guard interval as 400
...
6. Unload wifihal module</automation_approch>
    <expected_output>wifi_setGuardInterval() should successfully set  guard interval value to 400</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSetGuardInterval_400</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetGuardInterval_400');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 2: Set guard interval as wifi_guard_interval_400 using wifi_setGuardInterval() from the supported list of ", guardList
