...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <test_objective>Test to enable/disable radio enable status using wifi_setRadioEnable() api and verify using wifi_getRadioEnable() api</test_objective>
...
2. Using WIFIHAL_GetOrSetParamBoolValue invoke wifi_getRadioEnable and save the current radio enable state
3.Using WIFIHAL_GetOrSetParamBoolValue invoke wifi_setRadioEnable and toggle the current radio enable state
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetRadioEnable');
