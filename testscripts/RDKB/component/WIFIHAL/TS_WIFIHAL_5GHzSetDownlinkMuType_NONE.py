...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetDownlinkMuType_NONE</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_491</test_case_id>
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetDownlinkMuType_NONE</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetDownlinkMuType_NONE');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        if expectedresult in actualresult:
            ...
            print "API returned success status. ACTUAL RESULT 1:  %s" %details;
