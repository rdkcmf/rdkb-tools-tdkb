...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetApSecurityModeEnabled_Enterprise</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set and get all the enterprise security modes for 5GHz.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_516</test_case_id>
    <test_objective>To set and get all the enterprise security modes for 5GHz.</test_objective>
...
7. Unload wifihal module</automation_approch>
    <expected_output>Should be able to set and get all the enterprise security modes for 5GHz.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSetApSecurityModeEnabled_Enterprise</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetApSecurityModeEnabled_Enterprise');
