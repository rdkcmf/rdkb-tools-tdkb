...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzIsSSIDEnabled</name>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzIsSSIDEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzIsSSIDEnabled.py) using execution page of  Test Manager GUI
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzIsSSIDEnabled');
