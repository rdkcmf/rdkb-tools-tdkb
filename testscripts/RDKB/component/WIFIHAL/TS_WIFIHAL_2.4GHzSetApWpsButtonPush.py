...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>15</version>
  <name>TS_WIFIHAL_2.4GHzSetApWpsButtonPush</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>9</primitive_test_version>
  <status>FREE</status>
  <synopsis>To  start the WPS session for  2.4GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_333</test_case_id>
    <test_objective>To  start the WPS session for  2.4GHz.</test_objective>
...
3.Set the WpsButtonPush  for 2.4GHz by passing the parameters radioindex and setPin using wifi_setApWpsButtonPush() API by  invoking WIFIHAL_GetOrSetParamStringValue'
...
6.Unload the module.</automation_approch>
    <except_output>Successfully set and press the WPS push button for 2.4GHz AP</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetApWpsButtonPush</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApWpsButtonPush');
