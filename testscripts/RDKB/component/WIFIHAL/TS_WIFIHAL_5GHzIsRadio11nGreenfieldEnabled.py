...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzIsRadio11nGreenfieldEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check 11nGreenfield enable status of Radio 5GHz using wifi_getRadio11nGreenfieldEnable HAL API</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_93</test_case_id>
    <test_objective>Check 11nGreenfield enable status of Radio 5GHz using wifi_getRadio11nGreenfieldEnable HAL API</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzIsRadio11nGreenfieldEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzIsRadio11nGreenfieldEnabled.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzIsRadio11nGreenfieldEnabled</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzIsRadio11nGreenfieldEnabled');
