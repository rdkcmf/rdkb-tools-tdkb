...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_1Entry</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set an OUI list with single entry using wifi_pushApRoamingConsortiumElement() and verify it using wifi_getApRoamingConsortiumElement()</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_445</test_case_id>
    <test_objective>Set an OUI list with single entry using wifi_pushApRoamingConsortiumElement() and verify it using wifi_getApRoamingConsortiumElement()</test_objective>
...
2. Invoke wifi_getApRoamingConsortiumElement() to get the current OUI details and save them for revert operation
3. Set a new RoamingConsortiumElement with a single OUI entry using wifi_pushApRoamingConsortiumElement
...
6. Unload wifihal module</automation_approch>
    <expected_output>Should successfully set an OUI list with single entry using wifi_pushApRoamingConsortiumElement()</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_1Entry</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_1Entry');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	print "[TEST EXECUTION RESULT] : SUCCESS";
        ...
        print "TEST STEP 2: Set RoamingConsortiumElement  with a single OUI for 2.4GHz";
        print "EXPECTED RESULT 2: Should successfully set RoamingConsortiumElement  with a single OUI for 2.4GHz";
