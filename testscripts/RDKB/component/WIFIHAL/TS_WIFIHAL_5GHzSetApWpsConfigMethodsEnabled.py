...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetApWpsConfigMethodsEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get  the ApWpsConfigMethodsEnabled for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_157</test_case_id>
    <test_objective>To set and get  the ApWpsConfigMethodsEnabled for 5GHz</test_objective>
...
wifi_getApWpsConfigMethodsSupported()</api_or_interface_used>
    <input_parameters>methodName : getApWpsConfigMethodsEnabled
methodName : setApWpsConfigMethodsEnabled
methodName : getApWpsConfigMethodsSupported
...
8. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetApWpsConfigMethodsEnabled</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetApWpsConfigMethodsEnabled');
