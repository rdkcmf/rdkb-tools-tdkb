...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetApSecurityRadiusServer_NonEnterpriseMode</name>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_530</test_case_id>
...
7. Unload Wifihal module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetApSecurityRadiusServer_NonEnterpriseMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetApSecurityRadiusServer_NonEnterpriseMode');
