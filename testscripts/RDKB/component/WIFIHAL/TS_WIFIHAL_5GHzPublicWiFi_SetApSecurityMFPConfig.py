...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityMFPConfig</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApSecurityMFPConfig() to obtain the current config value and check if the value is from the expected list : ["Disabled", "Optional", "Required"]. Set each of the config values using wifi_setApSecurityMFPConfig() and cross check with the get API for 5GHz Public WiFi.</synopsis>
  <groups_id/>
...
setConfigValues : fetched from the expected list
</input_parameters>
...
8. Unload the module</automation_approch>
    <expected_output>The HAL API wifi_getApSecurityMFPConfig() should retrieve a valid MPF Config value and the HAL API wifi_setApSecurityMFPConfig() should successfully set different config values from the list ["Disabled", "Optional", "Required"] successfully for 5GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityMFPConfig</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityMFPConfig');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityMFPConfig');
