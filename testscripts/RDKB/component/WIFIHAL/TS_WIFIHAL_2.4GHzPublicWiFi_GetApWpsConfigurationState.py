...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzPublicWiFi_GetApWpsConfigurationState</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To  get the access point WpsConfigurationState for 2.4GHz public wifi</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_580</test_case_id>
    <test_objective>To  get the access point WpsConfigurationState for 2.4GHz public wifi</test_objective>
...
2.Get the apindex for 2.4G public wifi
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzPublicWiFi_GetApWpsConfigurationState</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_GetApWpsConfigurationState');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_GetApWpsConfigurationState');
