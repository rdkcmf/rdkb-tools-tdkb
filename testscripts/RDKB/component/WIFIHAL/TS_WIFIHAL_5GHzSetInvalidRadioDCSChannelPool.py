...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetInvalidRadioDCSChannelPool</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set dynamic channel pool outside the set of possible channels and verify whether we are able to set it for 5 GHz.</synopsis>
  <groups_id/>
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetInvalidRadioDCSChannelPool</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetInvalidRadioDCSChannelPool');
