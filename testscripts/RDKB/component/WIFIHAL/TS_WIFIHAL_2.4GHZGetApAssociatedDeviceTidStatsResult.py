...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHZGetApAssociatedDeviceTidStatsResult</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_353</test_case_id>
    <test_objective>To check for the successful invocation of ac,tid,sum_time_ms using wifi_getApAssociatedDeviceTidStatsResult</test_objective>
...
4.Unload module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHZGetApAssociatedDeviceTidStatsResult</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHZGetApAssociatedDeviceTidStatsResult');

wifiobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHZGetApAssociatedDeviceTidStatsResult');
...
if "SUCCESS" in loadmodulestatus.upper() and sysloadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        if expectedresult in actualresult :
            ...
            print "TEST STEP 1: Get the MAC of the connected client ";
            ...
            if MAC :
               ...
               if expectedresult in actualresult :
                  ...
                  if ac  !=  "(null)"  and tid != "(null)" and sum_time_ms != 0 :
                     tdkTestObj.setResultStatus("SUCCESS");
                     print "TEST STEP 2 : Get the ac,tid,sum_time_ms"
                     print "EXPECTED RESULT : Should successfuly get ac,tid,sum_time_m"
