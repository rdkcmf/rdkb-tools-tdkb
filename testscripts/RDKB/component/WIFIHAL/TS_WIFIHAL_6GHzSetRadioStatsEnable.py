...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzSetRadioStatsEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test to enable/disable radio enable status using wifi_setRadioStatsEnable() api and verify using wifi_getRadioStatsEnable() for 6GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_696</test_case_id>
    <test_objective>Test to enable/disable radio enable status using wifi_setRadioStatsEnable() api and verify using wifi_getRadioStatsEnable() for 6GHz.</test_objective>
...
radioIndex =  6g index</input_parameters>
...
5.Unload the module.</automation_approch>
    <expected_output>The radio enable status should be toggled </expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzSetRadioStatsEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzSetRadioStatsEnable');
