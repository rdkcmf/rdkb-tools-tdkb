...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth_40MHz</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the operating channel bandwidth to 40MHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_523</test_case_id>
    <test_objective>To set the operating channel bandwidth to 40MHz for 2.4GHz and verify the set value by getting it</test_objective>
...
3.Invoke "WIFIHAL_GetOrSetParamStringValue" to set the current operating channel bandwidth to 40MHz
...
8.Unload wifihal module</automation_approch>
    <expected_output>Should successfully set the operating channel bandwidth to 40MHz and successfully get it for 2.4GHz radio.</expected_output>
    <priority>High</priority>
    <test_stub_interface>Wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth_40MHz</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth_40MHz');
