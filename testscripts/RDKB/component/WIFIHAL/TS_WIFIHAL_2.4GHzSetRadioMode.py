...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_WIFIHAL_2.4GHzSetRadioMode</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_SetRadioMode</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set the applicable radio modes for 2.4GHZ using wifi_setRadioMode() and validate using wifi_getRadioMode()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Set the applicable radio modes for 2.4GHZ using wifi_setRadioMode() and validate using wifi_getRadioMode()</test_objective>
...
7.Unload the wifihal module.</automation_approch>
    <expected_output>Should be able to set all the applicable radio modes for 2.4GHZ using wifi_setRadioMode() and validate using wifi_getRadioMode()</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetRadioMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetRadioMode');
obj1.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetRadioMode');
