...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzGetApWpsConfiguration</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetApWpsConfiguration</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApWpsConfiguration() for 5G private AP and check if the WPS enabled is retrieved successfully and WPS PIN and WPS Methods are valid if WPS mode is enabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_777</test_case_id>
    <test_objective>Invoke the HAL API wifi_getApWpsConfiguration() for 5G private AP and check if the WPS enabled is retrieved successfully and WPS PIN and WPS Methods are valid if WPS mode is enabled.</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>apIndex : 5G private access point index</input_parameters>
    <automation_approch>1. Load the module
2. Invoke the HAL API wifi_getApWpsConfiguration() for 5G private access point.
...
6. Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetApWpsConfiguration</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApWpsConfiguration');
