...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzSetRadioAutoChannelRefreshPeriod</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_620</test_case_id>
    <test_objective>To set the auto channel refresh period if the automatic channel selection is enabled for 6GHz</test_objective>
...
4. RadioChannel after the refresh period should be from the list of radio possible channels</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzSetRadioAutoChannelRefreshPeriod</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzSetRadioAutoChannelRefreshPeriod');
...
def getRadioPossibleChannels(idx):
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP : Get the possible Radio Channels for 6GHz";
            print "EXPECTED RESULT : Should get the possible Radio Channels for 6GHz";
        ...
        tdkTestObjTemp.setResultStatus("FAILURE");
            ...
            if expectedresult in actualresult and "Disabled" in autoChannelSupport:
                ...
                if expectedresult in actualresult and "Enabled" in enable:
                    ...
                    if expectedresult in actualresult:
                        print "Auto channel enable set as true for 6GHz";
                        ...
                        print "Unable to set auto channel enable as true for 6GHz";
                        tdkTestObj.setResultStatus("FAILURE");
