...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_2Entries</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_447</test_case_id>
...
4. Set a new RoamingConsortiumElement with 2 OUI entries using wifi_pushApRoamingConsortiumElement
...
7.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_2Entries</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_2Entries');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	print "[TEST EXECUTION RESULT] : SUCCESS";
        ...
        print "TEST STEP 2: Set RoamingConsortiumElement  2 OUIs for 2.4GHz";
        print "EXPECTED RESULT 2: Should successfully set RoamingConsortiumElement  2 OUIs for 2.4GHz";
        ouiCount = 2
