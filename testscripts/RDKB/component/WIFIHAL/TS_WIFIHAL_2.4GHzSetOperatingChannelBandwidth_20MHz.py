...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth_20MHz</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_105</test_case_id>
    <test_objective>To set the operating channel bandwidth to 20MHz for 2.4GHz and verify the set value by getting it</test_objective>
...
8.Unload wifihal module</automation_approch>
    <expected_output>Should successfully set the operating channel bandwidth to 20MHz and successfully get it for 2.4GHz radio.</expected_output>
    <priority>High</priority>
    <test_stub_interface>Wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth_20MHz</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth_20MHz');
