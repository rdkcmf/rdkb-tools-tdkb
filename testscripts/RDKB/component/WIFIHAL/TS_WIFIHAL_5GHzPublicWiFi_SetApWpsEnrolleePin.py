...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetApWpsEnrolleePin</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke the HAL API wifi_setApWpsEnrolleePin() and set the Enrollee PIN for 5GHz Public WiFi      after ensuring that WPS is enabled for the corresponding AP using the HAL API wifi_setApWpsEnable() and wifi_getApWpsEnable().</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To invoke the HAL API wifi_setApWpsEnrolleePin() and set the Enrollee PIN for 5GHz Public WiFi after ensuring that WPS is enabled for the corresponding AP using the HAL API wifi_setApWpsEnable() and wifi_getApWpsEnable().</test_objective>
...
7. Unload the modules.</automation_approch>
    <expected_output>The HAL API wifi_setApWpsEnrollePin() should be invoked successfully after enabling WPS using wifi_setApWpsEnable() for 5GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetApWpsEnrolleePin</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApWpsEnrolleePin');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApWpsEnrolleePin');
