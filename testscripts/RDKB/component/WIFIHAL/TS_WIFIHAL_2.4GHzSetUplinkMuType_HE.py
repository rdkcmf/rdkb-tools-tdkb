...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetUplinkMuType_HE</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set UplinkMuType value as WIFI_UL_MU_TYPE_HE using wifi_setUplinkMuType() and verify it using wifi_getUplinkMuType() for 2.4G.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_505</test_case_id>
    <test_objective>Set UplinkMuType value as WIFI_UL_MU_TYPE_HE using wifi_setUplinkMuType() and verify it using wifi_getUplinkMuType() for 2.4G.</test_objective>
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetUplinkMuType_HE</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetUplinkMuType_HE');
