...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzWifiKickApAssociatedDevice</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To take the action to remove the existing wifi client connection for 5GHz by passing invalid MAC Address to wifi_kickApAssociatedDevice()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To take the action to remove the existing wifi client connection for 5GHz by passing invalid MAC Address to wifi_kickApAssociatedDevice()</test_objective>
...
4. Unload wifihal module</automation_approch>
    <except_output>Since we are passing invalid MAC address value, the API is expected to return failure</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzWifiKickApAssociatedDevice</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzWifiKickApAssociatedDevice');
