...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetOperatingChannelBandwidth_80MHz</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the operating channel bandwidth to 80MHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_527</test_case_id>
    <test_objective>To set the operating channel bandwidth to 80MHz for 5GHz and verify the set value by getting it</test_objective>
...
3.Invoke "WIFIHAL_GetOrSetParamStringValue" to set the current operating channel bandwidth to 80MHz
...
8.Unload wifihal module</automation_approch>
    <expected_output>Should successfully set the operating channel bandwidth to 80MHz and successfully get it for 5GHz radio.</expected_output>
    <priority>High</priority>
    <test_stub_interface>Wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSetOperatingChannelBandwidth_80MHz</test_script>
    <skipped>No</skipped>
