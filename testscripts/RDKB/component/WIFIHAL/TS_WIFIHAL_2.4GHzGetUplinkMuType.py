...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_2.4GHzGetUplinkMuType</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke wifi_getUplinkMuType() and check if it returns a value from the expected list</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_498</test_case_id>
    <test_objective>Invoke wifi_getUplinkMuType() and check if it returns a value from the expected list</test_objective>
...
2. Invoke wifi_getUplinkMuType for 5GHz and check if its return was success
...
4. Unload wifihal module</automation_approch>
    <expected_output>wifi_getUplinkMuType() should return a value from the expected list</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetUplinkMuType</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetUplinkMuType');
