...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetRadioStatsEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test to enable/disable radio enable status using wifi_setRadioStatsEnable() api and verify using wifi_getRadioStatsEnable() api for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Test to enable/disable radio enable status using wifi_setRadioStatsEnable() api and verify using wifi_getRadioStatsEnable() api for 2.4GHz</test_objective>
...
5.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetRadioStatsEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetRadioStatsEnable');
