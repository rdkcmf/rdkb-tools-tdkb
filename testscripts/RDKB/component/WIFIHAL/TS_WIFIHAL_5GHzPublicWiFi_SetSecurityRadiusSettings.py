...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusSettings</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetSecurityRadiusSettings</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get and set the SecurityRadiusSetting parameters for 5GHz public wifi</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To get and set the SecurityRadiusSetting parameters for 5GHz public wifi</test_objective>
...
2.Get the 5G public wifi apindex from platform property file
...
8.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusSettings</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusSettings');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusSettings');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult not in actualresult and details == "":
        print "TEST STEP 0: Get APINDEX_5G_PUBLIC_WIFI  from property file";
        print "EXPECTED RESULT 0: Should  get APINDEX_5G_PUBLIC_WIFI  from property file"
        print "ACTUAL RESULT 0: APINDEX_5G_PUBLIC_WIFI from properties file : ", details;
        ...
        tdkTestObj.setResultStatus("FAILURE");
            ...
            print "TEST STEP 0: Get APINDEX_5G_PUBLIC_WIFI  from property file";
            print "EXPECTED RESULT 0: Should  get APINDEX_5G_PUBLIC_WIFI  from property file"
            print "ACTUAL RESULT 0: APINDEX_5G_PUBLIC_WIFI from property file :", apIndex ;
