...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetApAssociatedDevicesHighWatermarkDate</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the Date and Time at which the maximum number of associated devices that has ever associated with the access point concurrently since the last reset of the device or WiFi module for 2.4GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get the Date and Time at which the maximum number of associated devices that has ever associated with the access point concurrently since the last reset of the device or WiFi module for 2.4GHz</test_objective>
...
2. Invoke "WIFIHAL_GetOrSetParamULongValue" to call wifi_getApAssociatedDevicesHighWatermarkDate for 2.4GHz
...
4.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetApAssociatedDevicesHighWatermarkDate</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApAssociatedDevicesHighWatermarkDate');
