...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_2.4GHzGetRadioCarrierSenseThresholdInUse</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_239</test_case_id>
    <test_objective>To get the RadioCarrierSenseThresholdInuse value for 2.4GHz radio using wifi_getRadioCarrierSenseThresholdRange HAL API and validate the same with the Radio  CarrierSenseThresholdRange whether the value is inside the range</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzGetRadioCarrierSenseThresholdInUse.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzGetRadioCarrierSenseThresholdInUse.py) using execution page of  Test Manager GUI
...
5.WIFIHAL_GetOrSetParamIntValue function will call Ccsp Base Function named "ssp_WIFIHALGetOrSetParamIntValue", that inturn will call WIFIHAL Library wifi_getRadioCarrierSenseThresholdRange(),wifi_getRadioCarrierSenseThresholdInUse() function
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetRadioCarrierSenseThresholdInUse</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
