...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetLayer2TrafficInspectionFiltering</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_432</test_case_id>
...
6.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetLayer2TrafficInspectionFiltering</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetLayer2TrafficInspectionFiltering');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    #Set the result status of execution
	    tdkTestObj.setResultStatus("SUCCESS");
	    print "TEST STEP 2: Toggle the Layer2TrafficInspectionFiltering enabled status for 5GHz";
	    print "EXPECTED RESULT 2: Should toggle the Layer2TrafficInspectionFiltering enable status for 5GHz to ", expectedStatus ;
		...
		if newStatus == expectedStatus:
		    #Set the result status of execution
		    tdkTestObj.setResultStatus("SUCCESS");
		    print "TEST STEP 3: Get the Layer2TrafficInspectionFiltering enabled status for 5GHz";
	...
	if expectedresult in actualresult:
	    #Set the result status of execution
	    tdkTestObj.setResultStatus("SUCCESS");
	    print "TEST STEP : Revert the Layer2TrafficInspectionFiltering enabled status for 5GHz";
	    print "EXPECTED RESULT : Should revert the Layer2TrafficInspectionFiltering enabled status for 5GHz";
