...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_2.4GHzIsApWmmEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Check Enable Status of Access point Wmm(wifi-multimedia) using wifi_getApWmmEnable HAL API</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_55</test_case_id>
    <test_objective>To Check Enable Status of Access point Wmm(wifi-multimedia) using wifi_getApWmmEnable HAL API</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XB3. XB6</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state else invoke cosa_start.sh manually that includes all the ccsp components and TDK Component
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>wifi_getApWmmEnable()</api_or_interface_used>
    <input_parameters>methodName   :   getApWmmEnable
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzIsApWmmEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzIsApWmmEnabled.py) using execution page of  Test Manager GUI
...
wifi_getApWmmEnable() and wifi_setApWmmEnable()
...
1:wifi_getApWmmEnable log from DUT should be available in Agent Console LogCheckPoint 
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""</except_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzIsApWmmEnabled</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzIsApWmmEnabled');
