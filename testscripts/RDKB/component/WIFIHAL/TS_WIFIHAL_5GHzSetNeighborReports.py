...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>15</version>
  <name>TS_WIFIHAL_5GHzSetNeighborReports</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_SetNeighborReports</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_setNeighborReports() to set the neighbor reports for the connected client when Neighbor Reports Activation is enabled for 5G private radio AP.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_718</test_case_id>
    <test_objective>Invoke the HAL API wifi_setNeighborReports() to set the neighbor reports for the connected client when Neighbor Reports Activation is enabled for 5G private radio AP.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state else invoke cosa_start.sh manually that includes all the ccsp components and TDK Component
2.TDK Agent should be in running state or invoke it through StartTdk.sh script
3. Connect a client to 5G radio private AP</pre_requisite>
...
radioIndex : 5G radio private AP index
apIndex : 5G radio private AP index
param : 0 or 1
...
9. Unload the module.</automation_approch>
    <expected_output>The HAL API wifi_setNeighborReports() to set the neighbor reports for the connected client when Neighbor Reports Activation is enabled for 5G private radio AP should be invoked successfully.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSetNeighborReports</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetNeighborReports');
