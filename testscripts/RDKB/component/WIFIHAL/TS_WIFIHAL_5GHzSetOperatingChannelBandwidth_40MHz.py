...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetOperatingChannelBandwidth_40MHz</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_526</test_case_id>
    <test_objective>To set the operating channel bandwidth to 40MHz for 5GHz and verify the set value by getting it</test_objective>
...
8.Unload wifihal module</automation_approch>
    <expected_output>Should successfully set the operating channel bandwidth to 40MHz and successfully get it for 5GHz radio.</expected_output>
    <priority>High</priority>
    <test_stub_interface>Wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSetOperatingChannelBandwidth_40MHz</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetOperatingChannelBandwidth_40MHz');
