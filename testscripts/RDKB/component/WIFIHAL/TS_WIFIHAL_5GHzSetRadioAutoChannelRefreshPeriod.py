...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetRadioAutoChannelRefreshPeriod</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set the auto channel refresh period if the automatic channel selection is enabled for 5GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_118</test_case_id>
    <test_objective>To set the auto channel refresh period if the automatic channel selection is enabled for 5GHz</test_objective>
...
4. RadioChannel after the refresh period should be from the list of radio possible channels</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzSetRadioAutoChannelRefreshPeriod</test_script>
    <skipped>No</skipped>
