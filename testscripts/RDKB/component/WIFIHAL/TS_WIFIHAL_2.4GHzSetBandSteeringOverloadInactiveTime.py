...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_2.4GHzSetBandSteeringOverloadInactiveTime</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get the BandSteering OverloadInactiveTime	 for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_196</test_case_id>
    <test_objective>To set and get the BandSteeringOverloadInactiveTime for 2.4GHz</test_objective>
...
8. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetBandSteeringOverloadInactiveTime</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetBandSteeringOverloadInactiveTime');
