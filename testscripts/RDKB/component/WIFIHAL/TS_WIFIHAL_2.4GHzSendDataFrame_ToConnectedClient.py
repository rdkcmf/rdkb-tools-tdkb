...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzSendDataFrame_ToConnectedClient</name>
...
3. Should connect a client to 2.4GHz radio</pre_requisite>
...
4. Unload the wifihal module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSendDataFrame_ToConnectedClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSendDataFrame_ToConnectedClient');
