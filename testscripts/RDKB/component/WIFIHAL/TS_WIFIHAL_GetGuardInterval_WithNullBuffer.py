...
<xml>
  ...
  <name>TS_WIFIHAL_GetGuardInterval_WithNullBuffer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Validate wifi_getGuardInterval with NULL buffer</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_475</test_case_id>
    <test_objective>Validate wifi_getGuardInterval with NULL buffer</test_objective>
...
2. Invoke wifi_getGuardInterval() with NULL buffer
3. Check if api returns failure and exits gracefully
4. Unload wifihal module</automation_approch>
    <expected_output>wifi_getGuardInterval() should return failure when invoked with a NULL buffer</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_GetGuardInterval_WithNullBuffer</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_GetGuardInterval_WithNullBuffer');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1: Query the wifi_getGuardInterval api with Null Buffer";
