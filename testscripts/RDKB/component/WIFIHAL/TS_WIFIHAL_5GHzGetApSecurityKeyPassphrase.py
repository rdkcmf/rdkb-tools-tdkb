...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzGetApSecurityKeyPassphrase</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get Accesspoint securitykey passpharse for 5GHz radio using wifi_getApSecurityKeyPassphrase HAL API and validate the same</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_71</test_case_id>
    <test_objective>To get Accesspoint securitykey passpharse for 5GHz radio using wifi_getApSecurityKeyPassphrase HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetApSecurityKeyPassphrase.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetApSecurityKeyPassphrase.py) using execution page of  Test Manager GUI
...
5.WIFIHAL_GetOrSetParamStringValue function will call Ccsp Base Function named "ssp_WIFIHALGetOrSetParamStringValue", that inturn will call WIFIHAL Library Function wifi_getApSecurityKeyPassphrase() function
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzGetApSecurityKeyPassphrase</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApSecurityKeyPassphrase');
