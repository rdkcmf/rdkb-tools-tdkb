...
2. Invoke wifi_getRadioPossibleChannels() and retrieve the possible channels list
3. Get the radio channel stats for 6G radio using the HAL API wifi_getRadioChannelStats() for each of radio channels and check if the stats are valid.
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        if expectedresult in actualresult and details != "":
            ...
            valid_values = 0;
            failed_stats = [];
            print "\nTEST STEP 2 : Get the Radio channel statistics info for 6GHz using the HAL API wifi_getRadioChannelStats()";
            print "EXPECTED RESULT 2: wifi_getRadioChannelStats should return the radio channel statistics for 6GHz";
