...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_LowerBoundary</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_PushApRoamingConsortiumElement</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set an OUI value of lower boundary length 3 using wifi_pushApRoamingConsortiumElement() and verify it using wifi_getApRoamingConsortiumElement()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_451</test_case_id>
    <test_objective>Set an OUI value of lower boundary length 3 using wifi_pushApRoamingConsortiumElement() and verify it using wifi_getApRoamingConsortiumElement()</test_objective>
...
3. Set a new RoamingConsortiumElement with  an OUI value of lower boundary length 3 using wifi_pushApRoamingConsortiumElement()
...
6. Unload wifihal module</automation_approch>
    <expected_output>Should successfully set an OUI value of lower boundary length 3 using wifi_pushApRoamingConsortiumElement() </expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_LowerBoundary</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_LowerBoundary');
