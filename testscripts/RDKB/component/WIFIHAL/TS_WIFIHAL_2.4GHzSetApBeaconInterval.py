...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_WIFIHAL_2.4GHzSetApBeaconInterval</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_553</test_case_id>
...
5. Unload the moule.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetApBeaconInterval</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApBeaconInterval');
wifiobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApBeaconInterval');
