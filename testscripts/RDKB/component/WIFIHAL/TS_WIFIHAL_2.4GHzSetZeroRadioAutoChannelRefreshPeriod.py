...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetZeroRadioAutoChannelRefreshPeriod</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamULongValue</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the auto channel refresh period  to zero if the automatic channel selection is enabled for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_459</test_case_id>
    <test_objective>This test case is to set the auto channel refresh period  to zero if the automatic channel selection is enabled for 2.4GHz</test_objective>
...
12. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetZeroRadioAutoChannelRefreshPeriod</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetZeroRadioAutoChannelRefreshPeriod');
