...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApWmmCapability() to retrieve the ApWmmCapability. If the ApWmmCapability is enabled toggle ApWmmEnable using the API wifi_setApWmmEnable() and confirm if the value is set properly using wifi_getApWmmEnable() for 2.4GHz Public WiFi.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Invoke the HAL API wifi_getApWmmCapability() to retrieve the ApWmmCapability. If the ApWmmCapability is enabled toggle ApWmmEnable using the API wifi_setApWmmEnable() and confirm if the value is set properly using wifi_getApWmmEnable() for 2.4GHz Public WiF</test_objective>
...
8. Unload module</automation_approch>
    <expected_output>If ApWmmCapability is Enabled then the HAL API  wifi_setApWmmEnable() should successfully toggle the value retrieved via  wifi_getApWmmEnable() for 2.4GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmEnable');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmEnable');
