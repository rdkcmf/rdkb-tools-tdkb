...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzGetIndexFromName</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetIndexFromName</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the index of 5GHz from its corresponding ssid string</synopsis>
  <groups_id/>
...
4. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetIndexFromName</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetIndexFromName');
