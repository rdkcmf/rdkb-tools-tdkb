...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetApWpsConfigMethodsEnabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the WPS configMethod Enabled values for 2.4GHz radio using wifi_getApWpsConfigMethodsEnabled HAL API and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_43</test_case_id>
    <test_objective>To get the WPS configMethod Enabled values for 2.4GHz radio using wifi_getApWpsConfigMethodsEnabled HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzGetApWpsConfigMethodsEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzGetApWpsConfigMethodsEnabled.py) using execution page of  Test Manager GUI
...
5.WIFIHAL_GetOrSetParamStringValue function will call Ccsp Base Function named "ssp_WIFIHALGetOrSetParamStringValue", that inturn will call WIFIHAL Library Function wifi_getApWpsConfigMethodsEnabled() function
...
1:wifi_getApWpsConfigMethodsEnabled from DUT should be available in Agent Console LogCheckPoint
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""</except_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetApWpsConfigMethodsEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApWpsConfigMethodsEnabled');
