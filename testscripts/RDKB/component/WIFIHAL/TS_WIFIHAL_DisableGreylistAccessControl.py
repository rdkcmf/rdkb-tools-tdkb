...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_DisableGreylistAccessControl</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To disable Grey List access control  using wifi api wifi_enableGreylistAccessControl and check if the necessary hostapd conf files are populated</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_552</test_case_id>
    <test_objective>To disable Grey List access control  using wifi api wifi_enableGreylistAccessControl and check if the necessary hostapd conf files are populated</test_objective>
...
param - 0 for disable</input_parameters>
...
3.Disable the radius grey list Enable status using api wifi_enableGreylistAccessControl
4.Check if hostapd conf files secath8,secath9  are present
5.revert the value to previous
6.Unload the module</automation_approch>
    <expected_output>The api call to disable wifi_enableGreylistAccessControl should be successfull and respective conf files should get populated</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_DisableGreylistAccessControl</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_DisableGreylistAccessControl');
wifiobj.configureTestCase(ip,port,'TS_WIFIHAL_DisableGreylistAccessControl');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_DisableGreylistAccessControl');
