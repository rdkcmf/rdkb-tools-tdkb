...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetApRoamingConsortiumElement</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_443</test_case_id>
...
4.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetApRoamingConsortiumElement</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApRoamingConsortiumElement');
