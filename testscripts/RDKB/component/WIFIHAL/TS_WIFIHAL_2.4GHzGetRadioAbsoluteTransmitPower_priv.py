...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzGetRadioAbsoluteTransmitPower_priv</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamULongValue</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the  Absolute transmit power  for 2G wifi using wifi_getRadioAbsoluteTransmitPower_priv.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_692</test_case_id>
    <test_objective>To get the  Absolute transmit power  for 2G wifi using wifi_getRadioAbsoluteTransmitPower_priv</test_objective>
...
2.Get the  private Absolute Transmit  Power for 2.4G using wifi_getRadioAbsoluteTransmitPower_priv
...
4.unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetRadioAbsoluteTransmitPower_priv</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetRadioAbsoluteTransmitPower_priv');
