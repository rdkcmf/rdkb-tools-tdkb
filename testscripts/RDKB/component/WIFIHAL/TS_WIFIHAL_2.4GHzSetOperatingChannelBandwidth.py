...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set the operating channel bandwidth</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_105</test_case_id>
    <test_objective>To set the operating channel bandwidth for 2.4GHz and verify the set value by getting it</test_objective>
...
7.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetOperatingChannelBandwidth');
