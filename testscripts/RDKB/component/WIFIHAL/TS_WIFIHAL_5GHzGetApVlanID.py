...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzGetApVlanID</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate the WiFi HAL API wifi_getApVlanID for 5GHz AP</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_367</test_case_id>
    <test_objective>To validate the WiFi HAL API wifi_getApVlanID for 5GHz AP</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>radioIndex - Radio index value</input_parameters>
    <automation_approch>1.Load the module
2.Using WIFIHAL_GetorSetParamIntValues, call wifi_getApVlanID HAL API and print the return value
3.Unload the module</automation_approch>
    <expected_output>should successfully get the VLAN ID for 5GHZ AP</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetApVlanID</test_script>
    <skipped>No</skipped>
