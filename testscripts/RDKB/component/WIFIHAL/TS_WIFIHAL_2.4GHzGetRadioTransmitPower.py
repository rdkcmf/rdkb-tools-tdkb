...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the transmit power for 2.4GHz using wifi_getRadioTransmitPower() and check whether it is not a null value.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get the transmit power for 2.4GHz using wifi_getRadioTransmitPower() and check whether it is not a null value.</test_objective>
...
2.Invoke wifi_getRadioTransmitPower() to get the current radio transmit power for 2.4GHz.
...
1.Should successfully get the current transmit power for 2.4GHz.</except_output>
