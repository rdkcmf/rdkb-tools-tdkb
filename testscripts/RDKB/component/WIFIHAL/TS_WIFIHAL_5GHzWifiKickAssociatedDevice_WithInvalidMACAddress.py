...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzWifiKickAssociatedDevice_WithInvalidMACAddress</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_512</test_case_id>
...
4. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzWifiKickAssociatedDevice_WithInvalidMACAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzWifiKickAssociatedDevice_WithInvalidMACAddress');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        if expectedresult in actualresult :
            ...
            print "TEST STEP 1: Calling the wifi api wifi_kickAssociatedDevice() with an invalid MAC address for 5GHz";
