...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetSSIDName_Empty</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>This is a negative scenario to set SSID Name to an empty value using wifi_setSSIDName() and try getting it with wifi_getSSIDName() for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_201</test_case_id>
    <test_objective>This is a negative scenario to set SSID Name to an empty value using wifi_setSSIDName() for 5GHz</test_objective>
...
6. Unload wifihal module"
    ...
    <test_script>TS_WIFIHAL_5GHzSetSSIDName_Empty</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetSSIDName_Empty');
