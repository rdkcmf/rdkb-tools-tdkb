...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzGetOperationalDataTransmitRates</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_653</test_case_id>
...
methodName : getOperationalDataTransmitRates</input_parameters>
...
4. Unload wifihal module</automation_approch>
    <expected_output>OperationalDataTransmitRates should be a subset of supported data transmit rates</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzGetOperationalDataTransmitRates</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzGetOperationalDataTransmitRates');
