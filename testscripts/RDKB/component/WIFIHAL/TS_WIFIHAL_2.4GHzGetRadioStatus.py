...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>16</version>
  <name>TS_WIFIHAL_2.4GHzGetRadioStatus</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>4</primitive_test_version>
  <status>FREE</status>
  <synopsis>To verify if wifi_getRadioStatus is changed on changing the RadioEnable  using wifi_setRadioEnable() for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_235</test_case_id>
    <test_objective>To verify if wifi_getRadioStatus is changed on changing the RadioEnable  using wifi_setRadioEnable() for 2.4GHz</test_objective>
...
6.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetRadioStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetRadioStatus');
