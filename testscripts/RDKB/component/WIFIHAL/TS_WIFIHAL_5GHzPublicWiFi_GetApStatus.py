...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzPublicWiFi_GetApStatus</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the AP Status value for 5GHz public wifi using wifi_getApStatus HAL API and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_579</test_case_id>
    <test_objective>To get the AP Status value for 5GHz public wifi using wifi_getApStatus HAL API and validate the same</test_objective>
...
apIndex   :(5GPublicwifiindex)    </input_parameters>
    <automation_approch>1.Load the module
2.Get the index for public wifi 5G from platform property file
...
4.Unload wifi module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_GetApStatus</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_GetApStatus');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_GetApStatus');
