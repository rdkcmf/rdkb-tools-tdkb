...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzGetSoftBlockWaitingTime</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamUIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To query wifi_getSofBlockWaitingTime api and check whether  expected Waiting time is received</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_466</test_case_id>
    <test_objective>This  test case is to query wifi_getSoftBlockWaitingTime api and check whether expected Waiting time is received</test_objective>
...
4.Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetSoftBlockWaitingTime</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetSoftBlockWaitingTime');
