...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_5GHzSetApInterworkingServiceEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke wifi_setApInterworkingServiceEnable() and check if the InterworkingServiceEnable is toggled  successfully.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_540</test_case_id>
    <test_objective>To invoke wifi_setApInterworkingServiceEnable() and check if the InterworkingServiceEnable is toggled  successfully.</test_objective>
...
2. Invoke wifi_ getApInterworkingServiceEnable() HAL API. The API should return the enable status of Interworking Service.
3. Toggle the value by invoking wifi_ setApInterworkingServiceEnable().
...
6. Unload the module</automation_approch>
    <expected_output>wifi_setApInterworkingServiceEnable() invoked and the InterworkingServiceEnable is toggled  successfully.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSetApInterworkingServiceEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetApInterworkingServiceEnable');
