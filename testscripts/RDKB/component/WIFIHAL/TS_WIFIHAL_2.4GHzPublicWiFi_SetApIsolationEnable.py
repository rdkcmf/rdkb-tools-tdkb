...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_WIFIHAL_2.4GHzPublicWiFi_SetApIsolationEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApIsolationEnable() and toggle the ApIsolationEnable using the API wifi_setApIsolationEnable() for 2.4GHz Public WiFi</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Invoke the HAL API wifi_getApIsolationEnable() and toggle the ApIsolationEnable using the API wifi_setApIsolationEnable() for 2.4GHz Public WiFi</test_objective>
...
7. Unload the module</automation_approch>
    <expected_output>The HAL API wifi_getApIsolationEnable() should be invoked and the ApIsolationEnable should be toggled successfully using the API wifi_setApIsolationEnable() for 2.4GHz Public WiFi</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzPublicWiFi_SetApIsolationEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_SetApIsolationEnable');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_SetApIsolationEnable');
