...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHZGetBSSTransitionImplemented</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check wether the BSSTransition is implemented using using wifi_getBSSTransitionImplemented</synopsis>
  <groups_id/>
...
5.Unload module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHZGetBSSTransitionImplemented</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHZGetBSSTransitionImplemented');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHZGetBSSTransitionImplemented');
