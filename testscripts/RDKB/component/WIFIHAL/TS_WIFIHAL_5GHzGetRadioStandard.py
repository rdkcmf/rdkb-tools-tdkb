...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To get the current radio standard for 5 GHz and to check whether it one of the supported standards for 5 GHz</synopsis>
  <groups_id/>
...
2. Invoke "WIFIHAL_GetOrSetParamStringValue" to get the current Radio Standard for 5GHz
3.Check if the value returned is valid or not
4. If not, return failure
5.Unload wifihal module</automation_approch>
    <except_output>The current radio standard for 5GHz should be a sublist of radio supported standards for 5GHz.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetRadioStandard</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetRadioStandard');
