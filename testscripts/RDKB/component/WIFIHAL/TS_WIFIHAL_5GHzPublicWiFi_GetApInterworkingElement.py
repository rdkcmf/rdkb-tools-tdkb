...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>apIndex : 9</input_parameters>
    <automation_approch>1. Load the wifihal module
2. Invoke wifi_getApInterworkingElement() and get the element details for 5GHz Public WiFi.
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if details != " ":
            print "TEST STEP 2: Get the Access Point InterworkingElement details for 5GHz Public WiFi";
