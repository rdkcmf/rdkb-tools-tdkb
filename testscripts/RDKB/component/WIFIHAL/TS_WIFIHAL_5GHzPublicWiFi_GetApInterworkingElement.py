...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzPublicWiFi_GetApInterworkingElement</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To invoke wifi_getApInterworkingElement() HAL API successfully and fetch the Interworking element details for 5GHz Public WiFi.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_556</test_case_id>
    <test_objective>To invoke wifi_getApInterworkingElement() HAL API successfully and fetch the Interworking element details for 5GHz Public WiFi.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state of DUT
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>WIFIHAL_GetApInterworkingElement</api_or_interface_used>
    <input_parameters>apIndex : fetched from platform properties file</input_parameters>
    <automation_approch>1. Load the wifihal module
2. Get the 5GHz Public WiFi AP Index from platform.properties file
3. Invoke wifi_getApInterworkingElement() and get the element details for 5GHz Public WiFi.
...
7. Unload the module</automation_approch>
    <expected_output>wifi_getApInterworkingElement() HAL API is invoked  Interworking element details are fetched successfully for 5GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_GetApInterworkingElement</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_GetApInterworkingElement');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_GetApInterworkingElement');
