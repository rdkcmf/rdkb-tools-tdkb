...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetWiFiTrafficStats</name>
...
5. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetWiFiTrafficStats</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetWiFiTrafficStats');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    ...
	    print "TEST STEP 1: Get the Wifi Traffic statistics for 2.4GHz";
	    print "EXPECTED RESULT 1: wifi_getWifiTrafficStats should return the wifi traffic statistics for 2.4GHz";
	    ...
	    print "[TEST EXECUTION RESULT] 1: SUCCESS";
            ...
            print "TEST STEP 2: Check if the Wifi Traffic statistics values for 2.4GHz are greater than or equal to 0";
            print "EXPECTED RESULT 2: Wifi Traffic statistics values for 2.4GHz should be greater than or equal to 0";
            if int(wifi_ErrorsSent) >= 0 and int(wifi_ErrorsReceived) >=0 and int(wifi_UnicastPacketsSent) >=0 and int(wifi_UnicastPacketsReceived) >=0 and int(wifi_DiscardedPacketsSent) >=0 and int(wifi_DiscardedPacketsReceived) >=0 and int(wifi_MulticastPacketsSent) >=0 and int(wifi_MulticastPacketsReceived) >=0:
                print "ACTUAL RESULT 2: Wifi Traffic statistics values for 2.4GHz are greater than or equal to 0";
                print "[TEST EXECUTION RESULT] 2: SUCCESS";
            else:
                print "ACTUAL RESULT 2: Wifi Traffic statistics values for 2.4GHz are not greater than or equal to 0";
                print "[TEST EXECUTION RESULT] 2: FAILURE";
	else:
	    tdkTestObj.setResultStatus("FAILURE");
  	    print "TEST STEP 1: Get the Wifi Traffic statistics for 2.4GHz";
	    print "EXPECTED RESULT 1: wifi_getWifiTrafficStats should return the Wifi traffic statistics for 2.4GHz";
	    print "ACTUAL RESULT 1: Failed to get the Wifi Traffic statistics values for 2.4GHz";
	    print "Actual result is :",details;
