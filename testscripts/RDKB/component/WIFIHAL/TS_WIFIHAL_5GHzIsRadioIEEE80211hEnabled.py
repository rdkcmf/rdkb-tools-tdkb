...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzIsRadioIEEE80211hEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check IEEE80211h is enabled for 5GHz Radio using wifi_getRadioIEEE80211hEnabled HAL API</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_99</test_case_id>
    <test_objective>Check IEEE80211h is enabled for 5GHz Radio using wifi_getRadioIEEE80211hEnabled HAL API</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzIsRadioIEEE80211hEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzIsRadioIEEE80211hEnabled.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzIsRadioIEEE80211hEnabled</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzIsRadioIEEE80211hEnabled');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult :
        ...
        if "Enabled" in enable:
            print "IEEE80211h is Enabled in Radio 5Ghz"
            oldEnable = 1
            newEnable = 0
        else:
            print "IEEE80211h is Disabled in Radio 5Ghz"
            oldEnable = 0
            newEnable = 1
