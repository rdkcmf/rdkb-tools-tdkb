...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetApRtsThreshold</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if ApRtsThreshold is supported, if supported set the ApRtsThreshold for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_186</test_case_id>
    <test_objective>To check if ApRtsThreshold is supported, if supported set the ApRtsThreshold for 5GHz</test_objective>
...
2. wifi_setApRtsThreshold should return SUCCESS</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzSetApRtsThreshold</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetApRtsThreshold');
