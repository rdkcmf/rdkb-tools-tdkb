...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHz_GetRadioPercentageTransmitPower</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check the RadioPercentageTransmitPower of 2.4GHZ using WiFi hal api wifi_getRadioPercentageTransmitPower()</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_370</test_case_id>
    <test_objective>Check the RadioPercentageTransmitPower of 2.4GHZ using WiFi hal api wifi_getRadioPercentageTransmitPower()</test_objective>
...
4. Unload wifihal module</automation_approch>
    <expected_output>Should successfully retrieve RadioPercentageTransmitPower for 2.4GHZ</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHz_GetRadioPercentageTransmitPower</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHz_GetRadioPercentageTransmitPower');
