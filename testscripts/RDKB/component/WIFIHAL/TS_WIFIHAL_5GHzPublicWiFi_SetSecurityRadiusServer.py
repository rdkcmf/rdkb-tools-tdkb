...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusServer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set and get the SecurityRadiusServer details  for 5GHz Public WiFi</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_570</test_case_id>
    <test_objective>To set and get the SecurityRadiusServer details  for 5GHz Public WiFi</test_objective>
...
6. Using  WIFIHAL_GetOrSetSecurityRadiusServer invoke wifi_getApSecurityRadiusServer() and save the value
7. Using  WIFIHAL_GetOrSetSecurityRadiusServer invoke wifi_setApSecurityRadiusServer() and set any values for IPaddress, port and RadiusSecret
8. Invoke wifi_getApSecurityRadiusServer() to get the previously set value.
9. Compare the above two results. If the two values  are same return SUCCESS else return FAILURE
10. Revert the RadiusServer and ModeEnabled back to initial value
11. Unload wifihal module</automation_approch>
    <expected_output>Set and get values of RadiusServer (IP address, port and RadiusSecret) should be the same</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusServer</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusServer');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetSecurityRadiusServer');
