...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetDownlinkMuType_HE_MIMO</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set DownlinkMuType value as WIFI_DL_MU_TYPE_HE_MIMO using wifi_setDownlinkMuType() and verify it using wifi_getDownlinkMuType() for 2.4G.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_503</test_case_id>
    <test_objective>Set DownlinkMuType value as WIFI_DL_MU_TYPE_HE_MIMO using wifi_setDownlinkMuType() and verify it using wifi_getDownlinkMuType() for 2.4G.</test_objective>
...
3. Using wifi_setDownlinkMuType() set DownlinkMuType as WIFI_DL_MU_TYPE_HE_MIMO
...
6. Unload wifihal module</automation_approch>
    <expected_output>wifi_setDownlinkMuType() should successfully set DownlinkMuType value to WIFI_DL_MU_TYPE_HE_MIMO</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetDownlinkMuType_HE_MIMO</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetDownlinkMuType_HE_MIMO');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 2: Set DownlinkMuType as WIFI_DL_MU_TYPE_HE_MIMO using wifi_setDownlinkMuType() from the supported list  ",muTypeList ;
