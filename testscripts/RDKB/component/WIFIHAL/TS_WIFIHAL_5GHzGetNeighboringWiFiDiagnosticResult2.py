...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzGetNeighboringWiFiDiagnosticResult2</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetNeighboringWiFiDiagnosticResult2</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To start the wifi scan and get the result for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To start the wifi scan and get the result for 5GHz</test_objective>
...
4.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetNeighboringWiFiDiagnosticResult2</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetNeighboringWiFiDiagnosticResult2');
