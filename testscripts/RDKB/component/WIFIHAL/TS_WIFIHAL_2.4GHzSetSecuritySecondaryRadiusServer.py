...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetSecuritySecondaryRadiusServer</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetSecurityRadiusServer</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To  set and get the SecuritySecondaryRadiusServer details  for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_178</test_case_id>
    <test_objective>To set and get the SecuritySecondaryRadiusServer details  for 2.4GHz</test_objective>
...
6. Revert the SecondaryRadiusServer and ModeEnabled back to initial value
7. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetSecuritySecondaryRadiusServer</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetSecuritySecondaryRadiusServer');

def GetorSetApSecuritySecondaryRadiusServer(obj, primitive, radioIndex, IPAddress, port, RadiusSecret, methodname):
...
def checkApSecuritySecondaryRadiusServer():
    expectedresult = "SUCCESS";
    radioIndex = 0
    ...
    tdkTestObj, actualresult, details = GetorSetApSecuritySecondaryRadiusServer(obj, primitive, radioIndex, "0", 0, "0", getMethod)
    ...
    if expectedresult in actualresult:
        ...
        if all(initValues):
            ...
            tdkTestObj, actualresult, details = GetorSetApSecuritySecondaryRadiusServer(obj, primitive, radioIndex, IPAddress, port, RadiusSecret, setMethod)
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    ...
                    tdkTestObj.setResultStatus("FAILURE");
                    print "wifi_getApSecuritySecondaryRadiusServer() call failed"
    ...
    if expectedresult in actualresult:
        ...
        if initMode not in compatibleModes:
            ...
            if expectedresult in actualresult:
                ...
                checkApSecuritySecondaryRadiusServer();
