...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetApAssociatedDeviceDiagnosticResult3</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test script is to find the AP associated device details of 5Ghz using wifi_getApAssociatedDeviceDiagnosticResult3()</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_352</test_case_id>
    <test_objective>This test script is to find the AP associated device details of 5ghz using wifi_getApAssociatedDeviceDiagnosticResult3()</test_objective>
...
3. Unload wifihal module</automation_approch>
    <except_output>It should return output_array_size, which will give the no associated device.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL_GetApAssociatedDeviceDiagnosticResult3</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetApAssociatedDeviceDiagnosticResult3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApAssociatedDeviceDiagnosticResult3');
