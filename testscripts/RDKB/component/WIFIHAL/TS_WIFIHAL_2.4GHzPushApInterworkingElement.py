...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzPushApInterworkingElement</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_PushApInterworkingElement</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke wifi_pushApInterworkingElement() HAL API and push the Interworking Element values and cross check by invoking wifi_getApInterworkingElement() API.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_549</test_case_id>
    <test_objective>Invoke wifi_pushApInterworkingElement() HAL API and push the Interworking Element values and cross check by invoking wifi_getApInterworkingElement() API.</test_objective>
...
2. Invoke wifi_getApInterworkingElement() HAL API and save the initial values. The GET operation should return success.
3. Invoke  wifi_pushApInterworkingElement() HAL API and set the values for the Interworking element. The SET operation should return success.
4. Cross check the values set with wifi_getApInterworkingElement() API.
5. Revert to initial values
6. Unload the module</automation_approch>
    <expected_output>wifi_pushApInterworkingElement() HAL API should push the Interworking Element values and wifi_getApInterworkingElement() API when invoked should return the set values properly.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzPushApInterworkingElement</test_script>
    <skipped>No</skipped>
...
'''
def push_element(tdkTestObj, radioIndex, step, element):
...
def get_element(tdkTestObj, radioIndex, step):
    expectedresult = "SUCCESS"
    element_details = [];
    tdkTestObj.addParameter("radioIndex",radioIndex);
    tdkTestObj.executeTestCase(expectedresult);
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPushApInterworkingElement');
