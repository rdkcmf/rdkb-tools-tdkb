...
2. Invoke the HAL API wifi_getApInterworkingServiceCapability() for 5GHz Public WiFi. If it is enabled return Success else return Failure.
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 2: Check if value returned by wifi_getApInterworkingServiceCapability api is Enabled for 5GHz Public WiFi";
