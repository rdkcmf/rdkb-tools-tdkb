...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_5GHzGetDownlinkMuType</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_496</test_case_id>
...
2. Invoke wifi_getDownlinkMuType for 5GHz and check if its return was success
...
4. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetDownlinkMuType</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetDownlinkMuType');
