...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WIFIHAL_2.4GHzDelApAclDevices</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_339</test_case_id>
    <test_objective>Get the number of Acl devices using the API   wifi_getApAclDeviceNum() and get the MAC adress of the Acl devices using  wifi_getApAclDevices() . Add  acl devices using wifi_addApAclDevice() if no acl devices listed and invoke wifi_delApAclDevices() to delete listed acl devices for 2.4GHz.</test_objective>
...
9.Unload the module.</automation_approch>
    <except_output>Should be able to delete all ApAclDevices  using delApAclDevices() api for 2.4GHz</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzDelApAclDevices</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzDelApAclDevices');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if olddeviceNum != "":
            ...
            print"Number of ApAcl devices initially for 2.4GHz=",olddeviceNum;
