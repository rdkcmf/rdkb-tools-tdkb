...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetUplinkMuType_NONE</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set UplinkMuType value as WIFI_UL_MU_TYPE_NONE using wifi_setUplinkMuType() and verify it using wifi_getUplinkMuType()</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Set UplinkMuType value as WIFI_UL_MU_TYPE_NONE using wifi_setUplinkMuType() and verify it using wifi_getUplinkMuType()</test_objective>
...
3. Using wifi_setUplinkMuType() set UplinkMuType as WIFI_UL_MU_TYPE_NONE
...
6. Unload wifihal module</automation_approch>
    <expected_output>wifi_setUplinkMuType() should successfully set UplinkMuType value to WIFI_UL_MU_TYPE_NONE</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzSetUplinkMuType_NONE</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetUplinkMuType_NONE');
