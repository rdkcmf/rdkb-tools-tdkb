...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_5GHzPushApRoamingConsortiumElement_3Entries</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_450</test_case_id>
...
6. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzPushApRoamingConsortiumElement_3Entries</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPushApRoamingConsortiumElement_3Entries');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	print "[TEST EXECUTION RESULT] : SUCCESS";
        ...
        print "TEST STEP 2: Set RoamingConsortiumElement  3 OUIs for 5GHz";
        print "EXPECTED RESULT 2: Should successfully set RoamingConsortiumElement  3 OUIs for 5GHz";
