...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test if on enabling autoChannel mode using wifi_setRadioAutoChannelEnable(), the manually set and get channel number is from the list of possible channels returned by wifi_getRadioPossibleChannels() api for 2.4GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test if on enabling autoChannel mode using wifi_setRadioAutoChannelEnable(), the manually set and get channel number is from the list of possible channels returned by wifi_getRadioPossibleChannels() api for 2.4GHz</test_objective>
		...
		if expectedresult in actualresult:
			...
			if expectedresult in actualresult:
				...
				if int(ChannelAfterAuto) in PossibleChannels:
				    #Set the result status of execution
				    tdkTestObj.setResultStatus("SUCCESS");
				    print "TEST STEP 5: Get the Radio channel for 2.4GHz and the channel should be from the list of Possible Channels";
				    print "EXPECTED RESULT 5: Should get the Radio channel for 2.4GHz and the channel should be from the list of Possible Channels";
			...
			#Set the result status of execution
			tdkTestObj.setResultStatus("SUCCESS");
			print "TEST STEP 6: Set Radio channel for 2.4GHz to initial value";
			print "EXPECTED RESULT 6: Should set Radio channel for 2.4GHz to initial value";
