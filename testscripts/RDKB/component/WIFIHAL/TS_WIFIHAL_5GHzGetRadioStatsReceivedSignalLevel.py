...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetRadioStatsReceivedSignalLevel</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the 5GHZ radio stats received signal using wifi_getRadioStatsReceivedSignalLevel HAL API and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_84</test_case_id>
    <test_objective>To get the 5GHZ radio stats received signal using wifi_getRadioStatsReceivedSignalLevel HAL API and validate the same</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XB3. XB6, Emulator, Rpi</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state else invoke cosa_start.sh manually that includes all the ccsp components and TDK Component
2.TDK Agent should be in running state or invoke it through StartTdk.sh script
3. Wifi client to be connected to 5GHz with DUT.</pre_requisite>
...
6. Unload the module.</automation_approch>
    <expected_output>wifi_getRadioStatsReceivedSignalLevel HAL API should return the radiostas received signal level in the expected range for 5GHz.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetRadioStatsReceivedSignalLevel</test_script>
    <skipped>No</skipped>
