...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>9</version>
  <name>TS_WIFIHAL_6GHzGetRadioOperatingParameters</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetRadioOperatingParameters</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getRadioOperatingParameters() and retrieve all the radio operating parameters for 6G radio.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_792</test_case_id>
    <test_objective>Invoke the HAL API wifi_getRadioOperatingParameters() and retrieve all the radio operating parameters for 6G radio.</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>radioIndex : 6G radio index</input_parameters>
    <automation_approch>1. Load the module
2. Invoke the HAL API wifi_getRadioOperatingParameters() for 6G radio and check if the invocation success.
...
4. Unload the module</automation_approch>
    <expected_output>The HAL API wifi_getRadioOperatingParameters() should be invoked successfully and all the radio operating parameters retrieved for 6G radio should be valid values.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzGetRadioOperatingParameters</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzGetRadioOperatingParameters');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
        ...
        print "\nTEST STEP 1: Invoke the HAL API wifi_getRadioOperatingParameters() to retrieve the 6G Radio operating parameter values";
        ...
        if expectedresult in actualresult and "Details" in details:
            ...
            invalid_flag = 0;
            print "\nTEST STEP 2: Check if the operating parameters for the 6G radio are valid";
            print "EXPECTED RESULT 2: The operating parameters for the 6G radio should be valid";
