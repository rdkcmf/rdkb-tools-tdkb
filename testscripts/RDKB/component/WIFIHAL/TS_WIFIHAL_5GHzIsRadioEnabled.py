...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzIsRadioEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check enable Status of 5Ghz Radio using wifi_getRadioEnable() HAL API</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_98</test_case_id>
    <test_objective>To check enable Status of 5Ghz Radio using wifi_getRadioEnable() HAL API</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzIsRadioEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzIsRadioEnabled.py) using execution page of  Test Manager GUI
...
8.Test Manager will publish the result in GUI as SUCCESS/FAILURE based on the response from wifihalstub</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzIsRadioEnabled</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzIsRadioEnabled');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult :
        ...
        if "Enabled" in enable:
            print "Radio 5GHz is Enabled"
	    oldEnable = 1
            newEnable = 0
        else:
            print "Radio 5GHz is Disabled"
	    oldEnable = 0
            newEnable = 1
        ...
        if expectedresult in actualresult :
            ...
            if expectedresult in actualresult and enable not in details.split(":")[1].strip():
                ...
                print "getRadioEnable() failed after set"
		tdkTestObj.setResultStatus("FAILURE");
        else:
