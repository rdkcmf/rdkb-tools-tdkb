...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>9</version>
  <name>TS_WIFIHAL_5GHzGet_ApAssociatedDevice</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_351</test_case_id>
...
4.Unload the module.</automation_approch>
    <except_output>Should get the list of associated devices for 5GHz</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGet_ApAssociatedDevice</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks>nil</remarks>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGet_ApAssociatedDevice');
