...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_2.4GHzGetApIndexFromName</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetApIndexFromName</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate wifi_getApIndexFromName for 2.4GHz with a valid SSID</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_379</test_case_id>
    <test_objective>This test case is to validate wifi_getApIndexFromName for 2.4GHz with a valid SSID</test_objective>
...
2.  Using wifiUtility.getIndex() get the index for "2.4G"
...
5.  Invoke wifi_getApIndexFromName() with new ssid name as param and see whether the index value equals to the index for "2.4G"
6.  Revert the ssid name to previous value.
7.  Unload the module</automation_approch>
    <expected_output>With SSID Name wifi_getApIndexFromName() should return Apindex for "2.4G"</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetApIndexFromName</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApIndexFromName');
