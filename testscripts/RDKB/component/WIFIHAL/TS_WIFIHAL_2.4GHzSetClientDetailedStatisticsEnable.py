...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_2.4GHzSetClientDetailedStatisticsEnable</name>
  <primitive_test_id/>
...
4. Unload the wifihal module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetClientDetailedStatisticsEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetClientDetailedStatisticsEnable');
