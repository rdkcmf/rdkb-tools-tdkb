...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThresholdReached</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the number of times the current total number of associated device has reached the HighWatermarkThreshold value for 5GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
2. Invoke "WIFIHAL_GetOrSetParamUIntValue" to call wifi_getApAssociatedDevicesHighWatermarkThresholdReached for 5GHz
...
4.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThresholdReached</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThresholdReached');
