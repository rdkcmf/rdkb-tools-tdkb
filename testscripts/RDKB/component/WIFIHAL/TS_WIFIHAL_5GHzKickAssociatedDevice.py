...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzKickAssociatedDevice</name>
...
9. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzKickAssociatedDevice</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzKickAssociatedDevice');
wifiobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzKickAssociatedDevice');
                        ...
                        if expectedresult in actualresult:
                             ...
                             if int(ApNumDevices) > 0:
                                 ...
                                 if expectedresult in actualresult:
                                     ...
                                     print "Device.WiFi.AccessPoint.2.AssociatedDevice.1.MACAddress :",newMacAddress;
