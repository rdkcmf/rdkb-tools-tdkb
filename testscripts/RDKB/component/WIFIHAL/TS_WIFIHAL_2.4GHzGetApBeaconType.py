...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_WIFIHAL_2.4GHzGetApBeaconType</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check the Beacon type value set in device for 2.4GHz radio using wifi_getApBeaconType HAL API and validate the same using wifi_getApSecurityModeEnabled HAL API</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check the Beacon type value set in device for 2.4GHz radio using wifi_getApBeaconType HAL API and validate the same using wifi_getApSecurityModeEnabled HAL API</test_objective>
...
6. Unload the module.</automation_approch>
    <except_output>ApBeaconType should match with the corresponding Ap Security Mode Enabled for 2.4GHz.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetApBeaconType</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
