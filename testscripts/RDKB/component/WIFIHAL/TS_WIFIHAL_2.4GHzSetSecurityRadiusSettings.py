...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetSecurityRadiusSettings</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetSecurityRadiusSettings</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get and set the SecurityRadiusSetting parameters for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_276</test_case_id>
    <test_objective>To get and set the SecurityRadiusSetting parameters for 2.4GHz</test_objective>
...
7.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetSecurityRadiusSettings</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetSecurityRadiusSettings');
