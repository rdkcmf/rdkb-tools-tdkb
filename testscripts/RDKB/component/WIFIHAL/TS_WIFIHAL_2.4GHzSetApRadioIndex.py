...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetApRadioIndex</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_258</test_case_id>
    <test_objective>To set the radioIndex of an even number of access point to 1</test_objective>
...
apIndex : 12</input_parameters>
    <automation_approch>1.Load the module.
2.Using WIFIHAL_GetOrSetParamIntValue invoke wifi_getApRadioIndex for Ap 12
...
6.Unload module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetApRadioIndex</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    #Checking for apIndex 12, Similary can be check for other APs 0,2,4,6,8,10,12,14
