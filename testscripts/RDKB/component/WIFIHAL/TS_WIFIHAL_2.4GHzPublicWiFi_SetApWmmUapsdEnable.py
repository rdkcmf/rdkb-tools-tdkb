...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmUapsdEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApUAPSDCapability() to retrieve the ApUAPSDCapability. If the ApUAPSDCapability is enabled toggle ApWmmUapsdEnable using the API wifi_setApWmmUapsdEnable() and confirm if the value is set properly using wifi_getApWmmUapsdEnable() for 2.4GHz Public WiFi.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Invoke the HAL API wifi_getApUAPSDCapability() to retrieve the ApUAPSDCapability. If the ApUAPSDCapability is enabled toggle ApWmmUapsdEnable using the API wifi_setApWmmUapsdEnable() and confirm if the value is set properly using wifi_getApWmmUapsdEnable() for 2.4GHz Public WiFi.</test_objective>
...
2. Fetch the 2.4GHz Public WiFi Access Point index from platform property file.
...
8. Unload module</automation_approch>
    <expected_output>If ApUAPSDCapability is Enabled then the HAL API  wifi_setApWmmUapsdEnable() should successfully toggle the value retrieved via  wifi_getApWmmUapsdEnable() for 5GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmUapsdEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmUapsdEnable');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_SetApWmmUapsdEnable');
