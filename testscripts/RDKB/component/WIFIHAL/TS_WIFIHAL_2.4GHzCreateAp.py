...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzCreateAp</name>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_297</test_case_id>
    <test_objective>To validate the functionality of
 wifi_createAp api for 2.4GHz</test_objective>
...
6. Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzCreateAp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzCreateAp');
wifiobj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzCreateAp');
...
if "SUCCESS" in loadmodulestatus.upper() and sysloadmodulestatus.upper():
	...
	tdkTestObj = wifiobj.createTestStep("WIFIAgent_Get");
	    ...
	    for apIndex in range(0, APCount, 2):
                expectedresult="SUCCESS";
		...
		print "EXPECTED RESULT 2 : Get  a free AccessPoint for 2.4 G"
		print "ACTUAL RESULT  2: %d APIndex is available for 2.4G " %newapIndex
		#Get the result of execution
