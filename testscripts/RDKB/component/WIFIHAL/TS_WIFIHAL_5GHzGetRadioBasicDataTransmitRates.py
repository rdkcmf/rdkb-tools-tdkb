...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzGetRadioBasicDataTransmitRates</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the Data Transmit Rates for 5GHz radio using wifi_getRadioBasicDataTransmitRates HAL API and validate the same</synopsis>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetRadioBasicDataTransmitRates.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetRadioBasicDataTransmitRates.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzGetRadioBasicDataTransmitRates</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetRadioBasicDataTransmitRates');
        ...
        if expectedresult in actualresult1:
            ...
            for item in actualTransmitRate:
                if item in supportedTransmitRate:
                    ...
                    print "EXPECTED RESULT 1: wifi_getRadioBasicDataTransmitRates should return a data transmit rate value for Radio 5GHz";
