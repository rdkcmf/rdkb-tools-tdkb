...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetApAssociatedDeviceStats</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the api which returns the associated device status for 2.4GHz.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_342</test_case_id>
    <test_objective>To validate the api which returns the associated device status for 2.4Ghz</test_objective>
...
2. Get the Ap Associated Device status of the device for 2.4GHz by using the primitive WIFIHAL_GetApAssociatedDeviceStats.
3. Unload wifihal module</automation_approch>
    <except_output>Should successfully list the associated device status for 2.4GHz radio by calling the primitive WIFIHAL_GetApAssociatedDeviceStats.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetApAssociatedDeviceStats</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApAssociatedDeviceStats');
