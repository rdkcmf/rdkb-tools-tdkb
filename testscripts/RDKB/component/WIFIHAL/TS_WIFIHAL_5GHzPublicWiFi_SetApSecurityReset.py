...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityReset</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_ParamRadioIndex</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke the api wifi_setApSecurityReset() and check whether the ap security mode enabled  value is equal to the default value for 5GHz public wifi</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To invoke the api wifi_setApSecurityReset() and check whether the ap security mode enabled  value is equal to the default value for 5GHz public wifi</test_objective>
...
2.Get the 5G public wifi index from platform property file
...
9. Unload wifihal module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityReset</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityReset');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApSecurityReset');
