...
5. Revert the added client config using wifi_steering_clientRemove()
6. If SSID and passphrase were changed in step2, revert them back
7. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetSteeringClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetSteeringClient');
sysObj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetSteeringClient');
wifiObj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetSteeringClient');
