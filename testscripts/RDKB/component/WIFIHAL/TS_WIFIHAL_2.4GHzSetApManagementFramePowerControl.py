...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetApManagementFramePowerControl</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get the ApManagementFramePowerControl for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_165</test_case_id>
    <test_objective>To set and get the ApManagementFramePowerControl for 2.4GHz</test_objective>
...
2. Using WIFIHAL_GetOrSetParamIntValue invoke wifi_getApManagementFramePowerControl() and save the get value
3. Choose a Power within -20 dBm and 20 dBm and using  WIFIHAL_GetOrSetParamIntValue invoke wifi_setApManagementFramePowerControl()
...
7. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetApManagementFramePowerControl</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApManagementFramePowerControl');
