...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_5GHzGetApSecurity</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetApSecurity</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApSecurity() for 5G private AP and retrieve all the AP security details and verify if the values are valid.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_757</test_case_id>
    <test_objective>Invoke the HAL API wifi_getApSecurity() for 5G private AP and retrieve all the AP security details and verify if the values are valid.</test_objective>
...
2. Invoke the HAL API wifi_getApSecurity() for 5G private AP. Check if API invocation is success.
...
4. Unload the modules.</automation_approch>
    <expected_output>Invocation of the HAL API wifi_getApSecurity() for 5G private AP should be success and all the AP security details retrieved should be valid.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetApSecurity</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApSecurity');
