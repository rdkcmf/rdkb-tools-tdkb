...
3. Toggle the value by invoking wifi_ setApInterworkingServiceEnable() for 5GHz Public WiFi.
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if "Enabled" in enable:
            ...
            newEnable = 1
            newStatus = "Enabled"
        print "TEST STEP 2: Toggle the enabled state using wifi_setApInterworkingServiceEnable api for 5GHz Public WiFi";
