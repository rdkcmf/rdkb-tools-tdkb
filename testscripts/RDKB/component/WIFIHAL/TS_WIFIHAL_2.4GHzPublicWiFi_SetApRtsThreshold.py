...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzPublicWiFi_SetApRtsThreshold</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if ApRtsThreshold is supported, if supported set the ApRtsThreshold for Public WiFi 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check if ApRtsThreshold is supported for public Wifi, if supported set the ApRtsThreshold for 2.4GHz</test_objective>
...
2. wifi_setApRtsThreshold should return SUCCESS</expected_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzPublicWiFi_SetApRtsThreshold</test_script>
    <skipped>No</skipped>
