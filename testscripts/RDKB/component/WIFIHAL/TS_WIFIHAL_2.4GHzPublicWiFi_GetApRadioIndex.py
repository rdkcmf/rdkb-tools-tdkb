...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzPublicWiFi_GetApRadioIndex.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzPublicWiFi_GetApRadioIndex.py) using execution page of  Test Manager GUI
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    #Checking for idx 8, Similary can be check for other APs 0,2,4,6,8,10,12,14
