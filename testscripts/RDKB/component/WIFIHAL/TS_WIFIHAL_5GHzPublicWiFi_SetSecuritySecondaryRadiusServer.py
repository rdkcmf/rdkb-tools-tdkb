...
3. If the mode is any Enterprise Modes : "WPA-Enterprise", "WPA2-Enterprise", "WPA-WPA2-Enterprise",  go to step 5
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if initMode not in compatibleModes:
            ...
            if expectedresult in actualresult:
                tdkTestObj.setResultStatus("SUCCESS");
                print "ModeEnabled is changed to WPA-Enterprise type"
