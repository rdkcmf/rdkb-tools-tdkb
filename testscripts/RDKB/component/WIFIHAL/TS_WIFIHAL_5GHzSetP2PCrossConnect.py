...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetP2PCrossConnect</name>
  <primitive_test_id/>
...
6.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetP2PCrossConnect</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetP2PCrossConnect');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    #Set the result status of execution
	    tdkTestObj.setResultStatus("SUCCESS");
	    print "TEST STEP 2: Toggle the P2PCrossConnect enabled status for 5GHz";
	    print "EXPECTED RESULT 2: Should toggle the P2PCrossConnect enable status for 5GHz to ", expectedStatus ;
		...
		if newStatus == expectedStatus:
		    #Set the result status of execution
		    tdkTestObj.setResultStatus("SUCCESS");
		    print "TEST STEP 3: Get the P2PCrossConnect enabled status for 5GHz";
	...
	if expectedresult in actualresult:
	    #Set the result status of execution
	    tdkTestObj.setResultStatus("SUCCESS");
	    print "TEST STEP : Revert the P2PCrossConnect enabled status for 5GHz";
	    print "EXPECTED RESULT : Should revert the P2PCrossConnect enabled status for 5GHz";
