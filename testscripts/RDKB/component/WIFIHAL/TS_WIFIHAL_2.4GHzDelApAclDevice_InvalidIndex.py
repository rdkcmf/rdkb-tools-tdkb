...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzDelApAclDevice_InvalidIndex</name>
...
8.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzDelApAclDevice_InvalidIndex</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzDelApAclDevice_InvalidIndex');
