...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_2.4GHzGetBSSColor</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetBSSColorValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke wifi_getBSSColor() and check if it returns a value between 0 and 63</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_507</test_case_id>
    <test_objective>Invoke wifi_getBSSColor() and check if it returns a value between 0 and 63</test_objective>
...
2. Invoke wifi_getBSSColor for 2.4GHz and check if its return was success
3. Check if output of wifi_getBSSColor() is in the range of 0 and 63
4. Unload wifihal module</automation_approch>
    <expected_output>wifi_getBSSColor() should return a value between 0 and 63</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetBSSColor</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetBSSColor');
