...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_2.4GHzIsRadioAutoBlockAckEnabled</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_59</test_case_id>
    <test_objective>To check AutoBlock-ACK enable status of Radio 2.4GHz by using  wifi_getRadioAutoBlockAckEnable HAL API</test_objective>
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""</except_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzIsRadioAutoBlockAckEnabled</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
