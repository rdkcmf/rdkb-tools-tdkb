...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_5GHzAddorDelApAclDevice</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_AddorDelApAclDevice</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To add/delete ApAclDevice using the device Mac Address for 5GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_260</test_case_id>
    <test_objective>To add/delete ApAclDevice using the device Mac Address for 5GHz.</test_objective>
...
7.Unload the module.</automation_approch>
    <except_output>Should be able to add/delete ApAclDevice using the device Mac Address for 5GHz.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzAddorDelApAclDevice</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzAddorDelApAclDevice');
