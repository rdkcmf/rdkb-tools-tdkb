...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To invoke the api wifi_setApSecurityReset() and check whether the ap security mode enabled  value is equal to the default value for 5GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To invoke the api wifi_setApSecurityReset() and check whether the ap security mode enabled  value is equal to the default value for 5GHz.</test_objective>
...
def GetSetApSecurityMode(obj,param,Method):
    apIndex = 1;
...
def setApSecurityReset():
    ...
    if expectedresult in actualresult:
        ...
        print "**************************************************";
        time.sleep(3);
        tdkTestObj, actualresult, details = GetSetApSecurityMode(obj,"0","getApSecurityModeEnabled");
        if expectedresult in actualresult :
	    tdkTestObj.setResultStatus("SUCCESS");
	    ResetMode = details.split(":")[1].strip();
            ...
            if ResetMode == DefaultMode :
                tdkTestObj.setResultStatus("SUCCESS");
                print "**************************************************";
                print "TEST STEP 10: To invoke the api wifi_setApSecurityReset and check whether the ApSecurityModeEnabled is equal to default mode and not equal to the set mode for 5GHz";
	        print "EXPECTED RESULT 10: The mode should be equal to the default mode for 5GHz";
	        print "ACTUAL RESULT 10: The mode is equal to the default mode for 5GHz";
	        #Get the result of execution
	        print "[TEST EXECUTION RESULT] : SUCCESS";
                print "**************************************************";
            else :
                ...
                print "TEST STEP 10: To invoke the api wifi_setApSecurityReset and check whether the ApSecurityModeEnabled is equal to default mode and not equal to the set mode for 5GHz";
                print "EXPECTED RESULT 10: The mode should be equal to the default mode for 5GHz";
                print "ACTUAL RESULT 10: The mode is NOT equal to the default mode for 5GHz";
                #Get the result of execution
...
if "SUCCESS" in loadmodulestatus.upper()and "SUCCESS" in sysloadmodulestatus.upper():
	...
	tdkTestObj.setResultStatus("SUCCESS");
        ...
        print "[TEST EXECUTION RESULT] : SUCCESS";
        print "**************************************************";
	tdkTestObj, actualresult, details1 = GetSetApSecurityMode(obj,"0","getApSecurityModesSupported");
	if expectedresult in actualresult :
	    tdkTestObj.setResultStatus("SUCCESS");
	    ...
	    print "ACTUAL RESULT 2 : Successfully got the Ap Security Modes Supported as %s" %supportedModes;
            ...
            print "[TEST EXECUTION RESULT] : SUCCESS";
            print "**************************************************";
	    tdkTestObj, actualresult, details2 = GetSetApSecurityMode(obj,"0","getApSecurityModeEnabled");
	    if expectedresult in actualresult :
                tdkTestObj.setResultStatus("SUCCESS");
		...
		if initMode in supportedModes.split(','):
                    ...
                    if initMode == DefaultMode :
                        ...
                        for setMode in supportedModes.split(','):
	                        ...
	                        tdkTestObj, actualresult1, details3 = GetSetApSecurityMode(obj,setMode,"setApSecurityModeEnabled");
                                time.sleep(10);
                                tdkTestObj, actualresult2, details4 = GetSetApSecurityMode(obj,"0","getApSecurityModeEnabled");
                                if expectedresult in actualresult1 :
                                    ...
                                    if expectedresult in actualresult2 :
                                        ...
                                        tdkTestObj, actualresult, details = GetSetApSecurityMode(obj,initMode,"setApSecurityModeEnabled");
                                        if expectedresult in actualresult:
