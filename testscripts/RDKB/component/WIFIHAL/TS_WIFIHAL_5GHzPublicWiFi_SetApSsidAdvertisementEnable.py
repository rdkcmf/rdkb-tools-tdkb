...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_SetApSsidAdvertisementEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApSsidAdvertisementEnable() to get the ApSSIDAdvertisementEnable and toggle the value by invoking wifi_setApSsidAdvertisementEnable and check if the set and get values are same for 5GHz Public WiFi.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Invoke the HAL API wifi_getApSsidAdvertisementEnable() to get the ApSSIDAdvertisementEnable and toggle the value by invoking wifi_setApSsidAdvertisementEnable and check if the set and get values are same for 5GHz Public WiFi.</test_objective>
...
2. Fetch the 5GHz Public WiFi Access Point index from platform properties file.
...
7. Unload the module</automation_approch>
    <expected_output>The ApSsidAdvertisementEnable should be retrieved from the HAL API wifi_getApSsidAdvertisementEnable() and the value should be toggled with the API wifi_setApSsidAdvertisementEnable() successfully for 5GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_SetApSsidAdvertisementEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApSsidAdvertisementEnable');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_SetApSsidAdvertisementEnable');
