...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThreshold</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamUIntValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the HighWatermarkThreshold value for 5GHz radio using wifi_getApAssociatedDevicesHighWatermarkThreshold HAL API and validate the same</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_67</test_case_id>
    <test_objective>To get the HighWatermarkThreshold value for 5GHz radio, that is lesser than or equal to MaxAssociatedDevices using wifi_getApAssociatedDevicesHighWatermarkThreshold HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThreshold.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThreshold.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThreshold</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApAssociatedDevicesHighWatermarkThreshold');
