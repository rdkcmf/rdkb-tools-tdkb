...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <test_objective>To get the HighWatermarkThreshold and MaxAssociatedDevices values for 5GHz radio using wifi_getApAssociatedDevicesHighWatermarkThreshold() and wifi_getApMaxAssociatedDevices() HAL APIS respectively. HighWatermarkThreshold value should be less than or equal to MaxAssociatedDevices. If MaxAssociatedDevices value is 0 then HighWatermarkThreshold value should be 50 which is the default value.</test_objective>
