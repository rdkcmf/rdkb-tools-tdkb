...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetRadioDCSSupported</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To invoke the api wifi_getRadioDCSSupported() for 5GHz and check whether the get value as expected.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_358</test_case_id>
    <test_objective>To check the functionality of wifi_getRadioDCSSupported() for 5GHz and check whether the get value as expected</test_objective>
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page.</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzGetRadioDCSSupported</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetRadioDCSSupported');
