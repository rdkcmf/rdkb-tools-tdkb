...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzPublicWiFi_CancelApWPS</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke the HAL API wifi_cancelApWPS() after enabling WPS using wifi_setApWpsEnable() for 5GHz Public WiFi.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To invoke the HAL API wifi_cancelApWPS() after enabling WPS using wifi_setApWpsEnable() for 5GHz Public WiFi.</test_objective>
...
7. Unload the modules.</automation_approch>
    <expected_output>The HAL API wifi_cancelApWPS() should be invoked successfully after enabling WPS using wifi_setApWpsEnable() for 5GHz Public WiFi.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_CancelApWPS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_CancelApWPS');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_CancelApWPS');
...
def cancelWPS(idx, step):
    ...
    print "\nTEST STEP %d: Call the function wifi_cancelApWPS() for 5 GHz Public WiFi" %step;
    ...
    if expectedresult in actualresult and details != "":
        ...
        if expectedresult in actualresult and details != "":
            ...
            if "Enabled" in ApWPSEnable:
                ...
                print "\nTEST STEP %d: Toggle the enabled state using wifi_setApWPSEnbale API for 5GHz Public WiFi" %step;
                ...
                if expectedresult in actualresult and details != "":
                    ...
                    if expectedresult in actualresult and details != "":
                        ...
                        if "Enabled" in ApWPSEnable:
                            ...
                            step = step + 1;
                            print "\nTEST STEP %d: Revert the enabled state using wifi_setApWPSEnbale API for 5GHz Public WiFi" %step;
