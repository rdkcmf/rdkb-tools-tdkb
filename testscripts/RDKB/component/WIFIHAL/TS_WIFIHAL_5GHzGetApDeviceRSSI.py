...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>14</version>
  <name>TS_WIFIHAL_5GHzGetApDeviceRSSI</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetApDeviceRSSI</primitive_test_name>
  <primitive_test_version>10</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the RSSI value set in device for 5GHz radio using wifi_getApDeviceRSSI API.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_324</test_case_id>
    <test_objective>To get the RSSI value set in device for 5GHz radio using wifi_getApDeviceRSSI API .</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>method name : getApDeviceRSSI
apindex : 1
...
4.Unload the module.</automation_approch>
    <except_output>Should successfully get the RSSI value from the device for 5GHz radio using WIFIHAL_GetApDeviceRSSI HAL API</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetApDeviceRSSI</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApDeviceRSSI');
