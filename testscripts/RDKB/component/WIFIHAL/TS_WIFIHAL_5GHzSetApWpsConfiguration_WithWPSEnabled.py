...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetApWpsConfiguration_WithWPSEnabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Invoke the HAL API wifi_setApWpsConfiguration() and set the WPS Mode to enabled, WPS PIN to a valid value and WPS Methods to Display and PushButton and cross check if the WPS configuration SET is reflected in the GET API wifi_getApWpsConfiguration() for 5G private AP.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_780</test_case_id>
    <test_objective>Invoke the HAL API wifi_setApWpsConfiguration() and set the WPS Mode to enabled, WPS PIN to a valid value and WPS Methods to Display and PushButton and cross check if the WPS configuration SET is reflected in the GET API wifi_getApWpsConfiguration() for 5G private AP.</test_objective>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetApWpsConfiguration_WithWPSEnabled');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetApWpsConfiguration_WithWPSEnabled');
