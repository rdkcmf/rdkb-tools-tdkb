...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzEnableCSIEngine_WithInvalidMAC</name>
  <primitive_test_id/>
...
4. Unload the modules.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzEnableCSIEngine_WithInvalidMAC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzEnableCSIEngine_WithInvalidMAC');
obj1.configureTestCase(ip,port,'TS_WIFIHAL_5GHzEnableCSIEngine_WithInvalidMAC');
