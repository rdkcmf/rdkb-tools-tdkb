...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIHAL_2.4GHzGetRadioDFSSupported</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke the api wifi_getRadioDfsSupport() for 2.4GHz and check whether the get value is false.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_520</test_case_id>
    <test_objective>To invoke the api wifi_getRadioDfsSupport() for 2.4GHz and check whether the get value is false.</test_objective>
...
2. Get whether DFS is supported for 2.4GHz using getRadioDFSSupported() API. Check if DFS Supported returns false for 2.4Ghz.
3. Unload Module</automation_approch>
    <expected_output>wifi_getRadioDfsSupport() for 2.4GHz should be Disabled</expected_output>
    <priority>High</priority>
    <test_stub_interface>Wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetRadioDFSSupported</test_script>
    <skipped>No</skipped>
