...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzGetApWpsConfigurationState</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>8</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the access point WpsConfigurationState for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_153</test_case_id>
    <test_objective>To set and get the access point WpsConfigurationState for 2.4GHz</test_objective>
...
5. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetaApWpsConfigurationState</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
