...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzSetRadioAutoChannelEnable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to enable/disable Auto Channel Enable status</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_524</test_case_id>
    <test_objective>To toggle AutoChannelEnable and verify the set operation</test_objective>
...
7. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetRadioAutoChannelEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetRadioAutoChannelEnable');
