...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>10</version>
  <name>TS_WIFIHAL_5GHzGetApDeviceTxrate</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetApDeviceTxRxRate</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the Tx rate of Ap associated devices for 5GHz.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To get the Tx rate of Ap associated devices for 5GHz.</test_objective>
...
3.Unload the module.</automation_approch>
    <except_output>Get the Tx rate of Ap associated devices for 5GHz.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetApDeviceTxrate</test_script>
    <skipped>No</skipped>
    <release_version/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApDeviceTxrate');
