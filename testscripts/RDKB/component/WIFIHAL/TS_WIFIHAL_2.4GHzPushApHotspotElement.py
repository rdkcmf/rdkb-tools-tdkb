...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzPushApHotspotElement</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_437</test_case_id>
...
6.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzPushApHotspotElement</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPushApHotspotElement');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    #Set the result status of execution
	    tdkTestObj.setResultStatus("SUCCESS");
	    print "TEST STEP 2: Toggle the ApHotspotElement enabled status for 2.4GHz";
	    print "EXPECTED RESULT 2: Should toggle the ApHotspotElement enable status for 2.4GHz to ", expectedStatus ;
		...
		if newStatus == expectedStatus:
		    #Set the result status of execution
		    tdkTestObj.setResultStatus("SUCCESS");
		    print "TEST STEP 3: Get the ApHotspotElement enabled status for 2.4GHz";
	...
	if expectedresult in actualresult:
	    #Set the result status of execution
	    tdkTestObj.setResultStatus("SUCCESS");
	    print "TEST STEP : Revert the ApHotspotElement enabled status for 2.4GHz";
	    print "EXPECTED RESULT : Should revert the ApHotspotElement enabled status for 2.4GHz";
