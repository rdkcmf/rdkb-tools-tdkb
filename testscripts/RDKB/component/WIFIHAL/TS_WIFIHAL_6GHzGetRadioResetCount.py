...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzGetRadioResetCount</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_662</test_case_id>
...
wifi_reset()
    ...
    <input_parameters>methodName : getRadioResetCount</input_parameters>
...
6. Unload wifihal module</automation_approch>
    <expected_output>Should increment by 1 after reset operation</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzGetRadioResetCount</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzGetRadioResetCount');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
		...
		print "initCount: %s "%initCount;
                if initCount.isdigit():
		    ...
		    if expectedresult in actualresult:
		        ...
		        print "wifi_reset() call failed";
                    ...
                    tdkTestObj.setResultStatus("FAILURE");
                    print "Radio reset count received is a not a digit";
            else:
		tdkTestObj.setResultStatus("FAILURE");
