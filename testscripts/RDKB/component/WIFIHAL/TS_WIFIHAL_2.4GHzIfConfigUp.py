...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzIfConfigUp</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To call wifi_ifConfigUp() api and check whether it returns SUCCESS for 2.4GHz.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To call wifi_ifConfigUp() api and check whether it returns SUCCESS for 2.4GHz.</test_objective>
...
2.Call wifi_ifConfigUp() api and check whether it returns SUCCESS for 2.4GHz.
3.Unload the module.</automation_approch>
    <except_output>wifi_ifConfigUp() api should return success for 2.4GHz</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzIfConfigUp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzIfConfigUp');
