...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>TS_WIFIHAL_5GHzFactoryResetAp</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_332</test_case_id>
...
9.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzFactoryResetAp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzFactoryResetAp');
                    ...
                    if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if SSIDName_afterFactoryReset !=  SSIDName_beforeFactoryReset:
                                ...
                                print "TEST STEP5 : Compare values of SSID Name before and after wifi_factoryResetAP"
