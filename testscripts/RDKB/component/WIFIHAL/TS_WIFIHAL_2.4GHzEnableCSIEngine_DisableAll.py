...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzEnableCSIEngine_DisableAll</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_585</test_case_id>
...
7. Unload the wifihal and sysutil module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzEnableCSIEngine_DisableAll</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzEnableCSIEngine_DisableAll');
obj1.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzEnableCSIEngine_DisableAll');
