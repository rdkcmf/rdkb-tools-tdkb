...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetApWpsConfigMethodsEnabled</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the WPS configMethod Enabled values for 5GHz radio using wifi_getApWpsConfigMethodsEnabled HAL API and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To get the WPS configMethod Enabled values for 5GHz radio using wifi_getApWpsConfigMethodsEnabled HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetApWpsConfigMethodsEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetApWpsConfigMethodsEnabled.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzGetApWpsConfigMethodsEnabled</test_script>
    <skipped>No</skipped>
