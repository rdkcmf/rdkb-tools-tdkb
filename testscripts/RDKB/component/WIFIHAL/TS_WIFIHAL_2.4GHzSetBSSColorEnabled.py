...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzSetBSSColorEnabled</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_478</test_case_id>
...
2. Invoke wifi_getBSSColorEnabled for 2.4GHz and save the current BSSColorEnabled status
...
6. Unload wifi hal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetBSSColorEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetBSSColorEnabled');
