...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WIFIHAL_2.4GHzSetApDTIMInterval</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>To  set the DTIM Interval with wifi_setApDTIMInterval and validate for 2.4 GHz WiFi</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>This test case is to  set the DTIM Interval with wifi_setApDTIMInterval and validate for 2.4 GHz WiFi</test_objective>
...
6.Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzSetApDTIMInterval</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApDTIMInterval');
sysObj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApDTIMInterval');
