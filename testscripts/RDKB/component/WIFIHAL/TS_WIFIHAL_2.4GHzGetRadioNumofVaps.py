...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_2.4GHzGetRadioNumofVaps</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetRadioVapInfoMap</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the Radio number of vaps  for 2.4G  wifi using wifi_getRadioVapInfoMap.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_689</test_case_id>
    <test_objective>To get the Radio number of vaps  for 2.4G  wifi using wifi_getRadioVapInfoMap</test_objective>
...
4.Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetRadioNumofVaps</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetRadioNumofVaps');
obj1.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetRadioNumofVaps');
