...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_5GHz_SetApBeaconInterval</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>>To set the Beacon Interval with wifi_setApBeaconInterval and validate for 5 Ghz WIFI</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_378</test_case_id>
    <test_objective>This test case is to set the Beacon Interval with wifi_setApBeaconInterval and validate for 5 Ghz WIFI.</test_objective>
...
6. Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHz_SetApBeaconInterval</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHz_SetApBeaconInterval');
sysObj.configureTestCase(ip,port,'TS_WIFIHAL_5GHz_SetApBeaconInterval');
