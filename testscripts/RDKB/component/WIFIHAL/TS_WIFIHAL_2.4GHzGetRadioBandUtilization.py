...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetRadioBandUtilization</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_311</test_case_id>
    <test_objective>This test script is to read the radio band utilization using wifi_getRadioBandUtilization()</test_objective>
...
3. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetRadioBandUtilization</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetRadioBandUtilization');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if idx == -1:
		...
		if 0 <= radioBandUtilization < 100 :
		    ...
		    print "FAILURE: Radio band utilization value not in the expected range"
	    else:
		#Set the result status of execution
		tdkTestObj.setResultStatus("FAILURE");
		print "TEST STEP 1: Get the Radio band utilization in percentage"
