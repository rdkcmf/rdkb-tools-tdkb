...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetInvalidRadioChannel</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamULongValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To To set an invalid value to RadioChannel for 5GHz and check whether it is failing or not</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_26</test_case_id>
    <test_objective>To set an invalid value to RadioChannel for 5GHz and check whether it is failing or not</test_objective>
...
2. Invoke "WIFIHAL_GetOrSetParamULongValue" to set the invalid value to radio channel for 5GHz
...
5.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetInvalidRadioChannel</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetInvalidRadioChannel');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("radioIndex",2);
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 3: Set invalid value to Radio channel for 5GHz";
                print "EXPECTED RESULT 3: Should not set the invalid value to Radio channel for 5GHz";
            ...
            if expectedresult in actualresult:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP : Set default value to Radio channel for 5GHz";
                print "EXPECTED RESULT : Should set the default value to Radio channel for 5GHz";
