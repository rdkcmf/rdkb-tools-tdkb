...
2. With the help of the function WIFIHAL_GetOrSetParamUIntValue invoke the HAL API wifi_getInterworkingAccessNetworkType for 5GHz Public WiFi. The GET should be success.
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    print "TEST STEP 1: Invoke the wifi_getInterworkingAccessNetworkType api for 5GHz Public WiFi";
