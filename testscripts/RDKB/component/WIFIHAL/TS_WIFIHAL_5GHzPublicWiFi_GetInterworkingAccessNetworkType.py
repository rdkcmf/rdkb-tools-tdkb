...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzPublicWiFi_GetInterworkingAccessNetworkType</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To invoke wifi_getInterworkingAccessNetworkType() HAL API for 5GHz Public WiFi and retrieve the Interworking Network Access Type.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_562</test_case_id>
    <test_objective>To invoke wifi_getInterworkingAccessNetworkType() HAL API for 5GHz Public WiFi  and retrieve the Interworking Network Access Type.</test_objective>
...
2. Get the 5G5G5G5G5GHz Public WiFi AP Index from platform.properties file
3. With the help of the function WIFIHAL_GetOrSetParamUIntValue invoke the HAL API wifi_getInterworkingAccessNetworkType for 5GHz Public WiFi. The GET should be success.
...
6. Unload the module</automation_approch>
    <expected_output>wifi_getInterworkingAccessNetworkType() HAL API for 5GHz Public WiFi should be invoked successfully and the Interworking Network Access Type retrieved</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPublicWiFi_GetInterworkingAccessNetworkType</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_GetInterworkingAccessNetworkType');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPublicWiFi_GetInterworkingAccessNetworkType');
