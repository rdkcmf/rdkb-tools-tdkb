...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetRadioBasicDataTransmitRates</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the Data Transmit Rates for 2.4GHz radio using wifi_getRadioBasicDataTransmitRates HAL API and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_45</test_case_id>
    <test_objective>To get the Data Transmit Rates for 2.4GHz radio using wifi_getRadioBasicDataTransmitRates HAL API and validate the same</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>methodName   :   getRadioBasicDataTransmitRates
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzGetRadioBasicDataTransmitRates.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzGetRadioBasicDataTransmitRates.py) using execution page of  Test Manager GUI
...
5.WIFIHAL_GetOrSetParamStringValue function will call Ccsp Base Function named "ssp_WIFIHALGetOrSetParamStringValue", that inturn will call WIFIHAL Library Function wifi_getRadioBasicDataTransmitRates() function
...
1:wifi_getRadioBasicDataTransmitRates log from DUT should be available in Agent Console LogCheckPoint
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page"""</except_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetRadioBasicDataTransmitRates</test_script>
    <skipped>No</skipped>
