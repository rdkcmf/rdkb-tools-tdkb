...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_3Entries</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_PushApRoamingConsortiumElement</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set an OUI list with 3 OUI entries using wifi_pushApRoamingConsortiumElement() and verify it using wifi_getApRoamingConsortiumElement()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_449</test_case_id>
    <test_objective>Set an OUI list with 3 OUI entries using wifi_pushApRoamingConsortiumElement() and verify it using wifi_getApRoamingConsortiumElement()</test_objective>
...
3. Set a new RoamingConsortiumElement with 3 OUI entries using wifi_pushApRoamingConsortiumElement
...
6. Unload wifihal module</automation_approch>
    <expected_output>Should successfully set an OUI list with 3 entries using wifi_pushApRoamingConsortiumElement()</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_3Entries</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPushApRoamingConsortiumElement_3Entries');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	print "[TEST EXECUTION RESULT] : SUCCESS";
        ...
        #extract the entryCount, ouis and it length values to be used for revert operation
        ...
        print "TEST STEP 2: Set RoamingConsortiumElement  3 OUIs for 2.4GHz";
        print "EXPECTED RESULT 2: Should successfully set RoamingConsortiumElement  3 OUIs for 2.4GHz";

        #Invoke the Push API
        ouiCount = 3
        ouiList = "506f9a,506f9b,001bc504bd"
        ouiLen = str(len(binascii.a2b_hex("506f9a"))) + "," + str(len(binascii.a2b_hex("506f9b"))) + "," + str(len(binascii.a2b_hex("001bc504bd")))
