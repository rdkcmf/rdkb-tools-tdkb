...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetBandSteeringBandUtilizationThreshold</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the band steering band utilization threshold and get the same for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_145</test_case_id>
    <test_objective>To set and get the BandSteering BandUtilizationThreshold for 2.4GHz</test_objective>
...
4. Using WIFIHAL_GetOrSetParamStringValue 
 invoke wifi_setBandSteeringBandUtilizationThreshold and set a valid value
...
8. Unload wifihal module</automation_approch>
    <except_output>Set and get values of BandUtilizationThreshold should be the same</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetBandSteeringBandUtilizationThreshold</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetBandSteeringBandUtilizationThreshold');
