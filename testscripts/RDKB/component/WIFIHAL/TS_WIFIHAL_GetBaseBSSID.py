...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_GetBaseBSSID</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the BSSID for the device using wifi_getBaseBSSID API and validate the samed</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_102</test_case_id>
    <test_objective>To get the BSSID for the device using wifi_getBaseBSSID HAL API and validate the same</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XB3. XB6, Emulator, Rpi</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state else invoke cosa_start.sh manually that includes all the ccsp components and TDK Component
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>wifi_getBaseBSSID()</api_or_interface_used>
    <input_parameters>methodName   :   getBaseBSSID
ssidIndex   :    0</input_parameters>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_GetBaseBSSID.py)
3.Execute the generated Script(TS_WIFIHAL_GetBaseBSSID.py) using execution page of  Test Manager GUI
...
5.WIFIHAL_GetOrSetParamIntValue function will call Ccsp Base Function named "ssp_WIFIHALGetOrSetParamIntValue", that inturn will call WIFIHAL Library Function wifi_getBaseBSSID() function
...
1:wifi_getBaseBSSID log from DUT should be available in Agent Console LogCheckPoint
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_GetBaseBSSID</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
