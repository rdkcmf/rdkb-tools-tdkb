...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetApBasicAuthenticationMode</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Check Authentication mode set in device for 5GHz radio using wifi_getApBasicAuthenticationMode HAL API and validate the same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_68</test_case_id>
    <test_objective>To Check Authentication mode set in device for 5GHz radio using wifi_getApBasicAuthenticationMode HAL API and validate the same</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_5GHzGetApBasicAuthenticationMode.py)
3.Execute the generated Script(TS_WIFIHAL_5GHzGetApBasicAuthenticationMode.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_5GHzGetApBasicAuthenticationMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApBasicAuthenticationMode');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApBasicAuthenticationMode');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in sysloadmodulestatus.upper():
    ...
    if supportedAuthModes and expectedresult in actualresult:
        ...
        if expectedresult in actualresult :
            ...
            print "**************************************************";
            print "TEST STEP 2: Get the Ap Basic Authentication mode for 5GHz";
            print "EXPECTED RESULT 2: Should successfully get the Ap Basic Authentication mode for 5GHz";
            print "ACTUAL RESULT 2: Successfully got the Ap Basic Authentication mode as %s for 5GHz"%receivedMode;
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : SUCCESS";
            print "**************************************************";
	    if receivedMode in supportedModes:
            ...
            print "TEST STEP 2: Get the Ap Basic Authentication mode for 5GHz";
            print "EXPECTED RESULT 2: Should successfully get the Ap Basic Authentication mode for 5GHz";
            print "ACTUAL RESULT 2: Failed to get the Ap Basic Authentication mode for 5GHz";
            print details;
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : FAILURE";
            print "**************************************************";
