...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIHAL_2.4GHzGetSSIDName</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamStringValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the SSIDName for 2.4GHz radio using wifi_getSSIDName HAL API and validate the same</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_50</test_case_id>
    <test_objective>To get the SSIDName for 2.4GHz radio using wifi_getSSIDName HAL API and validate the same.</test_objective>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzGetSSIDName.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzGetSSIDName.py) using execution page of  Test Manager GUI
...
3:Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetSSIDName</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
