...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzPushApEnable</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To push Ap Enable using wifi_pushApEnable() HAL API and validate the same using wifi_getApEnable() HAL API for 5GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_320</test_case_id>
    <test_objective>To push Ap Enable using wifi_pushApEnable() HAL API and validate the same using wifi_getApEnable() HAL API for 5GHz</test_objective>
...
6. Unload wifihal module</automation_approch>
    <except_output>To successfully push the Ap Enable value using wifi_pushApEnable() HAL API for 5GHz.</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzPushApEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzPushApEnable');
