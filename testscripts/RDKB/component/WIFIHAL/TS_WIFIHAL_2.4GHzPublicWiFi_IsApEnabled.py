...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzPublicWiFi_IsApEnabled</name>
  <primitive_test_id/>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_WIFIHAL_2.4GHzPublicWiFi_IsApEnabled.py)
3.Execute the generated Script(TS_WIFIHAL_2.4GHzPublicWiFi_IsApEnabled.py) using execution page of  Test Manager GUI
...
8.Test Manager will publish the result in GUI as SUCCESS/FAILURE based on the response from wifihalstub</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzPublicWiFi_IsApEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzPublicWiFi_IsApEnabled');
