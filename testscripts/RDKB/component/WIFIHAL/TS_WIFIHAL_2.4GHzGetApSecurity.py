...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIHAL_2.4GHzGetApSecurity</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetApSecurity</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getApSecurity() for 2.4G private AP and retrieve all the AP security details and verify if the values are valid.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_756</test_case_id>
    <test_objective>Invoke the HAL API wifi_getApSecurity() for 2.4G private AP and retrieve all the AP security details and verify if the values are valid.</test_objective>
...
4. Unload the modules.</automation_approch>
    <expected_output>Invocation of the HAL API wifi_getApSecurity() for 2.4G private AP should be success and all the AP security details retrieved should be valid.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzGetApSecurity</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetApSecurity');
