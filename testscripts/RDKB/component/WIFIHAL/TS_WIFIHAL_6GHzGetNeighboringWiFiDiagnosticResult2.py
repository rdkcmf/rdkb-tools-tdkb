...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzGetNeighboringWiFiDiagnosticResult2</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetNeighboringWiFiDiagnosticResult2</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Invoke the HAL API wifi_getNeighboringWiFiDiagnosticResult2() to retrieve the neighboring WiFi diagnostic results for 6Ghz radio.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_677</test_case_id>
    <test_objective>Invoke the HAL API wifi_getNeighboringWiFiDiagnosticResult2() to retrieve the neighboring WiFi diagnostic results for 6Ghz radio.</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>methodname : getNeighboringWiFiDiagnosticResult2
radioIndex : 6G radio index</input_parameters>
    <automation_approch>1. Load the module
2. Invoke the HAL API wifi_getNeighboringWiFiDiagnosticResult2() to retrieve the Neighboring WiFi Diagnostic Results.
3. Unload the module.</automation_approch>
    <expected_output>Invoking the HAL API wifi_getNeighboringWiFiDiagnosticResult2() should be success and the neighboring WiFi diagnostic results for 6Ghz radio should be retrieved successfully.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifihal</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzGetNeighboringWiFiDiagnosticResult2</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzGetNeighboringWiFiDiagnosticResult2');
