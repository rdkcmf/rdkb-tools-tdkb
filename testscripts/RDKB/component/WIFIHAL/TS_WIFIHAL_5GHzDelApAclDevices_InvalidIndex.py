...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzDelApAclDevices_InvalidIndex</name>
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_536</test_case_id>
...
10.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzDelApAclDevices_InvalidIndex</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzDelApAclDevices_InvalidIndex');
