...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzSetRadioMCS</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set and get the radio MCS for 5GHz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_137</test_case_id>
    <test_objective>To set and get the Radio MCS for 5GHz</test_objective>
...
7. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetRadioMCS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzSetRadioMCS');
