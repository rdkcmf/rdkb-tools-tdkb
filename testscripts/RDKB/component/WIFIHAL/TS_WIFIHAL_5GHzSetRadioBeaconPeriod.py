...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzSetRadioBeaconPeriod</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamUIntValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get the beacon period for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_138</test_case_id>
    <test_objective>To set and get the BeaconPeriod for 5GHz</test_objective>
...
7. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzSetRadioBeaconPeriod</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
