...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHZGetApAssociatedDeviceDiagnosticResult2</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetApAssociatedDeviceDiagnosticResult2</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check the value of output_array_size,cli_MaxRSSI,cli_OperatingStandard,cli_IPAddress  using wifi_getApAssociatedDeviceDiagnosticResult2</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check value of output_array_size,cli_MaxRSSI,cli_OperatingStandard,cli_IPAddress  using wifi_getApAssociatedDeviceDiagnosticResult2</test_objective>
...
2.Get the getApAssociatedDeviceDiagnosticResult2  using   wifi_getApAssociatedDeviceDiagnosticResult2.
...
4.Unload module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHZGetApAssociatedDeviceDiagnosticResult2</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHZGetApAssociatedDeviceDiagnosticResult2');
