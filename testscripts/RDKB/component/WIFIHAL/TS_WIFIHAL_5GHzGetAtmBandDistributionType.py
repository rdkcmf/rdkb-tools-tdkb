...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzGetAtmBandDistributionType</name>
  <primitive_test_id/>
...
4.Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetAtmBandDistributionType</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetAtmBandDistributionType');
sysobj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetAtmBandDistributionType');
