...
if "SUCCESS" in loadmodulestatus.upper():
	...
	print "[TEST EXECUTION RESULT] : SUCCESS";
        ...
        print "TEST STEP 2: Set RoamingConsortiumElement  with 2 OUIs for 5GHz";
        print "EXPECTED RESULT 2: Should successfully set RoamingConsortiumElement  with 2 OUIs for 5GHz";
        ouiCount = 2
