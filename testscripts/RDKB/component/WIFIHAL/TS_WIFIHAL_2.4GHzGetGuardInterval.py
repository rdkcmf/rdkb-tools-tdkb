...
<xml>
  ...
  <name>TS_WIFIHAL_2.4GHzGetGuardInterval</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_480</test_case_id>
...
2. Invoke wifi_getGuardInterval for 2.4GHz and check if its return was success
...
4. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetGuardInterval</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetGuardInterval');
