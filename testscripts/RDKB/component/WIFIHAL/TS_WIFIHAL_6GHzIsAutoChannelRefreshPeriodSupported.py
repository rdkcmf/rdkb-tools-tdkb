...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzIsAutoChannelRefreshPeriodSupported</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_701</test_case_id>
...
5. Unload wifihal module</automation_approch>
    <expected_output>wifi_getRadioAutoChannelRefreshPeriodSupported should be fetched successfully</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzIsAutoChannelRefreshPeriodSupported</test_script>
    <skipped>No</skipped>
