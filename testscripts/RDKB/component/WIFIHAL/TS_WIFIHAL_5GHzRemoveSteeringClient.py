...
8. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzRemoveSteeringClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzRemoveSteeringClient');
sysObj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzRemoveSteeringClient');
wifiObj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzRemoveSteeringClient');
