...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzIsSSIDEnabled</name>
  <primitive_test_id/>
...
ssidIndex : 2</input_parameters>
    <automation_approch>1.Load wifihal module
2.Get the current SSID enable status using wifi_getSSIDEnable
3.Toggle the SSID status using wifi_setSSIDEnable
4.Revert the set value
5.Unload the module</automation_approch>
    <expected_output>Set and get operation for SSID enable and disable should be successful</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_6GHzIsSSIDEnabled</test_script>
    <skipped>No</skipped>
