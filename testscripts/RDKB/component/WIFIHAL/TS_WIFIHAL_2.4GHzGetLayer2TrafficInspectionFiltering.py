...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzGetLayer2TrafficInspectionFiltering</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the current Layer2TrafficInspectionFiltering enabled status for 2.4G using wifi_getLayer2TrafficInspectionFiltering()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_417</test_case_id>
    <test_objective>Get the current Layer2TrafficInspectionFiltering enabled status for 2.4G using wifi_getLayer2TrafficInspectionFiltering()</test_objective>
...
4.Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_2.4GHzGetLayer2TrafficInspectionFiltering</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzGetLayer2TrafficInspectionFiltering');
