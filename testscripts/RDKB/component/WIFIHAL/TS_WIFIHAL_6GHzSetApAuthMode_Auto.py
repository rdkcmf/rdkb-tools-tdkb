...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_6GHzSetApAuthMode_Auto</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamIntValue</primitive_test_name>
  <primitive_test_version>5</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the authorization mode as auto for 6GHz and check if it is success.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_697</test_case_id>
    <test_objective>To set the authorization mode as auto for 6GHz and check if it is success</test_objective>
...
5. Unload wifihal module</automation_approch>
    ...
    <test_script>TS_WIFIHAL_6GHzSetApAuthMode_Auto</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_6GHzSetApAuthMode_Auto');
