...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_2.4GHzSetApRtsThreshold</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if ApRtsThreshold is supported, if supported set the ApRtsThreshold for 2.4GHz</synopsis>
  <groups_id/>
  ...
  <rdk_versions/>
  <test_cases>
    <test_case_id>TC_WIFIHAL_185</test_case_id>
    <test_objective>To check if ApRtsThreshold is supported, if supported set the ApRtsThreshold for 2.4GHz</test_objective>
...
2. wifi_setApRtsThreshold should return SUCCESS</except_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_2.4GHzSetApRtsThreshold</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_2.4GHzSetApRtsThreshold');
