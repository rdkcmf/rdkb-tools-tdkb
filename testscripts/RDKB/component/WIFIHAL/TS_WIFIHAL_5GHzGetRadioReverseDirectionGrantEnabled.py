...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIHAL_5GHzGetRadioReverseDirectionGrantEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIHAL_GetOrSetParamBoolValue</primitive_test_name>
  <primitive_test_version>4</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if RadioReverseDirectionGrant is supported and if supported check if it is enabled for 5GHz</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIHAL_249</test_case_id>
    <test_objective>To check if RadioReverseDirectionGrant is supported and if supported check if it is enabled for 5GHz</test_objective>
...
4.Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIHAL_5GHzGetRadioReverseDirectionGrantEnabled</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetRadioReverseDirectionGrantEnabled');
