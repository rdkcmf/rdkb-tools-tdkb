...
<xml>
  ...
  <name>TS_WIFIHAL_5GHzGetApAclDevices</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get List of Acl Devices associated with particular apIndex value and the number of devices in that list at radioIndex 5GHz.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TS_WIFIHAL_350</test_case_id>
...
4.Unload the module.</automation_approch>
    <expected_output>should get the mac addresses of the acl devices</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIHAL</test_stub_interface>
    <test_script>TS_WIFIHAL_5GHzGetApAclDevices</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIHAL_5GHzGetApAclDevices');
