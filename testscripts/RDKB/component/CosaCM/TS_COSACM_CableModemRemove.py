...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_COSACM_CableModemRemove</name>
  <primitive_test_id/>
  <primitive_test_name>COSACM_CableModemRemove</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test case to validate CosaCableModemRemove API</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_COSACM_62</test_case_id>
    <test_objective>To Validate Cable Modem object
Remove API</test_objective>
...
Input
Handle to the object - Valid object</input_parameters>
...
3.Execute the generated Script(TS_COSACM_CableModemRemove.py) using execution page of  Test Manager GUI 
...
object memory is freed successfully.
</except_output>
    <priority>High</priority>
    <test_stub_interface>None</test_stub_interface>
    <test_script>TS_COSACM_CableModemRemove</test_script>
    <skipped>No</skipped>
    <release_version/>
