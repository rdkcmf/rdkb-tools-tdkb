...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_COSACM_GetDOCSISInfo</name>
  <primitive_test_id/>
  <primitive_test_name>COSACM_GetDOCSISInfo</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test case to verify CosaDmlCMGetDOCSISInfo API</synopsis>
...
2.Create a Python Script  (TS_COSACM_GetDOCSISInfo.py) in Test Manager through Add new rdkb script option
...
Cosa CM Get DOCSIS Info success log from DUT should be available in Agent Console Log
CheckPoint 2:
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_COSACM_GetDOCSISInfo</test_script>
    <skipped>No</skipped>
    <release_version/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_COSACM_GetDOCSISInfo');
