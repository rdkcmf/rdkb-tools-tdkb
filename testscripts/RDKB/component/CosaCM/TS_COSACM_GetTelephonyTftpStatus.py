...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_COSACM_GetTelephonyTftpStatus</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_COSACM_27</test_case_id>
    <test_objective>To Validate Cable Modem 
"CosaDmlCMGetTelephonyTftpStatus" API</test_objective>
...
2.Create a Python Script in Test Manager with default primitive test case through add new rdkb script option (TS_COSACM_GetTelephonyTftpStatus.py)
3.Customize the generated script template to handle load/unload and pass/fail scenarios
3.Execute the generated Script(TS_COSACM_GetTelephonyTftpStatus.py) using execution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_COSACM_GetTelephonyTftpStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 1:Get Telephony Tftp Status";
            print "EXPECTED RESULT 1: Should Get Telephony Tftp Status";
