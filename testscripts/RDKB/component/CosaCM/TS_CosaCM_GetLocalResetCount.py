...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_CosaCM_GetLocalResetCount</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_COSACM_8</test_case_id>
    <test_objective>To retrieve the local reset count</test_objective>
...
4.From python script, invoke CosaCM_GetResetCount() stub function to get the value of local reset count.
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_script>TS_CosaCM_GetLocalResetCount</test_script>
    <skipped>No</skipped>
    <release_version/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CosaCM_GetLocalResetCount');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 1: Retrieve the Local reset count";
            print "EXPECTED RESULT 1: Should retrieve the Local reset count successfully";
