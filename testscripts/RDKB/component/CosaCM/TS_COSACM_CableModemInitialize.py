...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_COSACM_CableModemInitialize</name>
  <primitive_test_id/>
  <primitive_test_name>COSACM_CableModemInitialize</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test Case to validate the API CosaCableModemInitialize</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_COSACM_60</test_case_id>
    <test_objective>To Validate Cable Modem object
Intialize API</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Emulator,
XB3</test_setup>
    <pre_requisite>1.Ccsp Components in DUT should be in a running state that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script
3.Test case TC_COSACM_62 should have passed.
...
Input
Handle to the object - Valid handle sent
...
Cosa object should be intialized successfully and return  success which should be available in Agent Console Log
    ...
    <test_script>TS_COSACM_CableModemInitialize</test_script>
    <skipped>No</skipped>
    <release_version/>
