...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_COSACM_GetCMCertStatus</name>
  <primitive_test_id/>
  <primitive_test_name>COSACM_GetCMCertStatus</primitive_test_name>
...
2.Create a Python Script in Test Manager with default primitive test case through add new rdkb script option (TS_COSACM_GetCMCertStatus.py)
...
Cosa CM Get Certificate Status success log from DUT should be available in Agent Console Log
CheckPoint 2:
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_COSACM_GetCMCertStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_COSACM_GetCMCertStatus');
