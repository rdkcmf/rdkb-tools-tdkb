...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_CosaCM_GetCMResetCount</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_COSACM_6</test_case_id>
    <test_objective>To retrieve the reset count of cable modem</test_objective>
...
4.From python script, invoke CosaCM_GetResetCount() stub function to get the value of cable modem reset count
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_script>TS_CosaCM_GetCMResetCount</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CosaCM_GetCMResetCount');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 1: Retrieve the CM reset count";
            print "EXPECTED RESULT 1: Should retrieve the CM reset count successfully";
