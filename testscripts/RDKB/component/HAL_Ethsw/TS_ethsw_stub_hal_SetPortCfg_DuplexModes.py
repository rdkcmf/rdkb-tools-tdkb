...
4. Set the all possible values of duplex mode for port cfg
...
obj1.configureTestCase(ip,port,'TS_ethsw_stub_hal_SetPortCfg_DuplexModes');
            ...
            if port <= NumOfPorts :
                ...
                if expectedresult in actualresult and details:
                    ...
                    for mode in testDuplexModeList:
                        ...
                        if expectedresult in actualresult and details:
                            print "\nTEST STEP %d: Set the Ethsw_Set_Port_Cfg for port %d" %(step, port);
                            ...
                            if expectedresult in actualresult and details:
                                ...
                                #Set the result status of execution
                                tdkTestObj.setResultStatus("SUCCESS");
                                print "\nTEST STEP %d: Retrieve the Ethsw_Get_Port_Cfg for port %d" %(step, port);
                                print "EXPECTED RESULT %d: Should retrieve the Ethsw_Get_Port_Cfg successfully" %step;
                                ...
                                if duplexModeAfterSet == mode:
                                    tdkTestObj.setResultStatus("SUCCESS");
                                    print "\nTEST STEP %d: Cross verify value if those get set" %step
                                ...
                                print "\nTEST STEP %d: Retrieve the Ethsw_Get_Port_Cfg for port %d" %(step, port);
                                print "EXPECTED RESULT %d: Should retrieve the Ethsw_Get_Port_Cfg successfully" %step;
                                print "ACTUAL RESULT %d: Faied to get the port cfg" %step;
                                print "[TEST EXECUTION RESULT] : %s" %actualresult;
                        else:
                            tdkTestObj.setResultStatus("FAILURE");
                            print "\nTEST STEP %d: Set the Ethsw_Set_Port_Cfg for port %d" %(step, port);
                    ...
                    if expectedresult in actualresult and details:
                        tdkTestObj.setResultStatus("SUCCESS");
                        print "\nTEST STEP %d: Resetting the Ethsw_Set_Port_Cfg for port %d" %(step, port) ;
                        print "EXPECTED RESULT %d: Should reset the Port_Cfg successfully" %step;
                        print "ACTUAL RESULT %d: Port_Cfg reset was successful" %step;
                        #Get the result of execution
                        print "[TEST EXECUTION RESULT] : %s" %actualresult;
                    else:
                        tdkTestObj.setResultStatus("FAILURE");
                        print "\nTEST STEP %d: Resetting the Ethsw_Set_Port_Cfg for port %d" %(step, port);
                        print "EXPECTED RESULT %d: Should retrieve the Ethsw_Set_Port_Cfg successfully" %step ;
                        print "ACTUAL RESULT %d: Port_Cfg reset was not successful" %step;
                        #Get the result of execution
                        print "[TEST EXECUTION RESULT] : %s" %actualresult;
                else:
                    #Set the result status of execution
