...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ethsw_stub_hal_SetPortCfg_LinkRates</name>
  <primitive_test_id/>
  <primitive_test_name>ethsw_stub_hal_SetPortCfg</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate Ethsw HAL API CcspHalEthSwSetPortCfg() by setting all possible link rates</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Ethsw_22</test_case_id>
    <test_objective>To validate Ethsw HAL API CcspHalEthSwSetPortCfg() by setting all possible link rates</test_objective>
...
3. Set the all possible values of link rate for port cfg
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_Ethsw stub.</automation_approch>
    <expected_output>The set operation of all link rate should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>HAL_Ethsw</test_stub_interface>
    <test_script>TS_ethsw_stub_hal_SetPortCfg_LinkRates</test_script>
    <skipped>No</skipped>
