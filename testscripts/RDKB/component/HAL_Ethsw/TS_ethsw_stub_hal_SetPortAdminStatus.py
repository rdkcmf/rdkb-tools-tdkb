...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>16</version>
  <name>TS_ethsw_stub_hal_SetPortAdminStatus</name>
  <primitive_test_id/>
  <primitive_test_name>ethsw_stub_hal_SetPortAdminStatus</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate Ethsw HAL API CcspHalEthSwSetPortAdminStatus().</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Ethsw_7</test_case_id>
    <test_objective>To validate Ethsw HAL API CcspHalEthSwSetPortAdminStatus()</test_objective>
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_Ethsw stub.</automation_approch>
    ...
    <test_script>TS_ethsw_stub_hal_SetPortAdminStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_ethsw_stub_hal_SetPortAdminStatus');
