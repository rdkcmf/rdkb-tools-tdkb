...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ethsw_stub_hal_Get_Port_Status_InvalidPort</name>
  <primitive_test_id/>
  <primitive_test_name>ethsw_stub_hal_Get_Port_Status</primitive_test_name>
  <primitive_test_version>4</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate  HAL API CcspHalEthSwGetPortStatus() by giving invalid port ID</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To validate  HAL API CcspHalEthSwGetPortStatus() by giving invalid port ID</test_objective>
...
2. Give invalid port number to CcspHalEthSwGetPortStatus()
3. Check if the api returns failure or not
4. Unload module</automation_approch>
    <expected_output>The API should return failure with invalid port number</expected_output>
    <priority>High</priority>
    <test_stub_interface>HAL_Ethsw</test_stub_interface>
    <test_script>TS_ethsw_stub_hal_Get_Port_Status_InvalidPort</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_ethsw_stub_hal_Get_Port_Status_InvalidPort');
