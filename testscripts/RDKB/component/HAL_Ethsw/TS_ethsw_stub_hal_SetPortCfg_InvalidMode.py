...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ethsw_stub_hal_SetPortCfg_InvalidMode</name>
  <primitive_test_id/>
  <primitive_test_name>ethsw_stub_hal_SetPortCfg</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate Ethsw HAL API CcspHalEthSwSetPortCfg() by giving invalid duplex mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Ethsw_14</test_case_id>
    <test_objective>To validate Ethsw HAL API CcspHalEthSwSetPortCfg() by giving invalid duplex mode</test_objective>
...
3. Set the invalid value of duplex mode for port cfg
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_Ethsw stub.</automation_approch>
    <expected_output>The set operation of invalid duplex mode should fail</expected_output>
    <priority>High</priority>
    <test_stub_interface>HAL_Ethsw</test_stub_interface>
    <test_script>TS_ethsw_stub_hal_SetPortCfg_InvalidMode</test_script>
    <skipped>No</skipped>
...
port_id = 2
testDuplexMode = "INVALID_DUPLEX_MODE";
testLinkRate = 10;
#Test component to be tested
obj = tdklib.TDKScriptingLibrary("halethsw","RDKB");
obj.configureTestCase(ip,port,'TS_ethsw_stub_hal_SetPortCfg_InvalidMode');
