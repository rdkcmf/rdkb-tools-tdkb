...
<xml>
  ...
  <name>TS_TAD_Download_SetNoInterface</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether after setting all result parameters and  download interface as empty,download test is success</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To check whether after setting all result parameters and  download interface as empty,download test is success</test_objective>
...
2. From script invoke TADstub_Set to set all the writable parameters and set interface as empty
3. Check whether the set return a success and the download test is also a success
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_Download_SetNoInterface</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_Download_SetNoInterface');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
	    ...
	    print "[TEST EXECUTION RESULT] : FAILURE";
         ...
         #Set the result status of execution
        tdkTestObj.setResultStatus("FAILURE");
        print "TEST STEP 1:Set the interface of empty ";
        print "EXPECTED RESULT 1: Should set the interface of Download as empty";
        print "ACTUAL RESULT 1: Interface of Download is %s" %details;
        #Get the result of execution
        print "[TEST EXECUTION RESULT] : FAILURE";
