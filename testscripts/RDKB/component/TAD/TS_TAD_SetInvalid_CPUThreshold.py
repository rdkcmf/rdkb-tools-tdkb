...
<xml>
  ...
  <name>TS_TAD_SetInvalid_CPUThreshold</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if setting of an invalid value to Device.SelfHeal.ResourceMonitor.X_RDKCENTRAL-COM_AvgCPUThreshold is failing or not</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_64</test_case_id>
    <test_objective>Check if setting of an invalid value to Device.SelfHeal.ResourceMonitor.X_RDKCENTRAL-COM_AvgCPUThreshold is failing or not</test_objective>
...
3. Set an invalid value as AvgCPUThreshold and check if the set operation failed or not
4. If set operation was success, revert the value of Device.SelfHeal.ResourceMonitor.X_RDKCENTRAL-COM_AvgCPUThreshold
5. Unload the TAD module</automation_approch>
    ...
    <test_script>TS_TAD_SetInvalid_CPUThreshold</test_script>
    <skipped>No</skipped>
