...
<xml>
  ...
  <name>TS_TAD_GetTraceRouteDiagnosticsState</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test case is to get the current TraceRoute diagnostic state and check whether the state retrieved is a valid diagnostics data supported by TR-181</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_04</test_case_id>
    <test_objective>This test case is to get the current TraceRoute diagnostic state and check whether the state retrieved is a valid diagnostics data supported by TR-181</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.IP.Diagnostics.TraceRoute.DiagnosticsState</input_parameters>
    <automation_approch>1. Load TAD modules
2. From script invoke TADstub_Get to get the Trace route Diagnostics state
3. Check whether the trace route Diagnostics state is valid
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_GetTraceRouteDiagnosticsState</test_script>
    <skipped>No</skipped>
