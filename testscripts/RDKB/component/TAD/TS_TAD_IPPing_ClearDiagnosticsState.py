...
<xml>
  ...
  <name>TS_TAD_IPPing_ClearDiagnosticsState</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set all IPPing parameters to do a ping test and check whether IPPing diagnostic state changes to  None after changing any of the writable parameters</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_29</test_case_id>
    <test_objective>To set all IPPing parameters to do a ping test and check whether the IPPing diagnostic state changes to None after changing any of the writable parameters</test_objective>
...
3. Change any of the writable parameters and check whether the DiagnosticsState of IPPing is None.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_IPPing_ClearDiagnosticsState</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_IPPing_ClearDiagnosticsState');
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    ...
                    tdkTestObj = obj.createTestStep('TADstub_Set');
                    tdkTestObj.addParameter("ParamName","Device.IP.Diagnostics.IPPing.Host");
                    tdkTestObj.addParameter("ParamValue","yahoo.com");
                    tdkTestObj.addParameter("Type","string");
                    expectedresult="SUCCESS";
                    tdkTestObj.executeTestCase(expectedresult);
                    actualresult = tdkTestObj.getResult();
                    ...
                    if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult and details=="None":
                            #Set the result status of execution
                            tdkTestObj.setResultStatus("SUCCESS");
                            print "TEST STEP 5:Get DiagnosticsState of IPPing to None";
                            print "EXPECTED RESULT 5 :Should get the DiagnosticsState of IPPing ";
                            print "ACTUAL RESULT 5:The DiagnosticsState of IPPing is , details : %s" %details;
                            #Get the result of execution
                            print "[TEST EXECUTION RESULT] : SUCCESS";
                        else:
                            #Set the result status of execution
                            tdkTestObj.setResultStatus("FAILURE");
                            print "TEST STEP 5 :Get DiagnosticsState of IPPing to None";
                            print "EXPECTED RESULT 5: Should get the DiagnosticsState of IPPing to None";
                            print "ACTUAL RESULT 5:The DiagnosticsState of IPPing is, details : %s" %details;
                            #Get the result of execution
