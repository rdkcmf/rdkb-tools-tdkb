...
<xml>
  ...
  <name>TS_TAD_TraceRoute_ClearResult</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set all parameters and check if the result obtained successfully. Then again set all the parameters and check if the previous result is cleared.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_10</test_case_id>
    <test_objective>Set all parameters and check if the result obtained successfully. Then again set all the parameters and check if the previous result is cleared.</test_objective>
...
3. If set returns success, check if the result obtained successfully
4. Again set all the parameters
5. Check whether the previous result gets cleared
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_TraceRoute_ClearResult</test_script>
    <skipped>No</skipped>
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
        		...
        		if expectedresult in actualresult:
        		    #Set the result status of execution
        		    tdkTestObj.setResultStatus("SUCCESS");
        		    print "TEST STEP 5: Set the interface of TraceRoute";
        		    print "EXPECTED RESULT 5: Should set the interface of TraceRoute";
        		    ...
        		    if expectedresult in actualresult:
        		        #Set the result status of execution
        		        tdkTestObj.setResultStatus("SUCCESS");
        		        print "TEST STEP 6: Set the host of TraceRoute";
        		        print "EXPECTED RESULT 6: Should set the host of TraceRoute";
