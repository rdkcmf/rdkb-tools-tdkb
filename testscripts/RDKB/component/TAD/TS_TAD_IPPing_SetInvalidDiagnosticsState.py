...
<xml>
  ...
  <name>TS_TAD_IPPing_SetInvalidDiagnosticsState</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if Diagnostics state of IPPing can be set with invalid value. Requested and Canceled are the only writable values.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_23</test_case_id>
    <test_objective>To check if Diagnostics state of IPPing can be set with invalid value. Requested and Canceled are the only writable values.</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_IPPing_SetInvalidDiagnosticsState</test_script>
    <skipped>No</skipped>
