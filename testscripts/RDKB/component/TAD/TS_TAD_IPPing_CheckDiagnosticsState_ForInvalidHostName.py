...
<xml>
  ...
  <name>TS_TAD_IPPing_CheckDiagnosticsState_ForInvalidHostName</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set host name of IPPing to invalid and check whether diagnostic state is set to Error value in enumeration list</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_26</test_case_id>
    <test_objective>To set host name of IPPing to invalid  and check whether diagnostic state is set to Error value in enumeration list</test_objective>
...
2. From script invoke TADstub_Set to set the host name as invalid
3. Check if the diagnostic state is set to Error value in enumeration list
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_IPPing_CheckDiagnosticsState_ForInvalidHostName</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_IPPing_CheckDiagnosticsState_ForInvalidHostName');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            print "EXPECTED RESULT 2: Should set the host of IPPing as Invalid";
            ...
            tdkTestObj.addParameter("Type","string");
            expectedresult="SUCCESS";
            DiagnosticsState_list={'Error_CannotResolveHostName','Error_NoRouteToHost','Error_InitConnectionFailed','Error_NoResponse','Error_TransferFailed','Error_PasswordRequestFailed','Error_LoginFailed','Error_NoTransferMode','Error_NoPASV','Error_IncorrectSize','Error_Timeout','Error_Internal','Error_Other'};
            tdkTestObj.executeTestCase(expectedresult);
            actualresult = tdkTestObj.getResult();
            details = tdkTestObj.getResultDetails();
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult and details in DiagnosticsState_list:
                    ...
                    print "EXPECTED RESULT 4: Should get DiagnosticsState of IPPing as Error value in the enumeration list";
                    ...
                    print "TEST STEP 4: Get DiagnosticsState of IPPing";
                    print "EXPECTED RESULT 4: Should get DiagnosticsState of IPPing as Eror value in the enumeration list";
                    print "ACTUAL RESULT 4: %s" %details;
                    #Get the result of execution
