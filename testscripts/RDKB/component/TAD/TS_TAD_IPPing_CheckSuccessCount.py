...
<xml>
  <id/>
  <version>2</version>
  <name>TS_TAD_IPPing_CheckSuccessCount</name>
  <primitive_test_id/>
  <primitive_test_name>TADstub_Get</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if the success count is greater than zero after a successful IPPing test</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TAD_22</test_case_id>
    <test_objective>To check if the success count is greater than zero after a successful IPPing test</test_objective>
...
3. If set returns success, check the success count
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_IPPing_CheckSuccessCount</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    ...
                    if expectedresult in actualresult and int(details)>0:
                        #Set the result status of execution
                        tdkTestObj.setResultStatus("SUCCESS");
                        print "TEST STEP 4: Check if the success count is greater than zero";
                        print "EXPECTED RESULT 4: Should get the success count greater than zero";
