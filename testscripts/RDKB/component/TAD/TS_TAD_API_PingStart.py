...
<xml>
  ...
  <name>TS_TAD_API_PingStart</name>
  ...
  <test_cases>
    <test_case_id>TC_TAD_47</test_case_id>
    <test_objective>To verify the functionality of diag_start() api</test_objective>
...
6.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from TAD stub.</automation_approch>
    ...
    <test_script>TS_TAD_API_PingStart</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_API_PingStart');
