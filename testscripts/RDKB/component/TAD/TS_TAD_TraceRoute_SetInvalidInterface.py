...
<xml>
  <id/>
  <version>2</version>
  <name>TS_TAD_TraceRoute_SetInvalidInterface</name>
  <primitive_test_id/>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_TraceRoute_SetInvalidInterface</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_TraceRoute_SetInvalidInterface');
