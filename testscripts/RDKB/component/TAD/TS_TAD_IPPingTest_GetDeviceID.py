...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.DeviceID and Device.DeviceInfo.SerialNumber  are same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_59</test_case_id>
    <test_objective>To check Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.DeviceID and Device.DeviceInfo.SerialNumber are same</test_objective>
...
6.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from TAD stub.</automation_approch>
    ...
    <test_script>TS_TAD_IPPingTest_GetDeviceID</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","Device.IP.Diagnostics.X_RDKCENTRAL-COM_PingTest.DeviceID");
