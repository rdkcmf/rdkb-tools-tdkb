...
2. Enable TR069 logging and set the log level as DEBUG
	...
	#Set the loglevel of TR69.log to DEBUG level
		...
		tdkTestObj = obj.createTestStep('TADstub_Set');
        	    ...
        	    if expectedresult in actualresult:
        	        #Set the result status of execution
        	        tdkTestObj.setResultStatus("SUCCESS");
        	        print "TEST STEP 4: Set the interface of TraceRoute";
        	        print "EXPECTED RESULT 4: Should set the interface of TraceRoute";
            		...
            		if expectedresult in actualresult:
            		    #Set the result status of execution
            		    tdkTestObj.setResultStatus("SUCCESS");
            		    print "TEST STEP 5: Set the host of TraceRoute";
            		    print "EXPECTED RESULT 5: Should set the host of TraceRoute";
                	    ...
                	    if expectedresult in actualresult:
                	        #Set the result status of execution
                	        tdkTestObj.setResultStatus("SUCCESS");
                	        print "TEST STEP 6: Set DiagnosticsState of TraceRoute as Requested";
                	        print "EXPECTED RESULT 6: Should set DiagnosticsState of TraceRoute as Requested";
				...
				tdkTestObj = sysobj.createTestStep('ExecuteCmd');
                                ...
                                if logstatus:
                                    tdkTestObj.setResultStatus("FAILURE");
                                    print "The logs for traceroute are updated in the TR069 log file"
                                else:
                                    tdkTestObj.setResultStatus("SUCCESS");
                                    print "The logs for traceroute are not updated in the TR069 log file"
                	    else:
                	        #Set the result status of execution
                	        tdkTestObj.setResultStatus("FAILURE");
                	        print "TEST STEP 6: Set DiagnosticsState of TraceRoute as Requested";
