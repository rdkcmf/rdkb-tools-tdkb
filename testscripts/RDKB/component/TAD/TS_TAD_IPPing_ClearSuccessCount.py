...
<xml>
  ...
  <name>TS_TAD_IPPing_ClearSuccessCount</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set all IPPing parameters to do a ping test and check whether the IPPing success count gets cleared after changing any of the writable parameters</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_30</test_case_id>
    <test_objective>To set all IPPing parameters to do a ping test and check whether the IPPing success count gets cleared after changing any of the writable parameters.</test_objective>
...
3. Change any of the writable parameters and check whether the Success Count is cleared.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_IPPing_ClearSuccessCount</test_script>
    <skipped>No</skipped>
