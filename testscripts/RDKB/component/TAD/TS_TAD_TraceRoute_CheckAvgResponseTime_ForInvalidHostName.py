...
<xml>
  ...
  <name>TS_TAD_TraceRoute_CheckAvgResponseTime_ForInvalidHostName</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if the avg response time is equal to zero if a trace route testing is failed.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TAD_08</test_case_id>
    <test_objective>To check if the avg response time is equal to zero if a trace route testing is failed.</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_TAD_TraceRoute_CheckAvgResponseTime_ForInvalidHostName</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_TraceRoute_CheckAvgResponseTime_ForInvalidHostName');
