...
<xml>
  ...
  <name>TS_MTAHAL_GetLineTableGetEntry</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get an entry of the line table at the given index</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_3</test_case_id>
    <test_objective>Get entry of the line table for Line</test_objective>
...
3. Using TS_MTAHAL_GetLineTableGetEntry invoke mta_hal_LineTableGetEntry() to see if the entry of the line table at the given index are getting or not. If available return SUCCESS and exit else return FAILURE and exit.
4. Unload mtahal module</automation_approch>
    <except_output>An entry of the line table for Line 2</except_output>
    <priority>High</priority>
    <test_stub_interface>MTAHAL</test_stub_interface>
    <test_script>TS_MTAHAL_GetLineTableGetEntry</test_script>
    <skipped>No</skipped>
