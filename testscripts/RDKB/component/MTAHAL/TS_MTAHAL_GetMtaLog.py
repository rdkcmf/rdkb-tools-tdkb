...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_19</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MTAHAL_GetMtaLog')
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult and resultDetails != " ":
        ...
        print "TEST STEP 1: Get the MTA Log"
        print "EXPECTED RESULT 1: Should get the MTA Log successfully"
        print "ACTUAL RESULT 1: The MTA Log:"
        print ""
        ...
        print "TEST STEP 1: Get the MTA Log"
        print "EXPECTED RESULT 1: Should get the MTA Log successfully"
        print "ACTUAL RESULT 1: Failed to get the MTA Log:"
