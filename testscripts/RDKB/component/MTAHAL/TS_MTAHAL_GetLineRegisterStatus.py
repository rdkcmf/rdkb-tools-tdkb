...
<xml>
  ...
  <name>TS_MTAHAL_GetLineRegisterStatus</name>
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_37</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MTAHAL_GetLineRegisterStatus')
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult and resultDetails != " ":
        ...
        print "EXPECTED RESULT 1: Should get the Line Register Status successfully"
        print "ACTUAL RESULT 1: The Line Register Status:"
        print ""
        ...
        print "TEST STEP 1: Get the Line Register Status"
        print "EXPECTED RESULT 1: Should get the Line Register Status successfully"
        print "ACTUAL RESULT 1: Failed to get the Line Register Status:"
