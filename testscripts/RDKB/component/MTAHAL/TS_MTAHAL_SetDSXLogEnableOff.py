...
<xml>
  ...
  <name>TS_MTAHAL_SetDSXLogEnableOff</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set value 0 to DSXLogEnable</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_10</test_case_id>
    <test_objective>Set value 0 to DSXLogEnable</test_objective>
...
3. Using TS_MTAHAL_SetDSXLogEnableOff invoke mta_hal_SetDSXLogEnable() to see if the value of DSX enable can be set to 0 or not. If available return SUCCESS and exit else return FAILURE and exit.
...
6. Unload mtahal module</automation_approch>
    ...
    <test_script>TS_MTAHAL_SetDSXLogEnableOff</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MTAHAL_SetDSXLogEnableOff');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            print "ACTUAL RESULT 2: The DSXLogEnable is %s (0)" %resultDetails;
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : SUCCESS";
