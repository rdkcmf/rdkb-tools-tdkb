...
<xml>
  ...
  <name>TS_MTAHAL_SetCallSignallingLogEnableOn</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set value 1 to CallSignallingEnable</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_15</test_case_id>
    <test_objective>Set value of CallSignalling enable to the value</test_objective>
...
3. Using TS_MTAHAL_SetCallSignallingLogEnableOn invoke mta_hal_SetCallSignallingLogEnable() to see if the value of CallSignallingLogEnable can be set to 1 or not. If available return SUCCESS and exit else return FAILURE and exit.
4. If SUCCESS, check if the CallSignallingLogEnable is 1 or not.
5. Restore the value from (3) to CallSignallingLogEnable
6. Unload mtahal module</automation_approch>
    <except_output>Value (1) to set CallSignalling log enable to</except_output>
    <priority>High</priority>
    <test_stub_interface>MTAHAL</test_stub_interface>
    <test_script>TS_MTAHAL_SetCallSignallingLogEnableOn</test_script>
    <skipped>No</skipped>
