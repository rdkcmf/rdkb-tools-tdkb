...
<xml>
  ...
  <name>TS_MTAHAL_GetDhcpStatus</name>
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_36</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MTAHAL_GetDhcpStatus')
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult and resultDetails != " ":
        ...
        print "TEST STEP 1: Get the DHCP Status"
        print "EXPECTED RESULT 1: Should get the DHCP Status successfully"
        print "ACTUAL RESULT 1: The DHCP Status:"
        print ""
        ...
        print "TEST STEP 1: Get the DHCP Status"
        print "EXPECTED RESULT 1: Should get the DHCP Status successfully"
        print "ACTUAL RESULT 1: Failed to get the DHCP Status:"
