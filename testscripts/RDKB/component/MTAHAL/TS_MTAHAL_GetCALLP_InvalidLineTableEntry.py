...
<xml>
  ...
  <name>TS_MTAHAL_GetCALLP_InvalidLineTableEntry</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate mta_hal_GetCALLP() by passing an invalid line table entry number</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_43</test_case_id>
    <test_objective>To validate mta_hal_GetCALLP() by passing an invalid line table entry number</test_objective>
...
3. Using TS_MTAHAL_GetCALLP invoke mta_hal_GetCALLP() with invalid line table entry number
4. Check if mta_hal_GetCALLP() returns failure when invalid line table entry number is passed
5. Unload mtahal module</automation_approch>
    <expected_output>mta_hal_GetCALLP() should return failure when invalid line table entry number is passed</expected_output>
    <priority>High</priority>
    <test_stub_interface>MTAHAL</test_stub_interface>
    <test_script>TS_MTAHAL_GetCALLP_InvalidLineTableEntry</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MTAHAL_GetCALLP_InvalidLineTableEntry')
