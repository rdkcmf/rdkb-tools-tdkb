...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_MTAHAL_getMtaOperationalStatus_NullBuffer</name>
  <primitive_test_id/>
  <primitive_test_name>MTAHAL_getMtaOperationalStatus</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate mta_hal_GetMtaOperationalStatus() by passing a Null Buffer</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_MTAHAL_67</test_case_id>
    <test_objective>To validate mta_hal_GetMtaOperationalStatus() by passing a Null Buffer</test_objective>
...
2. Invoke the HAL api mta_hal_GetMtaOperationalStatus() by passing a null buffer
...
4. UnLoad mtahal module</automation_approch>
    <expected_output>Call to mta_hal_GetMtaOperationalStatus() api should fail</expected_output>
    <priority>High</priority>
    <test_stub_interface>MTAHAL</test_stub_interface>
    <test_script>TS_MTAHAL_getMtaOperationalStatus_NullBuffer</test_script>
    <skipped>No</skipped>
