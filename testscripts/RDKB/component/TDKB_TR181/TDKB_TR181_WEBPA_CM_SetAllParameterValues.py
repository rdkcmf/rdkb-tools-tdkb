...
<xml>
  ...
  <name>TDKB_TR181_WEBPA_CM_SetAllParameterValues</name>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_55</test_case_id>
...
5. Unload modules</automation_approch>
    <expected_output>Set operation on all CM parameters via WEBPA should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_WEBPA_CM_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WEBPA_CM_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WEBPA_CM_SetAllParameterValues');
