...
<xml>
  ...
  <name>TDKB_TR181_WEBPA_PAM_GetAllParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get all tr181 parameters of PAM module using WEBPA</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_07</test_case_id>
    <test_objective>Get all tr181 parameters of PAM module using WEBPA</test_objective>
...
5. Unload modules</automation_approch>
    <expected_output>Get operation on all PAM parameters via WEBPA should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdktr181</test_stub_interface>
    <test_script>TDKB_TR181_WEBPA_PAM_GetAllParameterValues</test_script>
    <skipped>No</skipped>
