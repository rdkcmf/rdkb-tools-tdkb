...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>11</version>
  <name>TDKB_TR181_WEBPA_PAM_SetAllParameterValues</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_04</test_case_id>
...
3. Invoke setAllParams() by passing PAM as module name
4. Display the final status of set and the list of failed parameters, if any
5. Unload modules</automation_approch>
    <expected_output>Set operation on all PAM parameters via SNMP should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_WEBPA_PAM_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WEBPA_PAM_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WEBPA_PAM_SetAllParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        moduleStatus,failedParams= tdkbSetAllParams.setAllParams("PAM", setup_type, obj, obj1);

        print "Status of PAM module is : ",moduleStatus, "\n";
