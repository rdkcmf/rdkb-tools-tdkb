...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TDKB_TR181_LMLITE_GetAllParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get all the tr181 parameters of LMLITE</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_66</test_case_id>
    <test_objective>Get all the tr181 parameters of LMLITE</test_objective>
...
2. Set the validation type as TDK and factoryReset flag as false
...
5. Unload modules</automation_approch>
    <expected_output>Get operation on all LMLITE parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_LMLITE_GetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_LMLITE_GetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_LMLITE_GetAllParameterValues');
