...
<xml>
  ...
  <name>TDKB_TR181_SNMP_PAM_SetAllParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set all tr181 parameters in PAM module via SNMP</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_03</test_case_id>
    <test_objective>To set all tr181 parameters in PAM module via SNMP</test_objective>
...
5. Unload modules</automation_approch>
    ...
    <test_script>TDKB_TR181_SNMP_PAM_SetAllParameterValues</test_script>
    <skipped>No</skipped>
