...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TDKB_TR181_SNMP_LOGAGENT_GetAllDefaultParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check via SNMP, whether all tr181 parameters of LOGAGENT are having the default values after factory reset</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_23</test_case_id>
...
8. Unload modules</automation_approch>
    <expected_output>Get operation for default values on all logagent parameters via SNMP should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdktr181</test_stub_interface>
    <test_script>TDKB_TR181_SNMP_LOGAGENT_GetAllDefaultParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_SNMP_LOGAGENT_GetAllDefaultParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_SNMP_LOGAGENT_GetAllDefaultParameterValues');
