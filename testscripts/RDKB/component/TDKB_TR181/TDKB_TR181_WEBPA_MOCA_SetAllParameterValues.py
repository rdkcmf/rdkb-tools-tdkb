...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TDKB_TR181_WEBPA_MOCA_SetAllParameterValues</name>
  <primitive_test_id/>
...
5. Unload modules</automation_approch>
    <expected_output>Set operation on all MOCA parameters via SNMP should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_WEBPA_MOCA_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WEBPA_MOCA_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WEBPA_MOCA_SetAllParameterValues');
