...
<xml>
  ...
  <name>TDKB_TR181_MOCA_GetAllDefaultParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if all tr181 parameters of MOCA are having the default values after factory reset</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_29</test_case_id>
    <test_objective>Check if all tr181 parameters of MOCA are having the default values after factory reset</test_objective>
...
5. Invoke getAllParams() by passing MOCA as module name
...
8. Unload modules</automation_approch>
    <expected_output>Get operation for default values on all MOCA parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdktr181</test_stub_interface>
    <test_script>TDKB_TR181_MOCA_GetAllDefaultParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_MOCA_GetAllDefaultParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_MOCA_GetAllDefaultParameterValues');
obj2.configureTestCase(ip,port,'TDKB_TR181_MOCA_GetAllDefaultParameterValues');
