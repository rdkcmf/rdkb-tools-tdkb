...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TDKB_TR181_WANMANAGER_GetAllParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get all the tr181 parameters of WAN Manager</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_115</test_case_id>
    <test_objective>Get all the tr181 parameters of WAN Manager</test_objective>
    <test_type>Positive</test_type>
    <test_setup>BroadBand</test_setup>
    <pre_requisite>TDK test agent should be running
WAN module's parameter xml should be available</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>&gt;1. Load tdkbtr181 module and sysutil module
2. Set the validation type as TDK
3. Invoke getAllParams() by passing WAN as module name
4. Display the final status of get and the list of failed parameters, if any
5. Unload modules</automation_approch>
    <expected_output>Get operation on all WAN parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>TDKB TR181</test_stub_interface>
    <test_script>TDKB_TR181_WANMANAGER_GetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WANMANAGER_GetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WANMANAGER_GetAllParameterValues');
