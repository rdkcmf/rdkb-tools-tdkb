...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TDKB_TR181_WEBPA_MTA_SetAllParameterValues</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_64</test_case_id>
    <test_objective>To set all tr181 parameters in MTA module</test_objective>
...
5. Unload modules</automation_approch>
    ...
    <test_script>TDKB_TR181_WEBPA_MTA_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WEBPA_MTA_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WEBPA_MTA_SetAllParameterValues');
