...
<xml>
  ...
  <name>TDKB_TR181_SNMP_CM_SetAllParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set all tr181 parameters in CM module via SNMP</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_52</test_case_id>
    <test_objective>To set all tr181 parameters in CM module via SNMP</test_objective>
...
3. Invoke setAllParams() by passing CM as module name
4. Display the final status of set and the list of failed parameters, if any
5. Unload modules</automation_approch>
    <expected_output>Set operation on all CM parameters via SNMP should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_SNMP_CM_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_CM_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_CM_SetAllParameterValues');
