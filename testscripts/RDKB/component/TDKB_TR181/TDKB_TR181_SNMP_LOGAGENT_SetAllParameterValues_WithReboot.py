...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TDKB_TR181_SNMP_LOGAGENT_SetAllParameterValues_WithReboot</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set all tr181 parameters in LOGAGENT  module using SNMP and check if the values that are set persist after a reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_109</test_case_id>
    <test_objective>To set all tr181 parameters in LOGAGENT  module using SNMP and check if the values that are set persist after a reboot</test_objective>
...
7. Unload modules</automation_approch>
    ...
    <test_script>TDKB_TR181_SNMP_LOGAGENT_SetAllParameterValues_WithReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_SNMP_LOGAGENT_SetAllParameterValues_WithReboot');
obj1.configureTestCase(ip,port,'TDKB_TR181_SNMP_LOGAGENT_SetAllParameterValues_WithReboot');
