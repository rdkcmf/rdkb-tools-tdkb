...
<xml>
  ...
  <name>TDKB_TR181_SNMP_DSLite_GetAllParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get all tr181 parameters of DSLite module using SNMP</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
5. Unload modules</automation_approch>
    ...
    <test_script>TDKB_TR181_SNMP_DSLite_GetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_SNMP_DSLite_GetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_SNMP_DSLite_GetAllParameterValues');
