...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TDKB_TR181_WEBPA_DSLite_SetAllParameterValues</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_112</test_case_id>
    <test_objective>To set all tr181 parameters in WEBPA module</test_objective>
...
3. Invoke setAllParams() by passing DSLite as module name
4. Display the final status of set and the list of failed parameters, if any
5. Unload modules</automation_approch>
    <expected_output>Set operation on all DSLite parameters via WEBPA should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_WEBPA_DSLite_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WEBPA_DSLite_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WEBPA_DSLite_SetAllParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        moduleStatus,failedParams= tdkbSetAllParams.setAllParams("DSLite", setup_type, obj, obj1);
