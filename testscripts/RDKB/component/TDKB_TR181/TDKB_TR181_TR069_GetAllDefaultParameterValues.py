...
<xml>
  ...
  <name>TDKB_TR181_TR069_GetAllDefaultParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if all tr181 parameters of TR069 are having the default values after factory reset</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_74</test_case_id>
    <test_objective>Check if all tr181 parameters of TR069 are having the default values after factory reset</test_objective>
...
TR069 module's parameter xml should be available</pre_requisite>
    ...
    <automation_approch>1. Load tdkbtr181 module, wifiagent module and sysutil module
2. Set the validation type as TDK
3. Set the factoryReset flag as true
4. do the factory reset of device
5. Invoke getAllParams() by passing TR069 as module name
...
8. Unload modules</automation_approch>
    <expected_output>Get operation for default values on all TR069 parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_TR069_GetAllDefaultParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_TR069_GetAllDefaultParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_TR069_GetAllDefaultParameterValues');
obj2.configureTestCase(ip,port,'TDKB_TR181_TR069_GetAllDefaultParameterValues');
