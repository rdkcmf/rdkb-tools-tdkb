...
<xml>
  ...
  <name>TDKB_TR181_TDM_GetAllDefaultParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if all tr181 parameters of TDM are having the default values after factory reset</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_38</test_case_id>
    <test_objective>Check if all tr181 parameters of TDM are having the default values after factory reset</test_objective>
...
5. Invoke getAllParams() by passing TDM as module name
...
8. Unload modules</automation_approch>
    <expected_output>Get operation for default values on all TDM parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdktr181</test_stub_interface>
    <test_script>TDKB_TR181_TDM_GetAllDefaultParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_TDM_GetAllDefaultParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_TDM_GetAllDefaultParameterValues');
obj2.configureTestCase(ip,port,'TDKB_TR181_TDM_GetAllDefaultParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper():
    ...
    if expectedresult in actualresult:
        ...
        moduleStatus,failedParams = tdkbSetAllParams.getAllParams("TDM", setup_type, factoryReset, obj, obj1);
