...
<xml>
  ...
  <name>TDKB_TR181_SNMP_CM_GetAllParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get all tr181 parameters of CM module using SNMP</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_51</test_case_id>
...
5. Unload modules</automation_approch>
    ...
    <test_script>TDKB_TR181_SNMP_CM_GetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_SNMP_CM_GetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_SNMP_CM_GetAllParameterValues');
