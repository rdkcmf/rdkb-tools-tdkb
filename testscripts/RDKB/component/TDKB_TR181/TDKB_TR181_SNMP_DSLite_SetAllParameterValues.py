...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TDKB_TR181_SNMP_DSLite_SetAllParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set all tr181 parameters in DSLite  module via SNMP</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To set all tr181 parameters in DSLite module via SNMP</test_objective>
...
5. Unload modules</automation_approch>
    <expected_output>Set operation on all DSLite parameters via SNMP should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_SNMP_DSLite_SetAllParameterValues</test_script>
    <skipped>No</skipped>
