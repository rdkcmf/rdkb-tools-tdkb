...
<xml>
  ...
  <name>TDKB_TR181_WEBPA_DSLite_SetAllParameterValues_WithReboot</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set all tr181 parameters in DSLite module using WEBPA and check if the values that are set persist after a reboot.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_113</test_case_id>
    <test_objective>To set all tr181 parameters in DSLite  module using WEBPA and check if the values that are set persist after a reboot.</test_objective>
...
7. Unload modules</automation_approch>
    ...
    <test_script>TDKB_TR181_WEBPA_DSLite_SetAllParameterValues_WithReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WEBPA_DSLite_SetAllParameterValues_WithReboot');
obj1.configureTestCase(ip,port,'TDKB_TR181_WEBPA_DSLite_SetAllParameterValues_WithReboot');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if "SUCCESS" in preRequisiteStatus:
        ...
        print "Status of DSLite module is : ",moduleStatus, "\n";
