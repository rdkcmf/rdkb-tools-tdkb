...
<xml>
  ...
  <name>TDKB_TR181_PAM_SetAllParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set all tr181 parameters in PAM module</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_02</test_case_id>
    <test_objective>To set all tr181 parameters in PAM module</test_objective>
...
5. Unload modules</automation_approch>
    <expected_output>Set operation on all PAM parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_PAM_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_PAM_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_PAM_SetAllParameterValues');
