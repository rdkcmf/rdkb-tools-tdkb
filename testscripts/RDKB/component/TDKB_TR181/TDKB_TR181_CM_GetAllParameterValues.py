...
<xml>
  ...
  <name>TDKB_TR181_CM_GetAllParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get all the tr181 parameters of CM</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_48</test_case_id>
    <test_objective>Get all the tr181 parameters of CM</test_objective>
...
5. Unload modules</automation_approch>
    <expected_output>Get operation on all CM parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_CM_GetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_CM_GetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_CM_GetAllParameterValues');
