...
<xml>
  ...
  <name>TDKB_TR181_WEBPA_LMLITE_GetAllDefaultParameterValues</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check via WEBPA, whether all tr181 parameters of LMLITE are having the default values after factory reset</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_71</test_case_id>
    <test_objective>Check via WEBPA, whether all tr181 parameters of LMLITE are having the default values after factory reset</test_objective>
...
8. Unload modules</automation_approch>
    <expected_output>Get operation for default values on all LMLITE parameters via WEBPA should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_WEBPA_LMLITE_GetAllDefaultParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WEBPA_LMLITE_GetAllDefaultParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WEBPA_LMLITE_GetAllDefaultParameterValues');
