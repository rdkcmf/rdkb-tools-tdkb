...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TDKB_TR181_LMLITE_GetAllDefaultParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check if all tr181 parameters of LMLITE are having the default values after factory reset</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_65</test_case_id>
    <test_objective>Check if all tr181 parameters of LMLITE are having the default values after factory reset</test_objective>
...
8. Unload modules</automation_approch>
    <expected_output>Get operation for default values on all LMLITE parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_LMLITE_GetAllDefaultParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_LMLITE_GetAllDefaultParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_LMLITE_GetAllDefaultParameterValues');
obj2.configureTestCase(ip,port,'TDKB_TR181_LMLITE_GetAllDefaultParameterValues');
