...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TDKB_TR181_SNMP_TR069_SetAllParameterValues_WithReboot</name>
  <primitive_test_id/>
  ...
  <test_cases>
    ...
    <test_objective>To set all tr181 parameters in TR069  module using SNMP and check if the values that are set persist after a reboot</test_objective>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_SNMP_TR069_SetAllParameterValues_WithReboot');
obj1.configureTestCase(ip,port,'TDKB_TR181_SNMP_TR069_SetAllParameterValues_WithReboot');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    print "Status of TR069 module test is : ",moduleStatus, "\n";
