...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TDKB_TR181_WIFI_GetAllParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get all the tr181 parameters of WiFi</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_11</test_case_id>
    <test_objective>Get all the tr181 parameters of WiFi</test_objective>
...
5. Unload modules</automation_approch>
    <expected_output>Get operation on all WIFI parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_WIFI_GetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WIFI_GetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WIFI_GetAllParameterValues');
