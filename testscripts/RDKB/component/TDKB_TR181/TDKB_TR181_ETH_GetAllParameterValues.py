...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TDKB_TR181_ETH_GetAllParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get all the tr181 parameters of ETH</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_123</test_case_id>
    <test_objective>Get all the tr181 parameters of  ETH</test_objective>
...
3. Invoke getAllParams() by passing ETH as module name
4. Display the final status of get and the list of failed parameters, if any
5. Unload modules</automation_approch>
    <expected_output>Get operation on all ETH parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_ETH_GetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_ETH_GetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_ETH_GetAllParameterValues');
