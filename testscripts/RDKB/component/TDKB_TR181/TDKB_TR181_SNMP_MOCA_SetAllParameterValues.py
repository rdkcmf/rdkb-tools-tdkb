...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TDKB_TR181_SNMP_MOCA_SetAllParameterValues</name>
  <primitive_test_id/>
  <primitive_test_name>TDKB_TR181Stub_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set all tr181 parameters in MOCA module via SNMP</synopsis>
  <groups_id/>
...
5. Unload modules</automation_approch>
    ...
    <test_script>TDKB_TR181_SNMP_MOCA_SetAllParameterValues</test_script>
    <skipped>No</skipped>
