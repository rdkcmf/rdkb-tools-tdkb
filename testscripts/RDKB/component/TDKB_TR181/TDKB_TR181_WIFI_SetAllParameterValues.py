...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TDKB_TR181_WIFI_SetAllParameterValues</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_12</test_case_id>
    <test_objective>To do set operation on all WiFi tr181 parameters</test_objective>
...
5. Unload modules</automation_approch>
    <expected_output>Set operation on all WIFI parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_WIFI_SetAllParameterValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_TR181_WIFI_SetAllParameterValues');
obj1.configureTestCase(ip,port,'TDKB_TR181_WIFI_SetAllParameterValues');
