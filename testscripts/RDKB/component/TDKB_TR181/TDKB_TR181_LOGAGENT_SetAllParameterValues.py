...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TDKB_TR181_LOGAGENT_SetAllParameterValues</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TDKB_TR181_22</test_case_id>
...
5. Unload modules</automation_approch>
    <expected_output>Set operation on all LOGAGENT parameters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TDKB_TR181_LOGAGENT_SetAllParameterValues</test_script>
    <skipped>No</skipped>
