...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_XCONF_Calculate_Time_For_FW_Upgrade</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_XCONF_12</test_case_id>
    <test_objective>Calculate the total time taken for  firmware up gradation and ensure it is less than 10 minutes</test_objective>
...
8.Reboot The DUT
9.Take final Time 
10.Ensure DUThas the diffrent  firmware  by comparing the new firmwareVersion and new firmwareName  with the old ones.The total time for the firmware up-gradation should be less than 10 minutes
11. Unload sysutil module</automation_approch>
    <except_output>DUT should has new  firmware and the total time taken for the firmware up gradation should be less than 10 minutes</except_output>
    <priority>High</priority>
    <test_stub_interface>sysutil</test_stub_interface>
    <test_script>TS_XCONF_Calculate_Time_For_FW_Upgrade</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_XCONF_Calculate_Time_For_FW_Upgrade');
    		...
    		#Execute cdnFile
    			...
    			print "Total time taken for FW updation is :",Grand_Total_Time
    		        ...
    		        New_FirmwareVersion, New_FirmwareFilename = xconfUtilityLib.getCurrentFirmware(obj);
    	                if (New_FirmwareFilename != oldFw[i+1] and Grand_Total_Time <= 10):
    	        	        tdkTestObj.setResultStatus("SUCCESS");
