...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_XCONF_CheckJsonInResponseFile</name>
  <primitive_test_id/>
  <primitive_test_name>XCONF_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check if the response from xconf server is getting stored in the response file</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_XCONF_17</test_case_id>
    <test_objective>Check if the response from xconf server is getting stored in the response file</test_objective>
...
6. Execute CDN_FILE
7. check if the json response inside the response file, is not empty
8. Unload sysutil module</automation_approch>
    <except_output>Response file should not be empty</except_output>
    <priority>High</priority>
    <test_stub_interface>sysutil</test_stub_interface>
    <test_script>TS_XCONF_CheckJsonInResponseFile</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
