...
<xml>
  ...
  <status>FREE</status>
  <synopsis>To check whether hash_password_3 from syscfg.db in /tmp and Device.Users.User.3.X_CISCO_COM_Password returns same value if the default admin password  is changed</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check whether hash_password_3 from syscfg.db in /tmp and Device.Users.User.3.X_CISCO_COM_Password returns same value if the default admin password  is changed</test_objective>
...
3.Check if Device.Users.User.3.X_CISCO_COM_Password and hash_password_3 from syscfg.db in /tmp returns same value
4.If user_password_3 entry is present in syscfg.db in /tmp,change the password
5.After changing the password,check if syscfg get hash_password_3 from syscfg.db in /tmp
6.Check if Device.Users.User.3.X_CISCO_COM_Password and hash_password_3 from syscfg.db in /tmp returns same value
