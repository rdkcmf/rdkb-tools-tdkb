...
<xml>
  ...
  <name>TS_SANITY_Is_brlan0_Up</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if brlan0 interface is up and verifies whether its ip retrieved from ifconfig is same as the ip from tr181 param</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Tests if brlan0 interface is up and verifies whether its ip retrieved from ifconfig is same as the ip from tr181 param</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_SANITY_Is_brlan0_Up</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'TS_SANITY_Is_brlan0_Up');
pamObj.configureTestCase(ip,port,'TS_SANITY_Is_brlan0_Up');
...
if "SUCCESS" in loadmodulestatus1.upper() and loadmodulestatus2.upper:
    ...
    if expectedresult in actualresult and details:
        ...
        print "TEST STEP 1: Check if brlan0 is up"
        print "EXPECTED RESULT 1: brlan0 should be up";
        print "ACTUAL RESULT 1: brlan0 is up with ip %s" %ip;
        ...
        print "TEST STEP 1: Check if brlan0 is up"
        print "EXPECTED RESULT 1: brlan0 should be up";
        print "ACTUAL RESULT 1: brlan0 is not up ";
        print "[TEST EXECUTION RESULT] : FAILURE";
