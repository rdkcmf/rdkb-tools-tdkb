...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>Check if the moca status is retained in bridge mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Check if the moca status is retained in bridge mode</test_objective>
...
5.Toggle the lanmode between router and bridge mode
6. Check if moca status is changed when lan mode is changed
...
8.Test Manager will publish the result in GUI as PASS/FAILURE</automation_approch>
    <except_output>The moca status should not change when the lan mode changes</except_output>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    mocaStatus = tdkTestObj.getResultDetails();
	...
	tdkTestObj.addParameter("ParamName","Device.X_CISCO_COM_DeviceControl.LanManagementEntry.1.LanMode");
        ...
        tdkTestObj.executeTestCase(expectedresult);
        actualresult = tdkTestObj.getResult();
        lanmode = tdkTestObj.getResultDetails();
	    ...
	    if lanmode == "router":
		newlanmode = "bridge-static";
	    else:
		newlanmode = "router";
	    #Toggle the lanmode
	    tdkTestObj = obj.createTestStep('TDKB_TR181Stub_Set');
            tdkTestObj.addParameter("ParamName","Device.X_CISCO_COM_DeviceControl.LanManagementEntry.1.LanMode");
            tdkTestObj.addParameter("ParamValue",newlanmode);
            ...
            if expectedresult in actualresult:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 3: Toggle the lanmode";
		...
		tdkTestObj = obj.createTestStep('TDKB_TR181Stub_Get');
    		...
    		if expectedresult in actualresult and mocaStatus_new == mocaStatus:
    		    #Set the result status of execution
    		    tdkTestObj.setResultStatus("SUCCESS");
    		    print "TEST STEP 4: Get the enable status of Moca";
    		    print "EXPECTED RESULT 4: Should get the enable status of Moca same as in router mode";
		    ...
		    #Set the result status of execution
                    ...
                    print "TEST STEP 4: Get the enable status of Moca";
                    print "EXPECTED RESULT 4: Should get the enable status of Moca same as in previous mode";
                    print "ACTUAL RESULT 4: Moca Enable status is %s" %mocaStatus_new;
                    #Get the result of execution
