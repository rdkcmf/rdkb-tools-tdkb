...
<xml>
  ...
  <name>TS_COSAMTA_GetBatteryRemainingCharge</name>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>CosaDmlMtaBatteryGetRemainingCharge</api_or_interface_used>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_COSAMTA_GetBatteryRemainingCharge');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult and (install == '0' or install == '1'):
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 2: Get the BatteryRemainingCharge";
            print "EXPECTED RESULT 2: Should get the BatteryRemainingCharge successfully";
            print "ACTUAL RESULT 2: Failed to get the BatteryRemainingCharge, Details : %s" %resultDetails;
            print "[TEST EXECUTION RESULT] : FAILURE";
    else:
        tdkTestObj.setResultStatus("FAILURE");
        print "TEST STEP 1: Get the BatteryInstalled";
