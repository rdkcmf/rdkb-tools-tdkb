...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if the actual capacity of the battery is greater than or equal to zero</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Check if the actual capacity of the battery is greater than or equal to zero</test_objective>
...
4. Check if actual capacity of the battery is greater than or equal to zero
5. Unload Cosamta module</automation_approch>
    <except_output>Actual capacity of the battery is greater than or equal to 0 </except_output>
