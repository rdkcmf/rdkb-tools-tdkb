...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_platform_stub_hal_GetSoftwareVersion_NullBuffer</name>
  <primitive_test_id/>
  <primitive_test_name>platform_stub_hal_GetSoftwareVersion</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate Platform HAL API platform_hal_GetSoftwareVersion() by passing a Null Buffer</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Platform_55</test_case_id>
    <test_objective>To validate Platform HAL API platform_hal_GetSoftwareVersion() by passing a Null Buffer</test_objective>
...
2. Invoke the HAL api platform_hal_GetSoftwareVersion() by passing a null buffer
...
4. UnLoad halplatform module</automation_approch>
    <expected_output>Call to platform_hal_GetSoftwareVersion should fail</expected_output>
    <priority>High</priority>
    <test_stub_interface>halplatform</test_stub_interface>
    <test_script>TS_platform_stub_hal_GetSoftwareVersion_NullBuffer</test_script>
    <skipped>No</skipped>
