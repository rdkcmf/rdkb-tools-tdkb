...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_platform_stub_hal_StopMACsec</name>
  <primitive_test_id/>
  <primitive_test_name>platform_stub_hal_StopMACsec</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To invoke platform_hal_StopMACsec() HAL API successfully</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Platform_85</test_case_id>
    <test_objective>To invoke platform_hal_StopMACsec() HAL API successfully</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state of DUT
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>platform_hal_StopMACsec()</api_or_interface_used>
    <input_parameters>method : platform_stub_hal_StopMACsec
ethPort : Give the ethPort Number</input_parameters>
    <automation_approch>1. Load  platform module.
2. From script invoke platform_hal_StopMACsec() by passing the ethPort value from platform properties file
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_Platform stub.</automation_approch>
    <expected_output>platform_hal_StopMACsec() HAL API invoked successfully</expected_output>
    <priority>High</priority>
    <test_stub_interface>HAL_Platform</test_stub_interface>
    <test_script>TS_platform_stub_hal_StopMACsec</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_platform_stub_hal_StopMACsec');
obj1.configureTestCase(ip,port,'TS_platform_stub_hal_StopMACsec');
