...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>TS_platform_stub_hal_GetBootLoaderVersion</name>
  <primitive_test_id/>
  <primitive_test_name>platform_stub_hal_GetBootLoaderVersion</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate HAL API platform_hal_GetBootloaderVersion()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Platform_1</test_case_id>
    <test_objective>To validate Platform HAL API platform_hal_GetBootloaderVersion()</test_objective>
...
obj.configureTestCase(ip,port,'TS_platform_stub_hal_GetBootLoaderVersion');
