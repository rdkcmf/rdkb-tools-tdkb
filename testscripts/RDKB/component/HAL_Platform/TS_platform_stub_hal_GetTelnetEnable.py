...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>11</version>
  <name>TS_platform_stub_hal_GetTelnetEnable</name>
  <primitive_test_id/>
  <primitive_test_name>platform_stub_hal_GetTelnetEnable</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Validate HAL API platform_hal_GetTelnetEnable()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Platform_19</test_case_id>
    <test_objective>To validate Platform HAL API platform_hal_GetTelnetEnable()</test_objective>
...
2. From script invoke platform_stub_hal_GetTelnetEnable().
3. Get the value 
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_Platform stub.</automation_approch>
    ...
    <test_script>TS_platform_stub_hal_GetTelnetEnable</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_platform_stub_hal_GetTelnetEnable');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        if expectedresult in actualresult and details:
            ...
            if details == "1":
                ...
                print "Telnet is set to  : %s" %details;
            else:
                print "ACTUAL RESULT 1: %s" %details;
                print "Telnet is set to : %s" %details;
