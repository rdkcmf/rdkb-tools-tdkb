...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>TS_platform_stub_hal_GetBaseMacAddress</name>
  <primitive_test_id/>
  <primitive_test_name>platform_stub_hal_GetBaseMacAddress</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Validate HAL API platform_hal_GetBaseMacAddress()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Platform_13</test_case_id>
    <test_objective>To validate Platform HAL API platform_hal_GetBaseMacAddress()</test_objective>
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_Platform stub.</automation_approch>
    ...
    <test_script>TS_platform_stub_hal_GetBaseMacAddress</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_platform_stub_hal_GetBaseMacAddress');
sysObj.configureTestCase(ip,port, 'TS_platform_stub_hal_GetBaseMacAddress');
