...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>TS_platform_stub_hal_DocsisParamsDBInit</name>
  <primitive_test_id/>
  <primitive_test_name>platform_stub_hal_DocsisParamsDBInit</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Validate HAL API platform_hal_DocsisParamsDBInit()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_Platform_14</test_case_id>
    <test_objective>To validate Platform HAL API platform_hal_DocsisParamsDBInit()</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state of DUT
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>platform_hal_DocsisParamsDBInit()</api_or_interface_used>
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_Platform stub.</automation_approch>
    ...
    <test_script>TS_platform_stub_hal_DocsisParamsDBInit</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_platform_stub_hal_DocsisParamsDBInit');
