...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_CMAGENT_DelObject.py)
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_CMAGENT_DelObject</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
