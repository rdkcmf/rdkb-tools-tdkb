...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>TS_CMAGENT_ToDStatus</name>
  <primitive_test_id/>
  <primitive_test_name>CMAgent_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_CMAGENT_20 - To Validate "ToDStatus" Function Parameter and check if ToDStatus is complete for CMStatus in enumeration list</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_CMAGENT_16</test_case_id>
    <test_objective>To Validate "ToDStatus" Function Parameters and check if ToDStatus is complete for CMStatus in enumeration list</test_objective>
...
( eg: "Device.X_CISCO_COM_CableModem.ToDStatus","Device.X_CISCO_COM_CableModem.CMStatus )</input_parameters>
...
3.If it returns true, get the value of ToDStatus
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_CMAGENT_ToDStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMAGENT_ToDStatus');
...
if expectedresult in actualresult and "OPERATIONAL" in Details_cmstatus:
    ...
    #Input Parameters
    tdkTestObj.addParameter("paramName","Device.X_CISCO_COM_CableModem.ToDStatus");
