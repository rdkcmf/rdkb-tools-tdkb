...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>TS_CMAGENT_MDDIPOverride</name>
  <primitive_test_id/>
  <primitive_test_name>CMAgent_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_CMAGENT_19 - To Validate "MDDIPOverride" Function Parameter</synopsis>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_CMAGENT_MDDIPOverride.py)
3.Execute the generated Script(TS_CMAGENT_MDDIPOverride.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_CMAGENT_MDDIPOverride</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMAGENT_MDDIPOverride');
...
#Input Parameters
tdkTestObj.addParameter("paramName","Device.X_CISCO_COM_CableModem.MDDIPOverride");
