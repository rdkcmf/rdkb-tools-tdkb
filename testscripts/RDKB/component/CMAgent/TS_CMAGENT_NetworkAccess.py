...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>9</version>
  <name>TS_CMAGENT_NetworkAccess</name>
  <primitive_test_id/>
  <primitive_test_name>CMAgent_Set_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_CMAGENT_18 - To Validate Read Only "NetworkAccess" Function Parameter</synopsis>
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_CMAGENT_NetworkAccess</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMAGENT_NetworkAccess');
...
#Input Parameters
tdkTestObj.addParameter("paramName","Device.X_CISCO_COM_CableModem.NetworkAccess");
