...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_CMAgent_GetHealth</name>
  <primitive_test_id/>
  <primitive_test_name>CMAgent_GetHealth</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_CMAGENT_10 :: Get Health API Validation for CM Agent</synopsis>
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_CMAgent_GetHealth</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMAGENT_GetHealth');
