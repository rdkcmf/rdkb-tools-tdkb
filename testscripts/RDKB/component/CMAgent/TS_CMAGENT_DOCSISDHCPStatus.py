...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>11</version>
  <name>TS_CMAGENT_DOCSISDHCPStatus</name>
  <primitive_test_id/>
  <primitive_test_name>CMAgent_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_CMAGENT_12 - Functional Validation :: Get DOCSIS DHCP Status</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_CMAGENT_9</test_case_id>
...
( eg: "Device.X_CISCO_COM_CableModem.DOCSISDHCPStatus" )</input_parameters>
    <automation_approch>1.Configure the Function info in Test Manager GUI  which needs to be tested  
(CMAgent_Get  - func name - "If not exists already"
 cmagent - module name
 Necessary I/P args as Mentioned in Input)
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_CMAGENT_DOCSISDHCPStatus.py)
3.Execute the generated Script(TS_CMAGENT_DOCSISDHCPStatus.py) using excution page of  Test Manager GUI
...
Testmanager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_CMAGENT_DOCSISDHCPStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMAGENT_DOCSISDHCPStatus');
...
#Input Parameters
tdkTestObj.addParameter("paramName","Device.X_CISCO_COM_CableModem.DOCSISDHCPStatus");
...
if expectedresult in actualresult:
	...
	tdkTestObj.setResultStatus("SUCCESS");
 	print "TEST STEP 1: Get the DOCSISDHCPStatus";
    	print "EXPECTED RESULT 1: Should get the DOCSISDHCPStatus";
