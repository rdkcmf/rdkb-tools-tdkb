...
<xml>
  ...
  <name>TS_RBUS_AddandRemoveElement</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the RBUS APIs rbus_addElement and rbus_removeElement</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_43</test_case_id>
    <test_objective>To validate the RBUS APIs rbus_addElement and rbus_removeElement</test_objective>
...
5. Add the Element in the Registered object using rbus_addElement method and return status should be success
6. Remove the added Element in the object using rbus_removeElement method and return status should be success
...
10. Unload the rbus module</automation_approch>
    <expected_output>Should be able to add the Element in the object using rbus_addElement and removing using rbus_removeElement</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_AddandRemoveElement</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_RBUS_AddandRemoveElement');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            print "\n*************Start of Adding Element*****************************"
            tdkTestObj = obj.createTestStep('RBUS_RegisterOperation');
            tdkTestObj.addParameter("operation","addElement");
            tdkTestObj.addParameter("objectName","tdkb_server1.obj1");
            tdkTestObj.addParameter("methodName","Element1"); # methodName will be converted as Element name in stub
            ...
            if expectedresult in actualresult:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 3: Adding the element with object ";
                ...
                if expectedresult in actualresult:
                    #Set the result status of execution
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 4: Remove the element with object ";
