...
<xml>
  ...
  <name>TS_RBUS_Validate_SingleDataType_RoundOff</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get the value of single data using Device.SampleProvider.AllTypes.SingleData and set a new value of double data type and check if the value is getting round-off to single data type properly while the rbusSampleProvider App is running.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_84</test_case_id>
    <test_objective>Get the value of single data using Device.SampleProvider.AllTypes.SingleData and set a new value of double data type and check if the value is getting round-off to single data type properly while the rbusSampleProvider App is running.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1. Ccsp Components  should be in a running state of DUT
2. TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>None</api_or_interface_used>
    <input_parameters>set_value : 11.14159567890123</input_parameters>
...
5. Set the set_value of double type and check if the set operation is success.
6. Fetch the value of Device.SampleProvider.AllTypes.SingleData and confirm whether the get value is matching with the round-off value.
...
8. Revert to the initial RBUS enable state if revert flag is set.</automation_approch>
    <expected_output>Setting a value of double data type to single data should be success and the corresponding get value should be the round-off value to single data type while the rbusSampleProvider App is running.</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_Validate_SingleDataType_RoundOff</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RBUS_Validate_SingleDataType_RoundOff');
tr181obj.configureTestCase(ip,port,'TS_RBUS_Validate_SingleDataType_RoundOff');
