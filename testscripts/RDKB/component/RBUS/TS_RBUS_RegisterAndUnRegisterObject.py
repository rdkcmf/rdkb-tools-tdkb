...
<xml>
  ...
  <name>TS_RBUS_RegisterAndUnRegisterObject</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the RBUS APIs rbus_registerObj and rbus_unregisterObj</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_33</test_case_id>
    <test_objective>To validate the RBUS APIs rbus_registerObj and rbus_unregisterObj</test_objective>
...
5. UnRegister the above object using rbus_unregisterObj API and the return status should be success
...
8. Unload the rbus module</automation_approch>
    <expected_output>Should be able to Register the object using rbus_registerObj and unregister the object using rbus_unregisterObj</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_RegisterAndUnRegisterObject</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_RBUS_RegisterAndUnRegisterObject');
