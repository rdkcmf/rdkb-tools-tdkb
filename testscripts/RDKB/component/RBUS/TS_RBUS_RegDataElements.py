...
<xml>
  ...
  <name>TS_RBUS_RegDataElements</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Validate the RBUS2.0 API rbus_regDataElements with sample data elements</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_21</test_case_id>
    <test_objective>To Validate the RBUS2.0 API rbus_regDataElements with sample data elements</test_objective>
...
5. Unload the module</automation_approch>
    <expected_output>RBUS2.0 API rbus_regDataElements  return status should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_RegDataElements</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_RBUS_RegDataElements');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult and details != "":
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Validate rbus_regDataElements API";
            print "EXPECTED RESULT 2: rbus_regDataElements API call should be success";
            print "ACTUAL RESULT 2: rbus_regDataElements API was success";
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
        else:
            #Set the result status of execution
            ...
            print "TEST STEP 2: Validate rbus_regDataElements API";
            print "EXPECTED RESULT 2: rbus_regDataElements API call should be success";
            print "ACTUAL RESULT 2: rbus_regDataElements API was Failed";
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
