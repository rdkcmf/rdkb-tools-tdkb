...
<xml>
  ...
  <name>TS_RBUS_TestApp_ValueChangeObjectFailCount</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the RBUS functionalities against ValueChange object using Test app execution</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_14</test_case_id>
    <test_objective>To check the RBUS functionalities against ValueChange object using Test app execution
</test_objective>
...
6. Grep through the consumer log file (/tmp/rbusTestConsumer1.log) to get the PASS and FAIL count on ValueChange object
...
9. Unload the modules</automation_approch>
    <expected_output>The Fail count value of ValueChange object from consumer app result should be zero
</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_TestApp_ValueChangeObjectFailCount</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RBUS_SampleApp_ValueChangeObjectFailCount');
tr181obj.configureTestCase(ip,port,'TS_RBUS_SampleApp_ValueChangeObjectFailCount');
    ...
    if rbus_set == 1:
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                cmd = "grep -w \"# ValueChange\" /tmp/rbusTestConsumer1.log";
                ...
                print "Test Name : ValueChange Fail count Result is:",details

                if expectedresult in actualresult and details != "":
                    print "TEST STEP 4: Get the ValueChange Test Result from consumer log file (/tmp/rbusTestConsumer1.log)"
                    print "EXPECTED RESULT 4: Should get ValueChange Test Result value from consumer log file (/tmp/rbusTestConsumer1.log)"
                    print "ACTUAL RESULT 4: Successfully got ValueChange Test Result value from consumer file (/tmp/rbusTestConsumer1.log)"
                    print "[TEST EXECUTION RESULT] 4: SUCCESS";
                    tdkTestObj_Tr181_Get.setResultStatus("SUCCESS");

                    testname = details.split("|")[0]
                    passcount = details.split("|")[1]
                    failcount1 = details.split("|")[2].split("#")[0]
                    ...
                    if int(failcount) == 0:
                        print "TEST STEP 5: Get the Fail count value for Test name ValueChange"
                        print "EXPECTED RESULT 5: Fail count value for Test name ValueChange should be zero"
                        print "[ACTUAL RESULT 5: Failcount value for Test name ValueChange is Zero"
                    ...
                    print "TEST STEP 4: Get the ValueChange Test Result from consumer log (/tmp/rbusTestConsumer1.log)"
                    print "EXPECTED RESULT 4: Should get ValueChange Test Result value from consumer log file (/tmp/rbusTestConsumer1.log)"
                    print "ACTUAL RESULT 4: Failed to get ValueChange Test Result value from consumer file (/tmp/rbusTestConsumer1.log)"
