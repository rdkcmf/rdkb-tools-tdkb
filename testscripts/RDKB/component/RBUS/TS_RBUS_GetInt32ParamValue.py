...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_RBUS_GetInt32ParamValue</name>
  <primitive_test_id/>
  <primitive_test_name>RBUS_GetValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the value of the DML parameter (integer) using rbus_get and rbusValue_GetInt32 RBUS APIs</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_RBUS_25</test_case_id>
    <test_objective>To Get the value of the DML parameter (integer) using rbus_get and rbusValue_GetInt32 RBUS APIs</test_objective>
...
rbusValue_GetInt32</api_or_interface_used>
    <input_parameters>Device.WiFi.AccessPoint.1.X_CISCO_COM_BssMaxNumSta</input_parameters>
    <automation_approch>1. Load the rbus module
2. Open the rbus connection using rbus_open RBUS API
3. Invoke the RBUS API rbusValue_GetInt32 with the Integer parameter name and the return status should be success
...
6. Unload the module</automation_approch>
    <expected_output>Should  get the value of the interger parameter</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_GetInt32ParamValue</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_RBUS_GetInt32ParamValue');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    parameterNameList = ["Device.WiFi.AccessPoint.1.X_CISCO_COM_BssMaxNumSta"]
