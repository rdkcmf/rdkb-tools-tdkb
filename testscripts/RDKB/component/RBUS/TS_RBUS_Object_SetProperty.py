...
<xml>
  ...
  <name>TS_RBUS_Object_SetProperty</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate the RBUS 2.0 API rbusObject_SetProperty</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_68</test_case_id>
    <test_objective>To Validate the RBUS 2.0 API rbusObject_SetProperty</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1. Ccsp Components  should be in a running state of DUT
2. TDK Agent should be in running state or invoke it through StartTdk.sh script
3. The DUT should be in RBUS mode</pre_requisite>
    <api_or_interface_used>rbusObject_SetProperty</api_or_interface_used>
...
8. Release all RBUS Property using rbusProperty_Release API and return status should be success
9. Release all RBUS objects using rbusObject_Release API and return status should be success
10.Close the RBUS Connection using rbus_close API</automation_approch>
    <expected_output>Should be able to set the RBUS properties to the RBUS Objects using rbusObject_SetProperty API </expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_Object_SetProperty</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_RBUS_Object_SetProperty');
