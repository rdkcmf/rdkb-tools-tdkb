...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_RBUS_GetStringParamValue</name>
  <primitive_test_id/>
  <primitive_test_name>RBUS_GetValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the value of the DML parameter (string) using rbus_get and rbusValue_GetString RBUS APIs</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_RBUS_26</test_case_id>
    <test_objective>To Get the value of the DML parameter (String) using rbus_get and rbusValue_GetString RBUS APIs</test_objective>
...
rbuValue_GetString</api_or_interface_used>
...
3. Invoke the RBUS API rbusValue_GetString with the String parameter name and the return status should be success
...
6. Unload the module</automation_approch>
    <expected_output>Should  get the value of the String parameter</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_GetStringParamValue</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_RBUS_GetStringParamValue');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    parameterNameList = ["Device.WiFi.SSID.1.SSID"]
