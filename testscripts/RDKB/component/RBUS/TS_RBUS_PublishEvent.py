...
<xml>
  ...
  <name>TS_RBUS_PublishEvent</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the RBUS API rbus_publishEvent by publishing the registered event</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_47</test_case_id>
    <test_objective>To validate the RBUS API rbus_publishEvent by publishing the registered event</test_objective>
...
6. Publish the Event in the RBUS using rbus_publishEvent API, return status should be success
7. Unregister the Event in the RBUS using rbus_unregisterEvent API, return status should be success
...
11.Unload the rbus module</automation_approch>
    <expected_output>Should be able to publish the registered event</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_PublishEvent</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_RBUS_PublishEvent');
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    #Set the result status of execution
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 4: Publish the Event with RBUS ";
                    print "EXPECTED RESULT 4: rbus_publishEvent should be success";
                    print "ACTUAL RESULT 4: rbus_publishEvent was success";
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : %s" %actualresult ;
                    ...
                    print "TEST STEP 4: Publish the Event with RBUS ";
                    print "EXPECTED RESULT 4: rbus_publishEvent should be success";
                    print "ACTUAL RESULT 4: rbus_publishEvent was Failed";
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : %s" %actualresult ;
                print "*************End of Publishing Event*****************************\n"
                ...
                if expectedresult in actualresult:
                    ...
                    print "EXPECTED RESULT 5: rbus_unregisterEvent should be success";
                    print "ACTUAL RESULT 5: rbus_unregisterEvent was success";
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : %s" %actualresult ;
                    ...
                    print "TEST STEP 5: UnRegister the Event with RBUS ";
                    print "EXPECTED RESULT 5: rbus_unregisterEvent should be success";
                    print "ACTUAL RESULT 5: rbus_unregisterEvent was Failed";
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : %s" %actualresult ;
            else:
                #Set the result status of execution
