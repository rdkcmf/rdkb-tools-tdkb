...
<xml>
  ...
  <name>TS_RBUS_Property_PushBack</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate the RBUS 2.0 API rbusProperty_PushBack by creating three different properties</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To Validate the RBUS 2.0 API rbusProperty_PushBack by creating three different properties</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1. Ccsp Components  should be in a running state of DUT
2. TDK Agent should be in running state or invoke it through StartTdk.sh script
3. The DUT should be in RBUS mode</pre_requisite>
    <api_or_interface_used>rbusProperty_PushBack</api_or_interface_used>
...
11. Close the RBUS connection using rbus_close API</automation_approch>
    <expected_output>Should be able to get the Names and values of three different properties which was set for rbusProperty_PushBack</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_Property_PushBack</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_RBUS_Property_PushBack');
                ...
                if expectedresult in actualresult:
                    ...
                    if expectedresult in actualresult:
                        ...
                        if loop != 1:
                            ...
                            if loop == 2:
                                tdkTestObj.addParameter("prop_count",1);
                                print "Initiate the Property PushBack for Prop1 and Prop2"
                            else:
                                tdkTestObj.addParameter("prop_count",2);
                                print "Initiate the Property PushBack for Prop2 and Prop3"
