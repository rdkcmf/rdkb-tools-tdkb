...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_RBUS_Validate_UInt16DataType</name>
  <primitive_test_id/>
  <primitive_test_name>RBUS_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the value of Uint16 using Device.SampleProvider.AllTypes.Uint16Data and set a new value of  data Uint16 type and check if the value is getting set properly while the rbusSampleProvider App is running</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_RBUS_78</test_case_id>
    <test_objective>Get the value of Uint16 using Device.SampleProvider.AllTypes.Uint16Data and set a new value of  data Uint16 type and check if the value is getting set properly while the rbusSampleProvider App is running</test_objective>
...
3. Enable RBUS and ensure rbus_session_mgr is running</pre_requisite>
    ...
    <input_parameters>set_value: 65533</input_parameters>
...
4. When the App is running, fetch the value of Device.SampleProvider.AllTypes.UInt16Data and store it.
5. Set the set_value of UInt16 type and check if the set operation is success.
6. Fetch the value of Device.SampleProvider.AllTypes.UInt16Data and confirm whether the set operation is success.
7. Revert to initial UInt16 data value
...
9. Revert to the initial RBUS enable state if revert flag is set.</automation_approch>
    <expected_output>Set operation of Device.SampleProvider.AllTypes.UInt16Data should be success and the get operation should reflect the set value when rbusSampleProvider App is running.</expected_output>
    <priority>High</priority>
    <test_stub_interface>RBUS</test_stub_interface>
    <test_script>TS_RBUS_Validate_UInt16DataType</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RBUS_Validate_UInt16DataType');
tr181obj.configureTestCase(ip,port,'TS_RBUS_Validate_UInt16DataType');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() :
    ...
    if rbus_set == 1:
        ...
        if expectedresult in actualresult:
            ...
            print "[TEST EXECUTION RESULT] : SUCCESS";
            #Get the data type of UInt16 data
            cmd = "rbuscli get Device.SampleProvider.AllTypes.UInt16Data | grep -i value";
            print "Command : %s" %cmd;
            tdkTestObj.addParameter("command",cmd);
            tdkTestObj.executeTestCase(expectedresult);
            actualresult = tdkTestObj.getResult();
            details = tdkTestObj.getResultDetails().strip();
            print "\nTEST STEP 3: Get the UInt16 Data type value of Device.SampleProvider.AllTypes.UInt16Data";
            print "EXPECTED RESULT 3: Should get the uint16 data type value of Device.SampleProvider.AllTypes.UInt16Data";
            if expectedresult in actualresult and "Value" in details:
                ...
                print "[TEST EXECUTION RESULT] : SUCCESS";
                #Set value to Device.SampleProvider.AllTypes.UInt16Data
                set_value = "65533";
                cmd = "rbuscli set Device.SampleProvider.AllTypes.UInt16Data uint16 " + set_value + " | grep -i succeeded";
                print "Command : %s" %cmd;
                tdkTestObj.addParameter("command",cmd);
                tdkTestObj.executeTestCase(expectedresult);
                actualresult = tdkTestObj.getResult();
                details = tdkTestObj.getResultDetails().strip();
                print "\nTEST STEP 4: Set the UInt16 Data type value of Device.SampleProvider.AllTypes.UInt16Data to %s" %set_value;
                print "EXPECTED RESULT 4: Should set the uint16 data type value of Device.SampleProvider.AllTypes.UInt16Data successfully";
                if expectedresult in actualresult and "succeeded" in details:
                    ...
                    actualresult = tdkTestObj.getResult();
                    details = tdkTestObj.getResultDetails().strip();
                    print "\nTEST STEP 5: Get the UInt16 Data type value of Device.SampleProvider.AllTypes.UInt16Data";
                    print "EXPECTED RESULT 5: Should get the uint16 data type value of Device.SampleProvider.AllTypes.UInt16Data";
                    if expectedresult in actualresult and "Value" in details:
