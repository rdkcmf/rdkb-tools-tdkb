...
<xml>
  ...
  <name>TS_RBUS_Object_SetChildren</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate the RBUS 2.0 API rbusObject_SetChildren</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_69</test_case_id>
    <test_objective>To Validate the RBUS 2.0 API rbusObject_SetChildren</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1. Ccsp Components  should be in a running state of DUT
2. TDK Agent should be in running state or invoke it through StartTdk.sh script
3. The DUT should be in RBUS mode</pre_requisite>
    <api_or_interface_used>rbusObject_SetChildren</api_or_interface_used>
    <input_parameters>N/A</input_parameters>
    <automation_approch>2. Initiate the RBUS value using rbusValue_Init and set string value to it using rbusValue_Init API
...
6. Set the Property for the Object using rbusObject_SetProperty API and return status should be success
...
8. Set the children to the Object using rbusObject_SetChildren API  and return status should be success, the combination was (parent obj1 and child obj1 ) and (parent obj2 and child obj2)
9. Release all RBUS Property using rbusProperty_Release API and return status should be success
10.Release all RBUS objects using rbusObject_Release API and return status should be success
11.Close the RBUS Connection using rbus_close API
</automation_approch>
    <expected_output>Should be able to set RBUS Object as a child to another RBUS Object using rbusObject_SetChildren API </expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_Object_SetChildren</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_RBUS_Object_SetChildren');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    if expectedresult in actualresult:
        ...
        for count in range (1,3):
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    ...
                    print "Initialize the RBUS Property prop%d with Property Name %s" %(count,prop_name)
                    tdkTestObj = obj.createTestStep('RBUS_PropertyCommands');
        ...
        for count1 in range (1,5):
            ...
            print "Initialize the Object obj%d with Object Name %s" %(count1,obj_name)
            tdkTestObj = obj.createTestStep('RBUS_ObjectCommands');
        ...
        for count4 in range (1,3):
            ...
            if expectedresult in actualresult:
                ...
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : %s" %actualresult ;
        print "*************** End of RBUS Object Set Children Function **********************"
        ...
        for count5 in range (1,5):
            ...
            if expectedresult in actualresult:
                ...
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : %s" %actualresult ;
        print "*************** End of RBUS Object Release Function **********************"
