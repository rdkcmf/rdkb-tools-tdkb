...
<xml>
  ...
  <name>TS_RBUS_RegisterMethodsBeyondLimits</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the RBUS API rbus_registerMethod by registering methods beyond the limit (32)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_40</test_case_id>
    <test_objective>To validate the RBUS API rbus_registerMethod by registering methods beyond the limit (32)</test_objective>
...
5. Register the sample Methods multiple times (32 times) in the RBUS using rbus_registerMethod and the return status should be success
6. Try to Register the 33rd method using rbus_registerMethod and the return status should be failure since its beyond the limit
7. Unregister one Method from RBUS and the return status should be success
8. Now try to register the same method again and return status should be success
9. UnRegister the all registered methods using rbus_unregisterMethod API and the return status should be success
10. UnRegister the above object using rbus_unregisterObj API and the return status should be success
11. Close the rbus broker connection using rbus_closeBrokerConnection API
12. The rbus_closeBrokerConnection should be success
13. Unload the rbus module</automation_approch>
    <expected_output>Registering Methods should be allowed only within the accepted limit</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_RegisterMethodsBeyondLimits</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_RBUS_RegisterMethodsBeyondLimits');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj.addParameter("objectName","tdkb_method.obj1");
        ...
        if expectedresult in actualresult:
            ...
            print "\n*************Start of Registering Method*****************************"

            max_method = 32;
            method_name = "";
            counter = 0;

            for method in range(0,max_method):
                method_name = "Method"+str(method);
                print "Registering Method with Method Name ",method_name;

                tdkTestObj = obj.createTestStep('RBUS_RegisterOperation');
                tdkTestObj.addParameter("operation","registerMethod");
                tdkTestObj.addParameter("objectName","tdkb_method.obj1");
                tdkTestObj.addParameter("methodName",method_name);
            ...
            print "*************End of Registering 32 Method*****************************\n"

            print "Register Method Beyond the Limit(more than 32)"

            tdkTestObj = obj.createTestStep('RBUS_RegisterOperation');
            tdkTestObj.addParameter("operation","registerMethod");
            tdkTestObj.addParameter("objectName","tdkb_method.obj1");
            tdkTestObj.addParameter("methodName","Method33");
            ...
            if expectedresult in actualresult:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 3: Register the Method with RBUS Beyond the Limit";
                print "EXPECTED RESULT 3: rbus_registerMethod should Fail if the limit is exceeds 32";
                print "ACTUAL RESULT 3: rbus_registerMethod was Failed as expected";
                #Get the result of execution
                ...
                print "TEST STEP 3: Register the Method with RBUS Beyond the Limit";
                print "EXPECTED RESULT 3: rbus_registerMethod should Fail if the limit is exceeds 32";
                print "ACTUAL RESULT 3: rbus_registerMethod was NOT Failed";
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : FAILURE" ;

            print "\nUnregister one Method (Method0) to freeup the Method register queue"

            tdkTestObj = obj.createTestStep('RBUS_RegisterOperation');
            tdkTestObj.addParameter("operation","unregisterMethod");
            tdkTestObj.addParameter("objectName","tdkb_method.obj1");
            tdkTestObj.addParameter("methodName","Method0");
            expectedresult="SUCCESS";
            tdkTestObj.executeTestCase(expectedresult);
            actualresult = tdkTestObj.getResult();
            details = tdkTestObj.getResultDetails();
            ...
            if expectedresult in actualresult:
                ...
                print "\nRegister the Method (Method0) again after unregistering it"
                tdkTestObj = obj.createTestStep('RBUS_RegisterOperation');
                tdkTestObj.addParameter("operation","registerMethod");
                tdkTestObj.addParameter("objectName","tdkb_method.obj1");
                tdkTestObj.addParameter("methodName","Method0");
                ...
                if expectedresult in actualresult:
                    #Set the result status of execution
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 4: Register the Method with RBUS again";
                    print "EXPECTED RESULT 4: rbus_registerMethod should be success";
                    print "ACTUAL RESULT 4: rbus_registerMethod was success";
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : %s" %actualresult ;
                else:
                    #Set the result status of execution
                    ...
                    print "TEST STEP 4: Register the Method with RBUS again";
                    print "EXPECTED RESULT 4: rbus_registerMethod should be success";
                    print "ACTUAL RESULT 4: rbus_registerMethod was Failed";
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : %s" %actualresult ;
            else:
                #Set the result status of execution
            ...
            print "\n*************Start of UnRegistering Methods*****************************"
            method_name = "";
            for method in range(0,counter):
                method_name = "Method"+str(method);
                print "UnRegistering Method with Method Name ",method_name;
            ...
            print "*************End of UnRegistering 32 Methods*******************************\n"
