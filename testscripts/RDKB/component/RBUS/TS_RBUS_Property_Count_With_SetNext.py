...
<xml>
  ...
  <name>TS_RBUS_Property_Count_With_SetNext</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate the RBUS 2.0 API rbusProperty_Count with rbusProperty_SetBack APIs</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To Validate the RBUS 2.0 API rbusProperty_Count with rbusProperty_SetBack APIs</test_objective>
...
9. Close the RBUS connection using rbus_close API</automation_approch>
    ...
    <test_script>TS_RBUS_Property_Count_With_SetNext</test_script>
    <skipped>No</skipped>
