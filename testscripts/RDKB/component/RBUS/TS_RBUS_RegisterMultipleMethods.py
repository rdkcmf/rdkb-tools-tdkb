...
<xml>
  ...
  <name>TS_RBUS_RegisterMultipleMethods</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate RBUS APIs rbus_registerMethod and rbus_unregisterMethod by registering and unregistering multiple times (32 times)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_36</test_case_id>
    <test_objective>To validate RBUS APIs rbus_registerMethod and rbus_unregisterMethod by registering and unregistering multiple times (32 times)</test_objective>
...
6. UnRegister the all registered methods using rbus_unregisterMethod API and the return status should be success
...
10. Unload the rbus module</automation_approch>
    <expected_output>Should be able to Register all the Methods using rbus_regsisterMethod and unregister the Method using rbus_unregisterMethod</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_RegisterMultipleMethods</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_RBUS_RegisterMultipleMethods');
