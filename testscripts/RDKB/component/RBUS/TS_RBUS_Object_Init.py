...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate the RBUS 2.0 API rbusObject_Init</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_RBUS_62</test_case_id>
    <test_objective>To Validate the RBUS 2.0 API rbusObject_Init</test_objective>
...
3. The DUT should be in RBUS mode
    ...
    <api_or_interface_used>rbusObject_Init</api_or_interface_used>
...
3. Release the RBUS Object using rbusObject_Release API and return status should be success
4. Close the RBUS Connection using rbus_close API</automation_approch>
    <expected_output>Should be able to initiate the RBUS Object using rbusObject_Init API</expected_output>
    <priority>High</priority>
    <test_stub_interface>rbus</test_stub_interface>
    <test_script>TS_RBUS_Object_Init</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_RBUS_Object_Init');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 3: Initiate rbusObject_Release function";
            print "EXPECTED RESULT 3: rbusObject_Release should be success";
            print "ACTUAL RESULT 3: rbusObject_Release  was Success";
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
        else:
            #Set the result status of execution
            ...
            print "TEST STEP 3: Initiate rbusObject_Release function";
            print "EXPECTED RESULT 3: rbusObject_Release should be success";
            print "ACTUAL RESULT 3: rbusObject_Release was Failed";
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
