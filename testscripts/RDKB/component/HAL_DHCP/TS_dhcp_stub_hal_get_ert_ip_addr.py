...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>33</version>
  <name>TS_dhcp_stub_hal_get_ert_ip_addr</name>
  <primitive_test_id/>
  <primitive_test_name>dhcp_stub_hal_get_ert_ip_addr</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate HAL API dhcpv4c_get_ert_ip_addr()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_DHCP_20</test_case_id>
    <test_objective>To validate Ethsw HAL API dhcpv4c_get_ert_ip_addr()</test_objective>
...
2. From script invoke dhcpv4c_get_ert_ip_addr().
3. Get the IP address of erouter0.
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_DHCP stub.</automation_approch>
    ...
    <test_script>TS_dhcp_stub_hal_get_ert_ip_addr</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_dhcp_stub_hal_get_ert_ip_addr');
