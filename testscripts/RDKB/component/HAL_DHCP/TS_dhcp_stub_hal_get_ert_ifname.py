...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_dhcp_stub_hal_get_ert_ifname</name>
  <primitive_test_id/>
  <primitive_test_name>dhcp_stub_hal_get_ert_ifname</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To validate HAL API dhcpv4c_get_ert_ifname()</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_HAL_DHCP_19</test_case_id>
    <test_objective>To validate Ethsw HAL API dhcpv4c_get_ert_ifname()</test_objective>
...
2. From script invoke dhcpv4c_get_ert_ifname().
...
5. Test Manager will publish the result in GUI as PASS/FAILURE based on the response from HAL_DHCP stub.</automation_approch>
    <except_output>Interface name should be erouter0.</except_output>
    <priority>High</priority>
    <test_stub_interface>HAL_DHCP</test_stub_interface>
    <test_script>TS_dhcp_stub_hal_get_ert_ifname</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_dhcp_stub_hal_get_ert_ifname');
