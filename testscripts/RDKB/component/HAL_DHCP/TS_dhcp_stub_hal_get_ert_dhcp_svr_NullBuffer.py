...
<xml>
  ...
  <name>TS_dhcp_stub_hal_get_ert_dhcp_svr_NullBuffer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify NULL buffer functionality of dhcpv4c_get_ert_dhcp_svr()</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_HAL_DHCP_46</test_case_id>
    <test_objective>To verify NULL buffer functionality of dhcpv4c_get_ert_dhcp_svr()</test_objective>
...
2.invoke dhcpv4c_get_ert_dhcp_svr() by passing a NULL buffer
3.Check if dhcpv4c_get_ert_dhcp_svr() returns failure when NULL Buffer is passed
4. Unload dhcphal module</automation_approch>
    <expected_output>dhcpv4c_get_ert_dhcp_svr() should return failure when NULL Buffer is passed</expected_output>
    <priority>High</priority>
    <test_stub_interface>HAL_DHCP</test_stub_interface>
    <test_script>TS_dhcp_stub_hal_get_ert_dhcp_svr_NullBuffer</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_dhcp_stub_hal_get_ert_dhcp_svr_NullBuffer');
