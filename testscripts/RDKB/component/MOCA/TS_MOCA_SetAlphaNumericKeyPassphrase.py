...
<xml>
  ...
  <name>TS_MOCA_SetAlphaNumericKeyPassphrase</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set alphanumeric characters as KeyPassphrase. The password is expected to be of numeric characters only.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_MOCA_11</test_case_id>
    <test_objective>To set alphanumeric characters as KeyPassphrase. The password is expected to be of numeric characters only.</test_objective>
...
3. Invoke Mocastub_Set to set the password of alpha numeric characters
...
CheckPoint 3:
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</expected_output>
    <priority>High</priority>
    <test_stub_interface>None</test_stub_interface>
    <test_script>TS_MOCA_SetAlphaNumericKeyPassphrase</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MOCA_SetAlphaNumericKeyPassphrase');
    ...
    if expectedresult in (actualresult1,actualresult2):
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                tdkTestObj.addParameter("ParamValue","abcd12345efgh");
                ...
                if expectedresult in actualresult:
                    ...
                    print "EXPECTED RESULT 5: Should not set alphanumberic KeyPassphrase";
