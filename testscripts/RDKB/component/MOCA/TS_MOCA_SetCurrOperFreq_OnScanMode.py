...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To check whether the current operating frequency is changing when channel selection mode is true. ie, scan mode. The current operating frequency is expected to be changed only when channel selection is false. ie, manual mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check whether the current operating frequency is changing when channel selection mode is true. ie, scan mode. The current operating frequency is expected to be changed only when channel selection is false. ie, manual mode</test_objective>
...
2. From script invoke Mocastub_Set to set the channel selection as scan mode
3. Change the frequency mask and check whether the current operating frequency is changed or not
...
5.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from Moca stub.</automation_approch>
 ...
 The current operating frequency should not be changed on scan mode.
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    #Get the current value of channel selection mode,CurrentOperFreq and FreqCurrentMaskSetting
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : SUCCESS";
		#set the ChannelScanning as true, ie. scan mode
                ...
                if expectedresult in actualresult:
                    ...
                    print "EXPECTED RESULT 4: Should set channel selection mode as true";
                    print "ACTUAL RESULT 4: %s" %details;
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : SUCCESS";
		    #set the FreqCurrentMaskSetting to a different value so that CurrentOperFreq will change
                    tdkTestObj = obj.createTestStep('Mocastub_Set');
                    tdkTestObj.addParameter("ParamName","Device.MoCA.Interface.1.FreqCurrentMaskSetting");
			...
			#Check whether the CurrentOperFreq is changed
                        ...
                        if expectedresult in actualresult and New_Freq in Curr_Freq:
                            #Set the result status of execution
                            tdkTestObj.setResultStatus("SUCCESS");
                            print "TEST STEP 6: Get the current operating frequency and check with previous frequency";
                            print "EXPECTED RESULT 6: Current operating frequency should not change";
                            print "ACTUAL RESULT 6: The current operating frequency and new operating frequency are :%s and %s" %(Curr_Freq,New_Freq);
                            #Get the result of execution
                            print "[TEST EXECUTION RESULT] : SUCCESS";
                        else:
                            #Set the result status of execution
                ...
                if expectedresult in actualresult:
                    ...
                    print "EXPECTED RESULT : Should set channel selection mode as default";
                    print "ACTUAL RESULT : %s" %details;
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : SUCCESS";
                else:
