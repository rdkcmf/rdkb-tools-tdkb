...
2. From script invoke Mocastub_Eet to set the frequency mask
3. Get the current opearting frequency and check whether the value has changed
	...
	tdkTestObj = obj.createTestStep('Mocastub_Get');
	    ...
	    tdkTestObj = obj.createTestStep('Mocastub_Get');
			...
			tdkTestObj = obj.createTestStep('Mocastub_Get');
        		...
        		if expectedresult in actualresult and New_Freq != Curr_Freq:
        		    #Set the result status of execution
        		    tdkTestObj.setResultStatus("SUCCESS");
        		    print "TEST STEP 6: Get the current operating frequency and check with previous frequency";
        		    print "EXPECTED RESULT 6: Current operating frequency should change";
