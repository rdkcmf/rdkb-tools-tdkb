...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_MOCA_SetInvalidBeaconPowerLimit</name>
  <primitive_test_id/>
  <primitive_test_name>Mocastub_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set an invalid beacon power limit and check whether it is failing. The valid values are [0,3,6,9,12,15]</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_MOCA_09</test_case_id>
    <test_objective>To set an invalid beacon power limit and check whether it is failing. The valid values are [0,3,6,9,12,15]</test_objective>
...
3. Set an invalid value and check whether it is failing
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_MOCA_SetInvalidBeaconPowerLimit</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj.addParameter("ParamName","Device.MoCA.Interface.1.BeaconPowerLimit");
        tdkTestObj.addParameter("ParamValue","12345678910");
        ...
        if expectedresult in actualresult:
            ...
            print "EXPECTED RESULT 2: Should not set an invalid BeaconPowerLimit";
