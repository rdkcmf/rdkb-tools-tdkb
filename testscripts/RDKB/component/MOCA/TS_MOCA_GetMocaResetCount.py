...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_MOCA_GetMocaResetCount</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_MOCA_15</test_case_id>
    <test_objective>To check whether the MocaResetCount is getting increment after each reset</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.MoCA.Interface.1.X_CISCO_COM_Reset
Device.MoCA.MocaResetCount
</input_parameters>
    <automation_approch>1. Load MOCA modules
2. From script invoke Mocastub_Set to reset moca
3. Get the reset count and check whether it has incremented
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_MOCA_GetMocaResetCount</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
