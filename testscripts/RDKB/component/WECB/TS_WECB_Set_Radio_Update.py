...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_WECB_10</test_case_id>
    <test_objective>To verify enabling/disabling of Radio update</test_objective>
...
Input:
1. paramName - Device.MoCA.X_CISCO_COM_WiFi_Extender.X_CISCO_COM_Radio_Updated
2. paramValue - true/false
3. paramType - boolean
4. commit - 0/1</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the WECB library via Test agent
4.From python script, invoke WECB_GetParamValues stub function to check if already enabled or not. Based on that invoke WECB_SetParamValues stub function to set enable/disable. Similarly vice versa.
5.WECB stub function will call the ssp_getParameterValue() and ssp_setParameterValue() function in TDK component which in turn will call Ccsp Base Function of Ccsp Common Library in RDKB.
...
Enabling/Disabling should be success based on the request and should see the corresponding log in the Agent console/Component log
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_script>TS_WECB_Set_Radio_Update</test_script>
    <skipped>No</skipped>
