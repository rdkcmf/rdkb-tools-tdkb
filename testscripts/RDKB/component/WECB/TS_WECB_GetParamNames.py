...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_WECB_1</test_case_id>
    <test_objective>To verify whether the writable field of Device.MoCA.X_CISCO_COM_WiFi_Extender.X_CISCO_COM_FactoryReset matches with the list associated with Device.MoCA</test_objective>
...
Input:
1.paramList- Device.MoCA.X_CISCO_COM_WiFi_Extender.
2. paramName - Device.MoCA.X_CISCO_COM_WiFi_Extender.X_CISCO_COM_FactoryReset</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the WECB library via Test agent
4.From python script, invoke WECB_GetParamNames() stub function to get the parameter names associated with the argument passed.
5.WECB stub function will call the ssp_getParameterNames() function in TDK component which in turn will call Ccsp Base Function CcspBaseIf_getParameterNames() of Ccsp Common Library in RDKB.
...
Parameter names associated with the Object specified should be listed in the Agent console/Component log
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_script>TS_WECB_GetParamNames</test_script>
    <skipped>No</skipped>
