...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_WECB_4</test_case_id>
    <test_objective>To verify enabling/disabling of SSID update</test_objective>
...
Input:
1. paramName - Device.MoCA.X_CISCO_COM_WiFi_Extender.X_CISCO_COM_SSID_Updated
2. paramValue - true
3. paramType - boolean
...
WECB should successfully set the parameter value for the specified parameter and corresponding log should be seen in the Agent console/Component log
...
Stub function result should be success and should see corresponding log in the agent console log</except_output>
    ...
    <test_script>TS_WECB_Set_SSID_Update</test_script>
    <skipped>No</skipped>
