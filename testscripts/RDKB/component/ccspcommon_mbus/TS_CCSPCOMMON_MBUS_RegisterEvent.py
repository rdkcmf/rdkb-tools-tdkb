...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_CCSPCOMMON_MBUS_RegisterEvent</name>
  <primitive_test_id/>
  <primitive_test_name>CCSPMBUS_RegisterEvent</primitive_test_name>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_CCSPCOMMON_MBUS_RegisterEvent.py)
...
Message Bus Event Registered success log from DUT should be available in Agent Console Log
CheckPoint 2:
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_CCSPCOMMON_MBUS_RegisterEvent</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CCSPCOMMON_MBUS_RegisterEvent');
