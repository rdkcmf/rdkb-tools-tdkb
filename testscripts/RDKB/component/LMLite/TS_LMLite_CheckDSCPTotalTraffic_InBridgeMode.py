...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_LMLite_CheckDSCPTotalTraffic_InBridgeMode</name>
  <primitive_test_id/>
  <primitive_test_name>LMLiteStub_Set_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if the DSCP Total traffic counts retrieved using Device.X_RDK_WAN.Interface.1.Stats.DscpCountTotal is empty when the Lan Mode is set to "bridge-static" even though the DSCP Traffic count is enabled with valid DSCP values and the DSCP interval is set.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_LMLite_27</test_case_id>
    <test_objective>To check if the DSCP Total traffic counts retrieved using Device.X_RDK_WAN.Interface.1.Stats.DscpCountTotal is empty when the Lan Mode is set to "bridge-static" even though the DSCP Traffic count is enabled with valid DSCP values and the DSCP interval is set.</test_objective>
...
paramValue : bridge-static/router
paramType : string
...
9. Toggle the lan mode to bridge -static using Device.X_CISCO_COM_DeviceControl.LanManagementEntry.1.LanMode and validate with get operation.
10. Sleep for the duration of Device.X_RDK_WAN.Interface.1.Stats.DscpCountInterval set.
11. Check if the DSCP traffic counts retrieved using Device.X_RDK_WAN.Interface.1.Stats.DscpCountTotal is empty in bridge-static mode.
12. Revert the lan mode to router.
...
16. Unload the module</automation_approch>
    <expected_output>DSCP traffic counts retrieved using Device.X_RDK_WAN.Interface.1.Stats.DscpCountTotal should be empty when the lan mode is bridge-static even when the DSCP is enabled and DSCP interval is set.</expected_output>
    <priority>High</priority>
    <test_stub_interface>lmlite</test_stub_interface>
    <test_script>TS_LMLite_CheckDSCPTotalTraffic_InBridgeMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_LMLite_CheckDSCPTotalTraffic_InBridgeMode');
