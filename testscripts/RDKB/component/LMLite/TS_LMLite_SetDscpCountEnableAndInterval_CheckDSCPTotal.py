...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>12</version>
  <name>TS_LMLite_SetDscpCountEnableAndInterval_CheckDSCPTotal</name>
  <primitive_test_id/>
  <primitive_test_name>LMLiteStub_Set_Get</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the DSCP WAN values to "0,8,20,28" using Device.X_RDK_WAN.Interface.1.Stats.DscpCountEnable and check if the total traffic count is getting populated with valid values in the interval set using Device.X_RDK_WAN.Interface.1.Stats.DscpCountInterval.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_LMLite_25</test_case_id>
    <test_objective>To set the DSCP WAN values to "0,8,20,28" using Device.X_RDK_WAN.Interface.1.Stats.DscpCountEnable and check if the total traffic count is getting populated with valid values in the interval set using Device.X_RDK_WAN.Interface.1.Stats.DscpCountInterval.</test_objective>
...
16. Unload the module</automation_approch>
    <expected_output>Device.X_RDK_WAN.Interface.1.Stats.DscpCountTotal should be updated with valid DSCP WAN traffic counts when Device.X_RDK_WAN.Interface.1.Stats.DscpCountEnable is enabled and Device.X_RDK_WAN.Interface.1.Stats.DscpCountInterval is set to a non-zero value.</expected_output>
    <priority>High</priority>
    <test_stub_interface>lmlite</test_stub_interface>
    <test_script>TS_LMLite_SetDscpCountEnableAndInterval_CheckDSCPTotal</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_LMLite_SetDscpCountEnableAndInterval_CheckDSCPTotal');
