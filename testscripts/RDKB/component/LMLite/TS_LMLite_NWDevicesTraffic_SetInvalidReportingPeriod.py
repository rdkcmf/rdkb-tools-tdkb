...
<xml>
  ...
  <name>TS_LMLite_NWDevicesTraffic_SetInvalidReportingPeriod</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether the NetworkDevicesTraffic.ReportingPeriod is a valid value. ie,[30,60,300,900,1800,3600,10800,21600,43200,86400]. Then try to set an invalid value to it</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_LMLite_19</test_case_id>
    <test_objective>To check whether the NetworkDevicesTraffic.ReportingPeriod is a valid value. ie,[30,60,300,900,1800,3600,10800,21600,43200,86400]. Then try to set an invalid value to it</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.X_RDKCENTRAL-COM_Report.NetworkDevicesTraffic.ReportingPeriod</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_LMLite_NWDevicesTraffic_SetInvalidReportingPeriod</test_script>
    <skipped>No</skipped>
