...
<xml>
  ...
  <name>TS_LMLite_NWDeviceStatus_SetInvalidDevicesStatusReportingPeriod</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether the NetworkDevicesStatus.ReportingPeriod is a valid value. ie,[5,10,15,30,60,300,900,1800,3600,10800,21600,43200,86400]. Then try to set an invalid value to it</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_LMLite_07</test_case_id>
    <test_objective>To check whether the NetworkDevicesStatus.ReportingPeriod is a valid value. ie,[5,10,15,30,60,300,900,1800,3600,10800,21600,43200,86400]. Then try to set an invalid value to it</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.X_RDKCENTRAL-COM_Report.NetworkDevicesStatus.ReportingPeriod</input_parameters>
    <automation_approch>1. Load Lmlite modules
2. From script invoke LMLiteStub_Get to get the reporting period
3. Set an invalid value for the reporting period
4. Set the reporting period to default value
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_LMLite_NWDeviceStatus_SetInvalidDevicesStatusReportingPeriod</test_script>
    <skipped>No</skipped>
