...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_XDNS_CheckEnableStatus_OnReboot</name>
  <primitive_test_id/>
  <primitive_test_name>XDNS_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if the enable status of XDNS persists on reboot</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_XDNS_03</test_case_id>
    <test_objective>To check if the enable status of XDNS persists on reboot</test_objective>
...
3. Enable XDNS
4. Reboot the device
5. Check if the status of XDNS is true itself
6. Revert the values
</automation_approch>
    <except_output>The enable status of XDNS should persist on reboot</except_output>
    <priority>High</priority>
    <test_stub_interface>pam</test_stub_interface>
    <test_script>TS_XDNS_CheckEnableStatus_OnReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_XDNS_CheckEnableStatus_OnReboot');
