...
<xml>
  ...
  <name>TS_EPONHAL_GetHalRebootReady</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Invoke Hal Reboot Ready api and check if the value returned is 1 for Ready or 2 for NotReady</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_EPONHAL_18</test_case_id>
    <test_objective>Get the  Hal Reboot Ready using dpoe_hal_Reboot_Ready  and check  if the value returned is 1 for Ready  or 2 for NotReady</test_objective>
...
3. Unload eponhal module</automation_approch>
    ...
    <test_script>TS_EPONHAL_GetHalRebootReady</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_EPONHAL_GetHalRebootReady');
