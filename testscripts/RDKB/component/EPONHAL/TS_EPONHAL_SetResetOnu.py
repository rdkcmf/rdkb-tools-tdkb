...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_EPONHAL_SetResetOnu</name>
  <primitive_test_id/>
  <primitive_test_name>EPONHAL_SetResetOnu</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if the Onu link is reset  after performing dpoe_setResetOnu.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_EPONHAL_27</test_case_id>
    <test_objective>Check the functonality of dpoe_setResetOnu</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state else invoke cosa_start.sh manually that includes all the ccsp components and TDK Component
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>dpoe_setResetOnu</api_or_interface_used>
    <input_parameters>None</input_parameters>
    <automation_approch>1. Load eponhal module
2. Get the initial  tx frame rate and Rx frame rate
3. invoke dpoe_setResetOnu  from the script
...
6. Unload eponhal module</automation_approch>
    <expected_output>The dpoe_setResetOnu  should clear the onu link statistics</expected_output>
    <priority>High</priority>
    <test_stub_interface>EPONHAL</test_stub_interface>
    <test_script>TS_EPONHAL_SetResetOnu</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_EPONHAL_SetResetOnu');
tr181obj.configureTestCase(ip,port,'TS_EPONHAL_SetResetOnu');
