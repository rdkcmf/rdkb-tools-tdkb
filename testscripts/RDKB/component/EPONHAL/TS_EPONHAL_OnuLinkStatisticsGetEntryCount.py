...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_EPONHAL_OnuLinkStatisticsGetEntryCount</name>
  <primitive_test_id/>
  <primitive_test_name>EPONHAL_GetParamUlongValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>dpoe_OnuLinkStatisticsGetEntryCount gives the maximum number of logical links the ONU supports on the EPON</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_EPONHAL_12</test_case_id>
    <test_objective>Get the   maximum number of logical links using dpoe_OnuLinkStatisticsGetEntryCount and check  if  number of   logical link is greater than 0</test_objective>
...
3. Unload eponhal module</automation_approch>
    ...
    <test_script>TS_EPONHAL_OnuLinkStatisticsGetEntryCount</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_EPONHAL_OnuLinkStatisticsGetEntryCount');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","OnuLinkStatisticsGetEntryCount");
