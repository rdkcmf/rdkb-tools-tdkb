...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_TelcoVoiceMgrHal_InitData</name>
  <primitive_test_id/>
  <primitive_test_name>TELCOVOICEMgrHal_InitData</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Initialize the Telco Voice Manager Hal Data.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TELCOVOICEMGRHAL_06</test_case_id>
    <test_objective>Initialize the Telco Voice Manager Hal Data.</test_objective>
...
6. Invoke the json_hal_add_param with the parameter name "1" - valid bStatus.
...
10. Unload the Telco Voice HAL Module</automation_approch>
    <expected_output>Should successfully initialize the Telco Voice Manager Hal Data.</expected_output>
    <priority>High</priority>
    <test_stub_interface>telcovoicemgrhal</test_stub_interface>
    <test_script>TS_TelcoVoiceMgrHal_InitData</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TelcoVoiceMgrHal_InitData');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj.addParameter("bStatus", 1);
        expectedresult = "SUCCESS";
        tdkTestObj.executeTestCase(expectedresult);
        actualresult = tdkTestObj.getResult();
        details = tdkTestObj.getResultDetails();
