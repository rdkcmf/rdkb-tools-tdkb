...
<xml>
  ...
  <name>TS_TelcoVoiceMgrHal_GetPhyInterface</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Get the Telco Voice Manager HAL Physical Interface structure values</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TELCOVOICEMGRHAL_05</test_case_id>
    <test_objective>Get the Telco Voice Manager HAL Physical Interface structure values.</test_objective>
...
10. Unload the Telco Voice HAL Module</automation_approch>
    <expected_output>Should be able to successfully retrieve the Telco Voice HAL Physical Interface structure values.</expected_output>
    <priority>High</priority>
    <test_stub_interface>telcovoicemgrhal</test_stub_interface>
    <test_script>TS_TelcoVoiceMgrHal_GetPhyInterface</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TelcoVoiceMgrHal_GetPhyInterface');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            print "EXPECTED RESULT 2: GetPhyInterface operation should be success ";
            print "ACTUAL RESULT 2: GetPhyInterface operation was success , Details: ",details;
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
            ...
            print "TEST STEP 2: Get the Physical Interafce details";
            print "EXPECTED RESULT 2: GetPhyInterface operation should be success ";
            print "ACTUAL RESULT 2: GetPhyInterface operation was Failed ";
            #Get the result of execution
            print "[TEST EXECUTION RESULT] : %s" %actualresult ;
    else:
        #Set the result status of execution
