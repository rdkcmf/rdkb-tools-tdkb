...
<xml>
  ...
  <name>TS_PAM_IpIfGetV6Prefix</name>
  ...
  <test_cases>
    <test_case_id>TC_PAM_76</test_case_id>
    <test_objective>To get the Prefix of IPV6 address</test_objective>
...
Input:
ParamName - Device.IP.Interface.1.IPv6Prefix.1.</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_GetParameterValues() stub function to get the prefix of IPV6 address.
...
8.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
 ...
 The prefix of IPv6 Address should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_IpIfGetV6Prefix</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
pamObj.configureTestCase(ip,port,'TS_PAM_IpIfGetV6Prefix');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    ...
	    tdkTestObj = pamObj.createTestStep('pam_GetParameterValues');
            tdkTestObj.addParameter("ParamName","%s" %addrInstance);
	    print "Parameter Name: %s" %addrInstance
            tdkTestObj.executeTestCase(expectedresult);
            actualresult = tdkTestObj.getResult();
	    ...
	    if expectedresult in actualresult:
                ...
                print "EXPECTED RESULT 1: Should get IPv6Prefix details"
