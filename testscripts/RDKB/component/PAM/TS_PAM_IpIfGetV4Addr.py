...
<xml>
  ...
  <name>TS_PAM_IpIfGetV4Addr</name>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_IpIfGetV4Addr</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
pamObj.configureTestCase(ip,port,'TS_PAM_IpIfGetV4Addr');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    ...
	    if expectedresult in actualresult:
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 1: Get IPv4Address value"
                print "EXPECTED RESULT 1: Should get IPv4Address value"
                print "ACTUAL RESULT 1: IPv4address is %s" %details;
                #Get the result of execution
