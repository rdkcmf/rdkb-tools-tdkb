...
<xml>
  ...
  <name>TS_ParentalCtrl_ManagedSitesDisabled_AddRule</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify whether user is able to add rule when ManagedSites is disabled</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_150</test_case_id>
    <test_objective>To verify whether user is able to add rule when ManagedSites is disabled</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_ManagedSitesDisabled_AddRule</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_ManagedSitesDisabled_AddRule');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_ManagedSitesDisabled_AddRule');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Set ManagedSites Enable status as false";
