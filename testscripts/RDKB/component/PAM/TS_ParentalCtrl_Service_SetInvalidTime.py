...
<xml>
  ...
  <name>TS_ParentalCtrl_Service_SetInvalidTime</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test if for a managed service, start time can be set as greater than end time</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_140</test_case_id>
    <test_objective>Test if for a managed service, start time can be set as greater than end time</test_objective>
...
AdvancedConfig_DelObject</api_or_interface_used>
    <input_parameters>"Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|ftp|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|false|bool|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartTime|02:54|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndTime|01:54|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.BlockDays|Sunday|string" %(instance, instance, instance, instance, instance, instance, instance, instance)</input_parameters>
...
7. With AdvancedConfig_SetMultiple, set  invalid time
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_Service_SetInvalidTime</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetInvalidTime');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetInvalidTime');
	...
	org_status = details;
		...
		#set the rule's starting time greater than end time
                if (instance > 0):
                    ...
                    tdkTestObj.addParameter("paramList","Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|ftp|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|false|bool|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartTime|02:54|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndTime|01:54|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.BlockDays|Sunday|string" %(instance, instance, instance, instance, instance, instance, instance, instance));
		    expectedresult="FAILURE";
        	    ...
        	    if expectedresult in actualresult:
	                tdkTestObj.setResultStatus("SUCCESS");
                	print "[TEST STEP 4]: Setting invalid time for managed services"
