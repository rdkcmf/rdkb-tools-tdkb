...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>TC_PAM_68</test_case_id>
    <test_objective>To change the cusadmin password</test_objective>
...
Input:
ParamName - Device.Users.User.2.X_CISCO_COM_Password</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_DeviceUsers_SetCusAdminPassword</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
