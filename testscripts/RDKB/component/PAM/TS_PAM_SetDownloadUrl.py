...
<xml>
  ...
  <name>TS_PAM_SetDownloadUrl</name>
  ...
  <test_cases>
    <test_case_id>TC_PAM_39</test_case_id>
    <test_objective>To set the download URL</test_objective>
...
Input:
ParamName - Device.IP.Diagnostics.DownloadDiagnostics.DownloadURL
ParamValue - Valid url
Type - String</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_SetParameterValues() stub function to set the download URL.
...
Download URL should be set and logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_SetDownloadUrl</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_SetDownloadUrl');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("ParamValue","www.google.com");
