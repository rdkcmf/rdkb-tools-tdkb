...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_COSAPAM_EthPortGetDInfo</name>
  <primitive_test_id/>
  <primitive_test_name>COSAPAM_DmlEthGetParamValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test case is to get the eth port dynamic info</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_115</test_case_id>
    <test_objective>to get the eth port dynamic info</test_objective>
...
4.From python script, invoke COSAPAM_DmlEthGetParamValue() stub function with parameter GetDinfo  .
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_COSAPAM_EthPortGetDInfo</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_COSAPAM_EthPortGetDInfo');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("MethodName","GetDinfo");
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1: Get the EthPortDinfo";
        print "EXPECTED RESULT 1: Should get the EthPortDinfo";
        print "ACTUAL RESULT 1: EthPortDinfo is %s" %details;
        #Get the result of execution
        print "[TEST EXECUTION RESULT] : SUCCESS";
    else:
        tdkTestObj.setResultStatus("FAILURE");
        print "TEST STEP 1: Get the EthPortDinfo";
        print "EXPECTED RESULT 1: Failure in getting the EthPortDinfo";
        print "ACTUAL RESULT 1: EthPortDinfo is %s" %details;
