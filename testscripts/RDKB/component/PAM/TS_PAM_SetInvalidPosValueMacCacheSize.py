...
<xml>
  ...
  <name>TS_PAM_SetInvalidPosValueMacCacheSize</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check the functionality of Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.RabidFramework.MacCacheSize by setting a Invalid Value</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>This test case will check whether an invalid positive value can be set as Mac Cache size </test_objective>
...
4.Now get the initial  Mac cache size  and store in a variable.
5.Generate a random number between 32768- 40000 which is the invalid range
6.Set the invalid value as MAc cache size and the parameter should not set the value successfully.
...
9.unload the loaded modules
    ...
    <expected_output>The invalid positive value should not be set as Cache Size</expected_output>
    <priority>High</priority>
    <test_stub_interface>PAM</test_stub_interface>
    <test_script>TS_PAM_SetInvalidPosValueMacCacheSize</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_SetInvalidPosValueMacCacheSize');
