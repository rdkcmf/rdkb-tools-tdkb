...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_COSAPAM_EthMlanInit</name>
  <primitive_test_id/>
  <primitive_test_name>COSAPAM_DmlEthGetParamValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test case is to get the EthMlanInit status</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>to get the EthMlanInit status</test_objective>
...
4.From python script, invoke COSAPAM_DmlEthGetParamValue() stub function with parameter Init  .
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_COSAPAM_EthMlanInit</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_COSAPAM_EthMlanInit');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1: Get the Eth init status";
        print "EXPECTED RESULT 1: Should get the eth init status";
        print "ACTUAL RESULT 1: Succesfully initialized %s" %details;
        ...
        print "TEST STEP 1: Get the Eth init status";
        print "EXPECTED RESULT 1: Should get the eth init status";
        print "ACTUAL RESULT 1: Initialization failed %s" %details;
