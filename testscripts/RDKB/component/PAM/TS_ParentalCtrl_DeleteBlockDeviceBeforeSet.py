...
<xml>
  ...
  <name>TS_ParentalCtrl_DeleteBlockDeviceBeforeSet</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test whether a rule can be deleted before setting its attributes</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_146</test_case_id>
    <test_objective>Test to delete a blocking rule</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_DeleteBlockDeviceBeforeSet</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_DeleteBlockDeviceBeforeSet');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_DeleteBlockDeviceBeforeSet');
