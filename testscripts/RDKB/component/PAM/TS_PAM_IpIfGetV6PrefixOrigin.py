...
<xml>
  ...
  <name>TS_PAM_IpIfGetV6PrefixOrigin</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test case will retrieve the origin type of IPv6 prefix</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_77</test_case_id>
    <test_objective>To get the origin type of IPv6 prefix</test_objective>
...
Input:
ParamName - Device.IP.Interface.1.IPv6Prefix.1.Origin</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_GetParameterValues() stub function to get the origin type of IPV6 prefix.
...
8.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
 ...
 The origin type of IPv6 prefix should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_IpIfGetV6PrefixOrigin</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
pamObj.configureTestCase(ip,port,'TS_PAM_IpIfGetV6PrefixOrigin');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    ...
	    if expectedresult in actualresult:
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 1: Get IPv6Prefix details"
                print "EXPECTED RESULT 1: Should get IPv6Prefix Origin Type"
