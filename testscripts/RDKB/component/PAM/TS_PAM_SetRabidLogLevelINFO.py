...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_PAM_SetRabidLogLevelINFO</name>
  <primitive_test_id/>
  <primitive_test_name>pam_GetParameterNames</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set the Rabid logging level to info and verify .</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_226</test_case_id>
    <test_objective>To set the Rabid logging level to info and verify </test_objective>
...
5.Check the same logged in agent.txt with log message "to LogLevel-3"
...
8.Unload the module</automation_approch>
    ...
    <test_script>TS_PAM_SetRabidLogLevelINFO</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in (loadmodulestatus1.upper() and loadmodulestatus2.upper()):
    ...
    if expectedresult in actualresult:
       ...
       print "TEST STEP 2: Setting Finger print log level to INFO";
       tdkTestObj = pamObj.createTestStep('pam_SetParameterValues');
       tdkTestObj.addParameter("ParamName","Device.DeviceInfo.X_RDKCENTRAL-COM_DeviceFingerPrint.LogLevel")
       tdkTestObj.addParameter("ParamValue","3");
           ...
           if expectedresult in actualresult  and "to LogLevel-3" in details:
               ...
               if expectedresult in actualresult and CUJO_GET!="":
                   ...
                   if expectedresult in actualresult and details  == "3":
                       ...
                       print "EXPECTED RESULT 5: should get log level as 3 for Error log level";
