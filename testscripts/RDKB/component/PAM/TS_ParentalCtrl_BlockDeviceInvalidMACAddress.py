...
<xml>
  ...
  <name>TS_ParentalCtrl_BlockDeviceInvalidMACAddress</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the configuration of the MAC address for the blocked device rule</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_136</test_case_id>
    <test_objective>Check if an invalid MAC address can be set as the MAC address of the device to be blocked</test_objective>
...
Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.Description|Comcast|string|Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.MACAddress|BC305BBF9823|string|Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.AlwaysBlock|true|bool" %(instance1, instance1, instance1</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_BlockDeviceInvalidMACAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_BlockDeviceInvalidMACAddress');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_BlockDeviceInvalidMACAddress');
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 4: Set Access Type AllowAll as true";
                    print "EXPECTED RESULT 4: Should set Access Type AllowAll as true";
                    ...
                    if expectedresult in actualresult:
                        ...
                        if (instance1 > 0):
                            ...
                            tdkTestObj.addParameter("paramList","Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.Description|Comcast|string|Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.MACAddress|BC305BBF9823|string|Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.AlwaysBlock|true|bool" %(instance1, instance1, instance1));
                            ...
                            if expectedresult in actualresult:
                                tdkTestObj.setResultStatus("SUCCESS");
                                print "[TEST STEP 6]: Setting an invalid MAC Address"
                    ...
                    tdkTestObj.setResultStatus("FAILURE");
                    print "TEST STEP 4: Set ManagedDevices access type  AllowAll as true";
                    print "EXPECTED RESULT 4: Should set the access type AllowAll as truee";
