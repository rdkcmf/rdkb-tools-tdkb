...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if two managed services can have the same port values</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_144</test_case_id>
    <test_objective>Check if two managed services can have the same port values</test_objective>
...
"Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|TCP|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|24|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance, instance, instance, instance, instance)</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_Sevice_SetDuplicatePorts</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_Sevice_SetDuplicatePorts');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_Sevice_SetDuplicatePorts');
