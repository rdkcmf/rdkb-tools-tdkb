...
<xml>
  ...
  <name>TS_ParentalCtrl_SetInvalidBlockingKeywordWithSpace</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if an invalid url with white space can be set as the url attribute of a site to be blocked</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_132</test_case_id>
    <test_objective>Check if an invalid url with white space can be set the url attribute of a site to be blocked</test_objective>
...
Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.BlockMethod|URL|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.Site|go ogle.com|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.AlwaysBlock|true|bool" %(instance, instance, instance)</input_parameters>
...
7. With AdvancedConfig_SetMultiple, set mode of blocking and invalid url
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_SetInvalidBlockingKeywordWithSpace</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidBlockingKeywordWithSpace');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidBlockingKeywordWithSpace');
	...
	org_status = details;
		...
		temp = details.split(':');
		    ...
		    #Setting the external port
                    ...
                    tdkTestObj.addParameter("paramList","Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.BlockMethod|Keyword|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.Site|go ogle|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.AlwaysBlock|true|bool" %(instance, instance, instance));
		    expectedresult="FAILURE";
        	    ...
        	    if expectedresult in actualresult:
	                tdkTestObj.setResultStatus("SUCCESS");
                	print "[TEST STEP 4]: Setting invalid keyword for site to be blocked"
	                print "[EXPECTED RESULT 4]: Should fail in setting invalid keyword"
            	        print "[ACTUAL RESULT 4]: SUCESS: Didn't set invalid keyword %s" %details;
	                print "[TEST EXECUTION RESULT] : %s" %actualresult;
		        ...
		        tdkTestObj.setResultStatus("FAILURE");
                        print "[TEST STEP 4]: Setting invalid keyword for site to be blocked"
                        print "[EXPECTED RESULT 4]: Should fail in setting invalid keyword"
                        print "[ACTUAL RESULT 4]: FAILURE: Could add invalid keyword in rule";
                        print "[TEST EXECUTION RESULT] : %s" %actualresult;
