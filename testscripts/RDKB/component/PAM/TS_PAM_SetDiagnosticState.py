...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_PAM_38</test_case_id>
    <test_objective>To set the diagnostics state</test_objective>
...
4.From python script, invoke pam_SetParameterValues() stub function to set the diagnostic state.
...
Diagnostics state  should be set and logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_SetDiagnosticState</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_SetDiagnosticState');
