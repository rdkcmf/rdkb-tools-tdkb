...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_PAM_DeviceUsers_EnableCusAdminUser</name>
  <primitive_test_id/>
  <primitive_test_name>pam_SetParameterValues</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test case will enable the Cusadmin user login</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_64</test_case_id>
    <test_objective>To enable the Cusadmin user login</test_objective>
...
Input:
ParamName - Device.Users.User.2.Enable</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_SetParameterValues() stub function to set the  Cusadmin user login enable as true.
...
Cusadmin user login enabling log should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_DeviceUsers_EnableCusAdminUser</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_DeviceUsers_EnableCusAdminUser');
