...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>TC_PAM_6 - To retrieve the bridge status</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_2</test_case_id>
    <test_objective>To get the bridge status</test_objective>
...
4.From python script, invoke pam_bridge_GetParamUlongValue() stub function to get the bridge status.
...
Bridge status should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_GetBridgeStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
