...
<xml>
  ...
  <name>TS_ParentalCtrl_Service_SetPortAsString</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test if invalid character strings can be set as start and end port of a managed srevice</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_142</test_case_id>
    <test_objective>Test if invalid character strings can be set as start and end port of a managed srevice</test_objective>
...
Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|ftp|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|one|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|two|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance, instance, instance, instance, instance</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_Service_SetPortAsString</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetPortAsString');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetPortAsString');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
	...
	org_status = details;
		...
		#set the rule's ports as character strings
                if (instance > 0):
                    print "INSTANCE VALUE: %s" %instance
                    tdkTestObj = obj.createTestStep("AdvancedConfig_SetMultiple");
                    tdkTestObj.addParameter("paramList","Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|ftp|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|one|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|two|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance, instance, instance, instance, instance));
