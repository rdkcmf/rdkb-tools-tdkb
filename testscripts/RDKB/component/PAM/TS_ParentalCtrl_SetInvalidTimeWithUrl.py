...
<xml>
  ...
  <name>TS_ParentalCtrl_SetInvalidTimeWithUrl</name>
  ...
  <test_cases>
    <test_case_id>TC_PAM_131</test_case_id>
    <test_objective>Check if start time can be set as greater than end time in a site blocking rule</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_SetInvalidTimeWithUrl</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidTimeWithUrl');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidTimeWithUrl');
