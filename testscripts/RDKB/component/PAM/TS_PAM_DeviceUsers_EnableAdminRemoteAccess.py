...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_PAM_DeviceUsers_EnableAdminRemoteAccess</name>
  <primitive_test_id/>
  <primitive_test_name>pam_SetParameterValues</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test case will enable the remote access capability of the admin user login</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_61</test_case_id>
    <test_objective>To enable the remote access capability of the admin user login</test_objective>
...
Input:
ParamName - Device.Users.User.3.RemoteAccessCapable</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_SetParameterValues() stub function to set the remote access capability of admin enable as true.
...
8.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
 ...
 Remote access enabling log should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_DeviceUsers_EnableAdminRemoteAccess</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_DeviceUsers_EnableAdminRemoteAccess');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("ParamName","Device.Users.User.3.RemoteAccessCapable");
	...
	if expectedresult in actualresult:
	    tdkTestObj.setResultStatus("SUCCESS");
	    print "STEP 2: Set the boolean value to true if remote access is disabled or viceversa";
