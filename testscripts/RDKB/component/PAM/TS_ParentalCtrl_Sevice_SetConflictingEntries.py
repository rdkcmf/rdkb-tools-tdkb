...
<xml>
  ...
  <name>TS_ParentalCtrl_Sevice_SetConflictingEntries</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to set conflicting port range for two managed services</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_145</test_case_id>
    <test_objective>Test to set conflicting port range for two managed services</test_objective>
...
"Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|Service1|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|9000|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|21000|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance1, instance1, instance1, instance1, instance1

Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|Service2|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|15000|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|30000|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance2, instance2, instance2, instance2, instance2</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the pamstub lib via Test agent
4.with pamstub's getparamvalue() get Device.X_Comcast_com_ParentalControl.ManagedServices.Enablestore it and set it as true
5. With AdvancedConfig_AddObject add new managed service instance
6. With AdvancedConfig_SetMultiple, set start and end ports
7. Repeat steps 5 and 6 with port range coinciding with previous rule
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_Sevice_SetConflictingEntries</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_Sevice_SetConflictingEntries');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_Sevice_SetConflictingEntries');
