...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_PAM_GetPortStatus</name>
  <primitive_test_id/>
  <primitive_test_name>pam_GetParameterValues</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_PAM_8 - To retrieve the port status</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_14</test_case_id>
    <test_objective>To get the port status</test_objective>
...
4.From python script, invoke pam_bridge_GetParamUlongValue() stub function to get the port status.
...
Port status should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_GetPortStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_GetPortStatus');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        tdkTestObj.addParameter("ParamName","Device.Bridging.Bridge.1.Port.1.Status");
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 1: Retrieve the Port Status";
            print "EXPECTED RESULT 1: Should retrieve the Port Status successfully";
            print "ACTUAL RESULT 1: Port Status: %s" %details;
