...
<xml>
  ...
  <name>TS_PAM_SetFirewallSecurityIPv6BlockFragIPPkts</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate whether iptable rules(IPv6) associated with  BlockFragIPPkt is added/removed into iptables for Enable/Disable on the BlockFragIPPkt TR181 parameter</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_195</test_case_id>
    <test_objective>To Validate whether Iptable rules(IPv6) associated with  BlockFragIPPkt is added/removed into iptables for Enable/Disable the BlockFragIPPkt TR181 parameter</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband,RPI</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state of DUT that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>N/A</api_or_interface_used>
    <input_parameters>Device.Firewall.X_RDKCENTRAL-COM_Security.V6.BlockFragIPPkt
</input_parameters>
...
7. Unload the Module</automation_approch>
    <expected_output>Iptable rules(IPv6) associated with  BlockFragIPPkt should be added/removed into iptables for Enable/Disable of BlockFragIPPkt TR181 parameter</expected_output>
    <priority>High</priority>
    <test_stub_interface>pam</test_stub_interface>
    <test_script>TS_PAM_SetFirewallSecurityIPv6BlockFragIPPkts</test_script>
    <skipped>No</skipped>
