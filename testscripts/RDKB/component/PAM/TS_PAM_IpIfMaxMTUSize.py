...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_PAM_IpIfMaxMTUSize</name>
  <primitive_test_id/>
  <primitive_test_name>pam_SetParameterValues</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test case will set the MTU size of the IP interface</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_78</test_case_id>
    <test_objective>To set the MTU size of the IP interface</test_objective>
...
Input:
ParamName - Device.IP.Interface.1.MaxMTUSize</input_parameters>
...
8.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
 ...
 The MTU size of the IP interface should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_IpIfMaxMTUSize</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_IpIfMaxMTUSize');
