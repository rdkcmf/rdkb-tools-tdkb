...
<xml>
  ...
  <name>TS_ParentalCtrl_DeleteBlockingRule</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test to delete a blocking rule</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_129</test_case_id>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_DeleteBlockingRule</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_DeleteBlockingRule');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_DeleteBlockingRule');
