...
<xml>
  ...
  <name>TS_PAM_SetSyndicationPartnerId</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set a syndication partner ID and check if it set and get are same</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_159</test_case_id>
    <test_objective>To set a syndication partner ID and check if it set and get are same</test_objective>
...
5.Unload the module</automation_approch>
    <expected_output>Set and get values should be same</expected_output>
    <priority>High</priority>
    <test_stub_interface>PAM</test_stub_interface>
    <test_script>TS_PAM_SetSyndicationPartnerId</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_SetSyndicationPartnerId');
