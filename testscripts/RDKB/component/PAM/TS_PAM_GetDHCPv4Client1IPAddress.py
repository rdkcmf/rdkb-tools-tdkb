...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_PAM_GetDHCPv4Client1IPAddress</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_31</test_case_id>
    <test_objective>To get the DHCPV4 client IP Address</test_objective>
...
Input:
ParamName - Device.DHCPv4.Client.1.IPAddress</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_GetParameterValues() stub function to get the DHCPV4 Client IP Address.
...
DHCPV4 Client IP Address should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_GetDHCPv4Client1IPAddress</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_GetDHCPv4Client1IPAddress');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("ParamName","Device.DHCPv4.Client.1.IPAddress");
