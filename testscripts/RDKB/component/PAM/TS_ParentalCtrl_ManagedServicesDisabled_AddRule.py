...
<xml>
  ...
  <name>TS_ParentalCtrl_ManagedServicesDisabled_AddRule</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To verify whether user is able to add rule when ManagedSevice is disabled</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_149</test_case_id>
    <test_objective>To verify whether user is able to add rule when ManagedServices is disabled</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_ManagedServicesDisabled_AddRule</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_ManagedServicesDisabled_AddRule');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_ManagedServicesDisabled_AddRule');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Set ManagedServices Enable status as false";
            print "EXPECTED RESULT 2: Should set the Enable status as false";
            ...
            if expectedresult in actualresult:
                ...
                tdkTestObj.setResultStatus("SUCCESS");
                print "[TEST STEP 3]: Adding new rule for service blocking";
		...
		temp = details.split(':');
                ...
                if (instance > 0):
                    ...
                    if expectedresult in actualresult:
                        tdkTestObj.setResultStatus("SUCCESS");
                        print "[TEST STEP 4]: Setting values for managed services"
                        print "[EXPECTED RESULT 4]: Should fail in setting values"
            ...
            if expectedresult in actualresult:
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP : Set ManagedService Enable status as its initial value";
                print "EXPECTED RESULT : Should set the Enable status as its initial value";
                print "ACTUAL RESULT : ManagedService Enable status set success"
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : SUCCESS";
            else:
                tdkTestObj.setResultStatus("FAILURE");
                print "TEST STEP : Set ManagedService Enable status as its initial value";
                print "EXPECTED RESULT : Should set the Enable status as its initial value";
                print "ACTUAL RESULT : ManagedService Enable status set failed";
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : FAILURE";
        else:
            tdkTestObj.setResultStatus("FAILURE");
            print "TEST STEP 2: Set ManagedService Enable status as true";
            print "EXPECTED RESULT 2: Should set the Enable status as true";
            print "ACTUAL RESULT 2: ManagedService Enable status set failed";
            print "[TEST EXECUTION RESULT] : FAILURE";
    else:
        tdkTestObj.setResultStatus("FAILURE");
        print "TEST STEP 1: Get ManagedService Enable status";
