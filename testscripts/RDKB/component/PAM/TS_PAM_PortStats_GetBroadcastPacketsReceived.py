...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>TC_PAM_29 - To retrieve the port statistic information on the number of broadcast packets received</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_15</test_case_id>
    <test_objective>To get the port statistic information on the number of broadcast packets received.</test_objective>
...
Input:
paramName - BroadcastPacketsReceived
module - PortStats</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_bridge_GetParamUlongValue() stub function to get the Port statistic information on the number of broadcast packets received
...
Port statistics information on the number of broadcast packets received should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_PortStats_GetBroadcastPacketsReceived</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
