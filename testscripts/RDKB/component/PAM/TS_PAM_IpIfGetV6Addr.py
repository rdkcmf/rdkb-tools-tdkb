...
<xml>
  ...
  <name>TS_PAM_IpIfGetV6Addr</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test will get the IPV6 address of the device</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_74</test_case_id>
    <test_objective>To get the IPV6 address</test_objective>
...
Device.IP.Interface.1.IPv6Address.1.</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4. using pam_GetParameterNames get interface and ipv6address instance values
4.From python script, invoke pam_GetParameterValues() stub function to get the IPV6 address.
...
8.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
 ...
 The IPv6 address should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_IpIfGetV6Addr</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
pamObj.configureTestCase(ip,port,'TS_PAM_IpIfGetV6Addr');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if expectedresult in actualresult:
	    ...
	    if expectedresult in actualresult:
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 1: Get IPv6address value"
                print "EXPECTED RESULT 1: Should get IPv6address value"
