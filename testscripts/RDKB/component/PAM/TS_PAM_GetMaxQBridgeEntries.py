...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_PAM_GetMaxQBridgeEntries</name>
  <primitive_test_id/>
  <primitive_test_name>pam_bridge_GetParamUlongValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_PAM_3 - To retrieve the maximum number of QBridge Entries supported</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_6</test_case_id>
    <test_objective>To get the Max Q bridge entry</test_objective>
...
Input:
paramName - MaxQBridgeEntries
module - Bridging</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_bridge_GetParamUlongValue() stub function to get the Max QBridge Entry.
...
Maximum Q bridge entry should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_GetMaxQBridgeEntries</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_GetMaxQBridgeEntries');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        tdkTestObj.addParameter("paramName","MaxQBridgeEntries");
