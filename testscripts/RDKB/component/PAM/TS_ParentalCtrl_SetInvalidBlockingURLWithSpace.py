...
<xml>
  ...
  <name>TS_ParentalCtrl_SetInvalidBlockingURLWithSpace</name>
  ...
  <test_cases>
    <test_case_id>TC_PAM_126</test_case_id>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_SetInvalidBlockingURLWithSpace</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidBlockingURLWithSpace');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidBlockingURLWithSpace');
	...
	org_status = details;
		...
		temp = details.split(':');
		    ...
		    #Setting the external port
                    ...
                    tdkTestObj.addParameter("paramList","Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.BlockMethod|URL|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.Site|www.go ogle.com|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.AlwaysBlock|true|bool" %(instance, instance, instance));
