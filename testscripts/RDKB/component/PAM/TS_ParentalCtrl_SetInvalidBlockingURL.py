...
<xml>
  ...
  <name>TS_ParentalCtrl_SetInvalidBlockingURL</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if an invalid url without http:// or https:// can be set as the url attribute of a site to be blocked</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_127</test_case_id>
    <test_objective>Check if an invalid url without http:// or https:// can be set as the url attribute of a site to be blocked</test_objective>
...
Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.BlockMethod|URL|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.Site|google.com|string|Device.X_Comcast_com_ParentalControl.ManagedSites.BlockedSite.%s.AlwaysBlock|true|bool" %(instance, instance, instance)</input_parameters>
...
5. With AdvancedConfig_SetMultiple, set mode of blocking and invalid url
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_SetInvalidBlockingURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidBlockingURL');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_SetInvalidBlockingURL');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
	...
	org_status = details;
		...
		temp = details.split(':');
		    ...
		    #Set a blocking url which doesn't start with http:// or https://
		    ...
		    expectedresult="FAILURE";
        	    ...
        	    if expectedresult in actualresult:
	                tdkTestObj.setResultStatus("SUCCESS");
                	print "[TEST STEP 4]: Setting invalid url as url to be blocked"
	                print "[EXPECTED RESULT 4]: Should fail in setting invalid url"
            	        print "[ACTUAL RESULT 4]: SUCESS: Didn't set invalid url %s" %details;
	                print "[TEST EXECUTION RESULT] : %s" %actualresult;
		        ...
		        tdkTestObj.setResultStatus("FAILURE");
                        print "[TEST STEP 4]: Setting invalid url as url to be blocked"
                        print "[EXPECTED RESULT 4]: Should fail in setting invalid url"
                        print "[ACTUAL RESULT 4]: FAILURE: Could add invalid url in rule";
                        print "[TEST EXECUTION RESULT] : %s" %actualresult;
