...
<xml>
  ...
  <name>TS_ParentalCtrl_Service_SetInvalidPort</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test if for a managed service, start port can be set as greater than end time</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_141</test_case_id>
    <test_objective>Test if invalid port number can be set as managed service attribute</test_objective>
...
"Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|ftp|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|false|bool|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartTime|02:54|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndTime|01:54|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.BlockDays|Sunday|string" %(instance, instance, instance, instance, instance, instance, instance, instance)</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the pamstub lib via Test agent
5.with pamstub's getparamvalue() get Device.X_Comcast_com_ParentalControl.ManagedServices.Enable store it and set it as true
5. With AdvancedConfig_AddObject add new mngd service instance
7. With AdvancedConfig_SetMultiple, set  invalid port
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_Service_SetInvalidPort</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetInvalidPort');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetInvalidPort');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
	...
	org_status = details;
		...
		tdkTestObj.setResultStatus("SUCCESS");
		print "[TEST STEP 3]: Adding new rule for mngd service";
		...
		#set the rule's starting port as an invalid negative value
                if (instance > 0):
                    print "INSTANCE VALUE: %s" %instance
                    tdkTestObj = obj.createTestStep("AdvancedConfig_SetMultiple");
                    tdkTestObj.addParameter("paramList","Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|ftp|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|-21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|23|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance, instance, instance, instance, instance));
		    expectedresult="FAILURE";
        	    ...
        	    if expectedresult in actualresult:
	                tdkTestObj.setResultStatus("SUCCESS");
                	print "[TEST STEP 4]: Setting invalid port for managed services"
	                print "[EXPECTED RESULT 4]: Should fail in setting invalid port"
            	        print "[ACTUAL RESULT 4]: SUCESS: Didn't set invalid port %s" %details;
	                print "[TEST EXECUTION RESULT] : %s" %actualresult;
		        ...
		        tdkTestObj.setResultStatus("FAILURE");
                        print "[TEST STEP 4]: Setting invalid port for managed services"
                        print "[EXPECTED RESULT 4]: Should fail in setting invalid port"
                        print "[ACTUAL RESULT 4]: FAILURE: Could add invalid port in rule";
                        print "[TEST EXECUTION RESULT] : %s" %actualresult;
		    ...
		    print "Table add returned invalid instance"
                ...
                #Set the result status of execution
                tdkTestObj.setResultStatus("FAILURE");
                print "[TEST STEP 3]: Adding new rule for mangd service";
                print "[EXPECTED RESULT 3]: Should add new rule";
