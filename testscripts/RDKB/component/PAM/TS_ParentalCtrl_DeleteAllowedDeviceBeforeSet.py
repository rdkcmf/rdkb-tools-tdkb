...
<xml>
  ...
  <name>TS_ParentalCtrl_DeleteAllowedDeviceBeforeSet</name>
  ...
  <test_cases>
    <test_case_id>TC_PAM_147</test_case_id>
    <test_objective>Test to delete an allowing rule</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_DeleteAllowedDeviceBeforeSet</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_DeleteAllowedDeviceBeforeSet');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_DeleteAllowedDeviceBeforeSet');
