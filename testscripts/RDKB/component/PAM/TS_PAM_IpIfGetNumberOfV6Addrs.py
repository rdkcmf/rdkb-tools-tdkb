...
<xml>
  ...
  <name>TS_PAM_IpIfGetNumberOfV6Addrs</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This will give the number of IPv6 entries in the IP interface.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_70</test_case_id>
    <test_objective>To get the number of IPv6 entries in the IP interface</test_objective>
...
Input:
ParamName - Device.IP.Interface.1.IPv6AddressNumberOfEntries</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_GetParameterValues() stub function to get the IPV6 entries.
...
8.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
 ...
 The number of IPV6 entries should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_IpIfGetNumberOfV6Addrs</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
pamObj.configureTestCase(ip,port,'TS_PAM_IpIfGetNumberOfV6Addrs');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj.addParameter("ParamName","%sIPv6AddressNumberOfEntries" %interface);
        print "Parameter Name: %sIPv6AddressNumberOfEntries" %interface
        tdkTestObj.executeTestCase(expectedresult);
        actualresult = tdkTestObj.getResult();
        ...
        if expectedresult in actualresult:
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 1: Get IPv6AddressNumberOfEntries"
            print "EXPECTED RESULT 1: Should get IPv6AddressNumberOfEntries"
