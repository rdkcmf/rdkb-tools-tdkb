...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_PAM_16</test_case_id>
    <test_objective>To get the port statistic information on the number of broadcast packets sent.</test_objective>
...
Input:
paramName - BroadcastPacketsSent
module - PortStats</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_bridge_GetParamUlongValue() stub function to get the Port statistic information on the number of broadcast packets sent.
...
Port statistics information on the number of broadcast packets sent should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_PortStats_GetBroadcastPacketsSent</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        tdkTestObj.addParameter("ParamName","Device.Bridging.Bridge.1.Port.1.Stats.BroadcastPacketsSent");
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 1: Retrieve the number of broadcast packets sent";
            print "EXPECTED RESULT 1: Should retrieve the number of broadcast packets sent";
            print "ACTUAL RESULT 1: Broadcast Packets Sent: %s" %details;
