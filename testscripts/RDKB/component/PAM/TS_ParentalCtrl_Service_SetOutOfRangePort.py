...
<xml>
  ...
  <name>TS_ParentalCtrl_Service_SetOutOfRangePort</name>
  ...
  <test_cases>
    <test_case_id>TC_PAM_143</test_case_id>
    <test_objective>Test if out of range port values can be set for a managed service</test_objective>
...
"Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|TCP|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|70000|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance, instance, instance, instance, instance)</input_parameters>
...
7. With AdvancedConfig_SetMultiple, set  invalid port range
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_Service_SetOutOfRangePort</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetOutOfRangePort');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_Service_SetOutOfRangePort');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in pamloadmodulestatus.upper():
	...
	org_status = details;
		...
		#set out of range port values as start and end port
                if (instance > 0):
                    print "INSTANCE VALUE: %s" %instance
                    tdkTestObj = obj.createTestStep("AdvancedConfig_SetMultiple");
                    tdkTestObj.addParameter("paramList","Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Description|TCP|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.Protocol|BOTH|string|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.StartPort|21|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.EndPort|70000|unsignedint|Device.X_Comcast_com_ParentalControl.ManagedServices.Service.%s.AlwaysBlock|true|bool" %(instance, instance, instance, instance, instance));
		    expectedresult="FAILURE";
        	    ...
        	    if expectedresult in actualresult:
	                tdkTestObj.setResultStatus("SUCCESS");
                	print "[TEST STEP 4]: Setting out of range port for managed services"
	                print "[EXPECTED RESULT 4]: Should fail in setting invalid port range"
            	        print "[ACTUAL RESULT 4]: SUCESS: Didn't set invalid port %s" %details;
	                print "[TEST EXECUTION RESULT] : %s" %actualresult;

		    else:
		        tdkTestObj.setResultStatus("FAILURE");
                        print "[TEST STEP 4]: Setting out of range ports for managed services"
                        print "[EXPECTED RESULT 4]: Should fail in setting invalid port range"
