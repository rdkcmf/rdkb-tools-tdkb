...
<xml>
  ...
  <name>TS_PAM_SetFirewallSecurityIPv4IPFloodDetect</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To Validate whether iptable rules(IPv4) associated with  IPFloodDetect is added/removed into iptables for Enable/Disable on IPFloodDetect TR181 parameter</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>To Validate whether Iptable rules(Ipv4) associated with  IPFloodDetect is added/removed into iptables for Enable/Disable the TR181 parameter</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband,RPI</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state of DUT that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>N/A</api_or_interface_used>
    <input_parameters>Device.Firewall.X_RDKCENTRAL-COM_Security.V4.IPFloodDetect</input_parameters>
    <automation_approch>
1. Load the PAM Module
...
7. Unload the Module</automation_approch>
    <expected_output>The iptables rules associated with IPFloodDetect should be added into iptables on Enabled and should be removed on Disabled case of IPFloodDetect TR181 parameter</expected_output>
    <priority>High</priority>
    <test_stub_interface>pam</test_stub_interface>
    <test_script>TS_PAM_SetFirewallSecurityIPv4IPFloodDetect</test_script>
    <skipped>No</skipped>
