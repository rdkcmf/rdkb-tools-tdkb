...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_PAM_SetLanSubnetMask</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_40</test_case_id>
    <test_objective>To set the LAN subnet mask</test_objective>
...
Input:
ParamName - Device.X_CISCO_COM_DeviceControl.LanManagementEntry.1.LanSubnetMask
ParamValue - 255.255.255.192
Type - String</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_SetParameterValues() stub function to set the LAN subnet mask
...
Lan subnet mask should be set and logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_SetLanSubnetMask</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_SetLanSubnetMask');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("ParamValue","255.0.0.0");
