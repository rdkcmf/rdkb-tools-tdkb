...
<xml>
  ...
  <name>TS_PAM_GetCompressionProtocol</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This testcase checks if  CompressionProtocol is a subset of None, Van Jacobson, STAC LZS</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_98</test_case_id>
    <test_objective>To  check if Compression Protocol is a subset of None, Van Jacobson, STAC LZS</test_objective>
...
Input:
ParamName -
Device.PPP.Interface.1.CompressionProtocol</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_GetParameterValues() stub function to get the Compression Protocol.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_GetCompressionProtocol</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_GetCompressionProtocol');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("ParamName","Device.PPP.Interface.1.CompressionProtocol");
