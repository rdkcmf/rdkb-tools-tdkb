...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>TC_PAM_1 - To retrieve the maximum number of Bridge Entries supported</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_3</test_case_id>
    <test_objective>To get the max bridge entry</test_objective>
...
Input:
paramName - MaxBridgeEntries
module - Bridging</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_bridge_GetParamUlongValue() stub function to get the Max Bridge Entry.
...
Maximum bridge entry should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_GetMaxBridgeEntries</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_GetMaxBridgeEntries');
...
if "SUCCESS" in loadmodulestatus.upper():
        ...
        tdkTestObj.addParameter("paramName","MaxBridgeEntries");
