...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_PAM_EnableRFC_DLCaStoreEnable</name>
  <primitive_test_id/>
  <primitive_test_name>pam_GetParameterNames</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To  Enable  the RFC  DLCA Store Enable and check if the set logging is present is PAMLog.txt.o</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_208</test_case_id>
    <test_objective>To  Enable  the RFC  DLCA Store Enable and check if the set logging is present is PAMLog.txt.0</test_objective>
...
3.Enable the RFC  DLCA Store Enable status
...
7.Unload the module</automation_approch>
    <expected_output>Enabling DLCA RFC should be successful and the same logging should take place in PAMLog.txt.0</expected_output>
    <priority>High</priority>
    <test_stub_interface>PAM</test_stub_interface>
    <test_script>TS_PAM_EnableRFC_DLCaStoreEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
pamobj.configureTestCase(ip,port,'TS_PAM_EnableRFC_DLCaStoreEnable');
sysobj.configureTestCase(ip,port,'TS_PAM_EnableRFC_DLCaStoreEnable');
