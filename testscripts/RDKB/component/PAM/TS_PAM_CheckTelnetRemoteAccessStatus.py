...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_PAM_CheckTelnetRemoteAccessStatus</name>
  <primitive_test_id/>
  <primitive_test_name>pam_GetParameterValues</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This testcase check if remote access via Telnet is enabled or not</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_PAM_94</test_case_id>
    <test_objective>To check if remote access via Telnet is enabled or not</test_objective>
...
Input:
ParamName -
Device.UserInterface.X_CISCO_COM_RemoteAccess.TelnetEnable</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page.
3.TM will load the PAM library via Test agent
4.From python script, invoke pam_GetParameterValues() stub function to get the details of remote access via Telnet.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_PAM_CheckTelnetRemoteAccessStatus</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_CheckTelnetRemoteAccessStatus');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("ParamName","Device.UserInterface.X_CISCO_COM_RemoteAccess.TelnetEnable");
