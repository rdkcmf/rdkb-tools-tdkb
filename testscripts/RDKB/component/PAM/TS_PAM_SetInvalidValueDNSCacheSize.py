...
<xml>
  ...
  <name>TS_PAM_SetInvalidValueDNSCacheSize</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set  a Invalid value to  Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.RabidFramework.DNSCacheSize  and verify</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_184</test_case_id>
    <test_objective>This test case will check whether an invalid positive and negative  value can be set as DNS Cache size </test_objective>
...
5.Generate a random number between 32768- 40000 which is the invalid range
6.Set the invalid positive  value as DNS cache size and the parameter should not set the value successfully.
7.Set the invalid negative value as DNS cache size and the parameter should not set the value successfully.
...
9.unload the loaded modules
    ...
    <expected_output>The invalid positive and negative  value should not be set as  DNS Cache Size</expected_output>
    <priority>High</priority>
    <test_stub_interface>PAM</test_stub_interface>
    <test_script>TS_PAM_SetInvalidValueDNSCacheSize</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_PAM_SetInvalidValueDNSCacheSize');
