...
<xml>
  ...
  <name>TS_ParentalCtrl_DuplicateBlockDevices</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the Duplicate entry of the blocked devices table</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_PAM_139</test_case_id>
...
Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.Description|Xfinity|string|Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.MACAddress|BC:30:5B:BF:98:23|string|Device.X_Comcast_com_ParentalControl.ManagedDevices.Device.%s.AlwaysBlock|true|bool" %(instance2, instance2, instance2</input_parameters>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_ParentalCtrl_DuplicateBlockDevices</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ParentalCtrl_DuplicateBlockedDevices');
pamObj.configureTestCase(ip,port,'TS_ParentalCtrl_DuplicateBlockedDevices');
                        ...
                        if (instance1 > 0):
                            ...
                            if expectedresult in actualresult:
                                ...
                                if expectedresult in actualresult:
                                    #Set the result status of execution
                                    tdkTestObj.setResultStatus("SUCCESS");
                                    print "[TEST STEP 7]: Adding new rule for device blocking";
                                    ...
                                    if (instance2 > 0):
                                        ...
                                        if expectedresult in actualresult:
                                            tdkTestObj.setResultStatus("SUCCESS");
                                            print "[TEST STEP 8]: Setting duplicate device as device to be blocked"
