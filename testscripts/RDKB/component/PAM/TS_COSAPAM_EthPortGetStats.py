...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_COSAPAM_EthPortGetStats</name>
  <primitive_test_id/>
  <primitive_test_name>COSAPAM_DmlEthGetParamValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test case is to get the ethernet port stats</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>to get the ethernet port stats</test_objective>
...
4.From python script, invoke COSAPAM_DmlEthGetParamValue() stub function with parameter GetStats to get stats details .
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_COSAPAM_EthPortGetStats</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_COSAPAM_EthPortGetStats');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("MethodName","GetStats");
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1: Get the EthPortStats";
        print "EXPECTED RESULT 1: Should get the EthPortStats";
        print "ACTUAL RESULT 1: EthPortStats is %s" %details;
        #Get the result of execution
        print "[TEST EXECUTION RESULT] : SUCCESS";
    else:
        tdkTestObj.setResultStatus("FAILURE");
        print "TEST STEP 1: Get the EthPortStats";
        print "EXPECTED RESULT 1: Failure in getting the EthPortStats";
        print "ACTUAL RESULT 1: EthPortStats is %s" %details;
