...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WANMANAGER_DSLWANoE_FixedModeOnBootUp_ActLink_P_1-1_WAN_Pri-Sec</name>
  <primitive_test_id/>
  <primitive_test_name>wanmanager_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if DSL line is active with FIXED_MODE_ON_BOOTUP policy ,WAN Type and priorities being (1,1) (Primary,Secondary) for DSL and WANOE respectively</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WANMANAGER_86</test_case_id>
    <test_objective>This test case is to check if DSL line is active with FIXED_MODE_ON_BOOTUP policy ,WAN Type and priorities being (1,1) (Primary,Secondary) for DSL and WANOE respectively</test_objective>
...
6.Set the  Wan Type and priorities as(1,1) (Primary,Secondary) for DSL and WANOE respectively and reboot the device for changes to reflect
...
10.Unload the Module</automation_approch>
    ...
    <test_script>TS_WANMANAGER_DSLWANoE_FixedModeOnBootUp_ActLink_P_1-1_WAN_Pri-Sec</test_script>
    <skipped>No</skipped>
