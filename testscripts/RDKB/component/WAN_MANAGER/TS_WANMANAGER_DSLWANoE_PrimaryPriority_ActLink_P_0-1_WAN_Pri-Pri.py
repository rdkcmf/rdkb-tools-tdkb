...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WANMANAGER_DSLWANoE_PrimaryPriority_ActLink_P_0-1_WAN_Pri-Pri</name>
  <primitive_test_id/>
  <primitive_test_name>wanmanager_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>>To check if  DSL  line is active with PRIMARY_PRIORITY policy,Wan priorities and Type being (0,1) (Primary,Primary)  for DSL and WANOE respectively</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WANMANAGER_96</test_case_id>
    <test_objective>To check if  DSL  line is active with PRIMARY_PRIORITY policy,Wan priorities and Type being (0,1) (Primary,Primary)  for DSL and WANOE respectively</test_objective>
...
6.Set the  Wan Type and priorities as 0,1) (Primary,Primary)for DSL and WANOE respectively
...
10.Unload the module</automation_approch>
    <expected_output>With Primary Priority policy Wan Type and priorities being (0,1) (Primary,Primary)   for DSL and WANOE respectively - DSL Line is expected to be active</expected_output>
    <priority>High</priority>
    <test_stub_interface>WAN_MANAGER</test_stub_interface>
    <test_script>TS_WANMANAGER_DSLWANoE_PrimaryPriority_ActLink_P_0-1_WAN_Pri-Pri</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_WANMANAGER_DSLWANoE_PrimaryPriority_ActLink_P_0-1_WAN_Pri-Pri');
obj1.configureTestCase(ip,port,'TS_WANMANAGER_DSLWANoE_PrimaryPriority_ActLink_P_0-1_WAN_Pri-Pri');
