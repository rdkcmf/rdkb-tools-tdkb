...
<xml>
  ...
  <name>TS_WANMANAGER_SetWanManagerPolicy_PrimaryPriority</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set Device.X_RDK_WanManager.Policy to PRIMARY_PRIORITY and check if the required logs are found in WANMANAGERlog.txt on bootup.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WANMANAGER_10</test_case_id>
    <test_objective>To set Device.X_RDK_WanManager.Policy to PRIMARY_PRIORITY and check if the required logs are found in WANMANAGERlog.txt on bootup.</test_objective>
...
Sysutil_Stub</api_or_interface_used>
    <input_parameters>Device.X_RDK_WanManager.Policy : PRIMARY_PRIORITY</input_parameters>
...
6. Unload the module</automation_approch>
    <expected_output>Setting Device.X_RDK_WanManager.Policy to PRIMARY_PRIORITY should be success and the required logs are found in WANMANAGERlog.txt on bootup.</expected_output>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WANMANAGER_SetWanManagerPolicy_PrimaryPriority');
obj1.configureTestCase(ip,port,'TS_WANMANAGER_SetWanManagerPolicy_PrimaryPriority');
        ...
        if status == 0:
            ...
            if status == 0:
                if policy == new_policy:
                    ...
                    log = "Primary Priority Policy Thread Starting"
                    result = [];
