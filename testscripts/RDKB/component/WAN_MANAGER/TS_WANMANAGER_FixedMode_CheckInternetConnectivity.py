...
<xml>
  ...
  <name>TS_WANMANAGER_FixedMode_CheckInternetConnectivity</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Set the WAN Manager Policy to Fixed Mode and check the internet connectivity.</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WANMANAGER_23</test_case_id>
    <test_objective>To set the WAN Manager Policy to Fixed Mode and check the internet connectivity</test_objective>
...
6.Unload the module</automation_approch>
    <expected_output>Setting Device.X_RDK_WanManager.Policy to FIXED_MODE should be success and internet should be available</expected_output>
    <priority>High</priority>
    <test_stub_interface>WAN MANAGER</test_stub_interface>
    <test_script>TS_WANMANAGER_FixedMode_CheckInternetConnectivity</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_WANMANAGER_FixedMode_CheckInternetConnectivity');
obj1.configureTestCase(ip,port,'TS_WANMANAGER_FixedMode_CheckInternetConnectivity');
