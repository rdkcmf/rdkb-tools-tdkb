...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_CMHAL_US_OFDM_GetNumberOfFirstActiveSubcarrier</name>
  <primitive_test_id/>
  <primitive_test_name>CMHAL_GetUsOfdmChanTable</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the number of the first non-excluded subcarrier. The valid range is 74 to 3947</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_CMHAL_69</test_case_id>
    <test_objective>Get the number of the first non-excluded subcarrier. The valid range is 74 to 3947</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>paramName : "US_OFDM_FirstActiveSubcarrierNum"</input_parameters>
    <automation_approch>1. Load  cmhal module
2. Invoke docsis_GetUsOfdmaChanTable to get the number of first active subcarriers
3. Validate the value
4. Unload cmhal module</automation_approch>
    <except_output>The number of first active subcarriers must be in range of  74 to 3947</except_output>
    <priority>High</priority>
    <test_stub_interface>CMHAL</test_stub_interface>
    <test_script>TS_CMHAL_US_OFDM_GetNumberOfFirstActiveSubcarrier</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMHAL_US_OFDM_GetNumberOfFirstActiveSubcarrier');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","US_OFDM_FirstActiveSubcarrierNum");
	...
	tdkTestObj.setResultStatus("FAILURE");
	print "Failed to get the value of FirstActiveSubcarrier"
