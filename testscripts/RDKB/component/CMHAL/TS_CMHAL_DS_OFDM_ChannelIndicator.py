...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_CMHAL_DS_OFDM_ChannelIndicator</name>
  <primitive_test_id/>
  <primitive_test_name>CMHAL_GetParamUlongValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the channel Indicator which is a datatype that defines the subcarrier spacing for the FFT mode in use. The spacing must be a subset of [other(1), primary(2), backupPrimary(3), nonPrimary(4)].</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_CMHAL_59</test_case_id>
    <test_objective>Get the channel Indicator which is a datatype that defines the subcarrier spacing for the FFT mode in use. The spacing must be a subset of [other(1), primary(2), backupPrimary(3), nonPrimary(4)].</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state of DUT that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>docsis_GetDsOfdmChanTable
...
4. Unload cmhal module</automation_approch>
    ...
    <test_script>TS_CMHAL_DS_OFDM_ChannelIndicator</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMHAL_DS_OFDM_ChannelIndicator');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","DS_OFDM_ChannelIndicator");
	...
	if int(NoOfEntries) > 0:
	    minValue = 1;
            ...
            if minValue <= int(ChanIndicator) <= maxValue:
                ChanIndValue = expectedList[ChanIndicator];
