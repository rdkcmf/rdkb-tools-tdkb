...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_CMHAL_US_OFDM_GetChannelID</name>
  <primitive_test_id/>
  <primitive_test_name>CMHAL_GetParamCharValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the Channel ID of OFDM upstream channel. If the upstream channel ID is unknown, this object returns a value of 0.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_CMHAL_66</test_case_id>
    <test_objective>Get the Channel ID of OFDM upstream channel. If the upstream channel ID is unknown, this object returns a value of 0.</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>paramName : "US_OFDM_ChannelId"</input_parameters>
    <automation_approch>1. Load  cmhal module
2. Invoke docsis_GetUsOfdmaChanTable to get the channel ID
...
4. Unload cmhal module</automation_approch>
    ...
    <test_script>TS_CMHAL_US_OFDM_GetChannelID</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMHAL_US_OFDM_GetChannelID');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","US_OFDM_ChannelId");
