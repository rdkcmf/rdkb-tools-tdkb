...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_CMHAL_GetCPEList_NullBuffer</name>
  <primitive_test_id/>
  <primitive_test_name>CMHAL_GetCPEList</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if the call to cm_hal_GetCPEList fails with a null buffer</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_CMHAL_97</test_case_id>
    <test_objective>This test case is to check if the call to cm_hal_GetCPEList fails with a null buffer</test_objective>
...
4. Unload cmhal module</automation_approch>
    ...
    <test_script>TS_CMHAL_GetCPEList_NullBuffer</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMHAL_GetCPEList_NullBuffer');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult :
        ...
        print "TEST STEP 1: Get the GetCPEList with null buffer";
        print "EXPECTED RESULT 1: Should not get the GetCPEList with null buffer";
