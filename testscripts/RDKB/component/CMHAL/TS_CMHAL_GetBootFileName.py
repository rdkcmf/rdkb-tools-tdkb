...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_CMHAL_GetBootFileName</name>
  <primitive_test_id/>
  <primitive_test_name>CMHAL_GetParamCharValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check whether the Boot FileName is getting updated properly</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_CMHAL_02</test_case_id>
    <test_objective>To check whether the Boot File Name is getting updated properly</test_objective>
...
5.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from TAD stub.</automation_approch>
    <except_output>BootFileName should be retrieved successfully</except_output>
    <priority>High</priority>
    <test_stub_interface>CosaCM</test_stub_interface>
    <test_script>TS_CMHAL_GetBootFileName</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
