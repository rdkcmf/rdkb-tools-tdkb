...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_CMHAL_DS_OFDM_GetSubcarrierSpacing</name>
  <primitive_test_id/>
  <primitive_test_name>CMHAL_GetDsOfdmChanTable</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get the SubcarrierSpacing of OFDM downstream channel. It must be a subset of [50Khz,25Khz].</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_CMHAL_64</test_case_id>
    <test_objective>Get the SubcarrierSpacing of OFDM downstream channel. It must be a subset of [50Khz,25Khz].</test_objective>
    <test_type>Positive</test_type>
    <test_setup>Broadband</test_setup>
    <pre_requisite>1.Ccsp Components  should be in a running state of DUT that includes component under test Cable Modem
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>docsis_GetDsOfdmChanTable</api_or_interface_used>
    <input_parameters>paramName :  "DS_OFDM_SubcarrierSpacing"</input_parameters>
    <automation_approch>1. Load  cmhal module
2. Invoke docsis_GetDsOfdmChanTable to get the number of subcarrier spacing
...
4. Unload cmhal module</automation_approch>
    ...
    <test_script>TS_CMHAL_DS_OFDM_GetSubcarrierSpacing</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_CMHAL_DS_OFDM_GetSubcarrierSpacing');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","DS_OFDM_SubcarrierSpacing");
