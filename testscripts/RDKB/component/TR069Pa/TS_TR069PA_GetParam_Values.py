...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>9</version>
  <name>TS_TR069PA_GetParam_Values</name>
  <primitive_test_id/>
  <primitive_test_name>TR069Agent_GetParameterValues</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>TC_TR069_1 - To Validate Get Param Values API for TR069 PA</synopsis>
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_TR069PA_GetParam_Values</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TR069PA_GetParam_Values');
