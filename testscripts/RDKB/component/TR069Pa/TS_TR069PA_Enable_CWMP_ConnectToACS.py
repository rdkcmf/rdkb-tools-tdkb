...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_TR069PA_Enable_CWMP_ConnectToACS</name>
  <primitive_test_id/>
  <primitive_test_name>TR069Agent_SetParameterValues</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check connectivity of CPE and ACS after enabling CWMP</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TR069_7</test_case_id>
    <test_objective>Check connectivity of CPE and ACS after enabling CWMP</test_objective>
...
3. Set the value of Device.ManagementServer.EnableCWMP as true
4. Try to do a get operation in gateway using the TR069 ACS server
5. Check if connection between ACS server and gateway is success or not
6. Revert the value of Device.ManagementServer.EnableCWMP
7. unload tdkbtr181 module</automation_approch>
    <except_output>Connection between ACS server and gateway should be success when Device.ManagementServer.EnableCWMP is true </except_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TS_TR069PA_Enable_CWMP_ConnectToACS</test_script>
    <skipped>No</skipped>
