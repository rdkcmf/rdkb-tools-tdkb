        ...
        if expectedresult in lineCountResult:
            ...
            if expectedresult in (ssid1_res and ssid2_res):
                ...
                if str(ssid1_name) != str(ssid2_name):
                    ...
                    set_result1,set_details1, tdkTestObj = setSSIDNames(tdkTestObj_Tr181_set,"Device.WiFi.SSID.1.SSID","Tel_24_WiFi");
                    set_result2,set_details2, tdkTestObj1 = setSSIDNames(tdkTestObj_Tr181_set,"Device.WiFi.SSID.2.SSID","Tel_5_WiFi");
