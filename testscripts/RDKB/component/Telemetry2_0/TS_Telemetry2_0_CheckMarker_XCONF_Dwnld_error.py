...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_Telemetry2_0_CheckMarker_XCONF_Dwnld_error</name>
  <primitive_test_id/>
  <primitive_test_name>Telemetry_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To simulate  XCONF_Dwnld_error  by giving a bad image name and triggering xconf http download</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_TELEMETRY2_0_49</test_case_id>
    <test_objective>This test case is to simulate  XCONF_Dwnld_error  by giving a bad image name and triggering xconf http download</test_objective>
...
6. Check if marker XCONF_Dwnld_error  is present in  telemetry log file (only between the initial line count and line count after simulation)
...
9. Unload the modules</automation_approch>
    ...
    <test_script>TS_Telemetry2_0_CheckMarker_XCONF_Dwnld_error</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_Telemetry2_0_CheckMarker_XCONF_Dwnld_error');
tr181obj.configureTestCase(ip,port,'TS_Telemetry2_0_CheckMarker_XCONF_Dwnld_error');
