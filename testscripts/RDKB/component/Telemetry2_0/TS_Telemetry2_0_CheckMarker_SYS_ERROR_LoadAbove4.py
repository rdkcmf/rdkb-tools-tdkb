...
<xml>
  ...
  <name>TS_Telemetry2_0_CheckMarker_SYS_ERROR_LoadAbove4</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To simulate SYS_ERROR_LoadAbove4 telemetry2_0 marker by loading CPU Load value more than 4</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_TELEMETRY2_0_30</test_case_id>
    <test_objective>To simulate SYS_ERROR_LoadAbove4 telemetry2_0 marker by loading CPU Load value more than 4
</test_objective>
...
5. If the CPULoad value hits 4, then execute the script log_mem_cpu_info.sh from TAD module
...
8. Check if marker SYS_ERROR_LoadAbove4 is present in telemetry log file (only between the initial line count and line count after simulation)
...
12. Unload the modules</automation_approch>
    ...
    <test_script>TS_Telemetry2_0_CheckMarker_SYS_ERROR_LoadAbove4</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_Telemetry2_0_CheckMarker_SYS_ERROR_LoadAbove4');
tr181obj.configureTestCase(ip,port,'TS_Telemetry2_0_CheckMarker_SYS_ERROR_LoadAbove4');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() :
    ...
    if preReq_Status == 1:
        ...
        if expectedresult in lineCountResult:
            ...
            print "EXPECTED RESULT 3: CPULOAD average should be increased to value 4";
            ...
            for loop in range (1,24):
                ...
                if int(cpuload) == 4:
                    cpuloadabove4 = 1;
                    tdkTestObj_Sys_ExeCmd.setResultStatus("SUCCESS");
                    print "EXPECTED RESULT 3: CPULOAD average Increased to value 4";
                    print "[TEST EXECUTION RESULT] : SUCCESS";
                    break;
                elif int(cpuload) > 4:
                    print "EXPECTED RESULT 3: CPULOAD average value was more than 4";
            ...
            if cpuloadabove4 == 1:
                ...
                if expectedresult in actualresult:
                    ...
                    if expectedresult in actualresult:
                        ...
                        if expectedresult in lineCountResult and  int(lineCountAfterSimu) > int(initialLinesCount):
                            ...
                            query = "sed -n -e %s,%sp /rdklogs/logs/telemetry2_0.txt.0 | grep -i \"Received eventInfo : SYS_ERROR_LoadAbove4\"" %(initialLinesCount,lineCountAfterSimu)
                            print "query:%s" %query
                            ...
                            if expectedresult in actualresult and details!="" and (len(details) > 0) and "SYS_ERROR_LoadAbove4" in details:
                                tdkTestObj_Sys_ExeCmd.setResultStatus("SUCCESS");
                                markervalue = details.split("SYS_ERROR_LoadAbove4 value : ")[1]
                                print "TEST STEP 7: SYS_ERROR_LoadAbove4  Marker should be present";1
                                print "EXPECTED RESULT 7: SYS_ERROR_LoadAbove4 Marker should be present";
                                print "ACTUAL RESULT 7: SYS_ERROR_LoadAbove4  Marker Value is %s" %markervalue;
                                #Get the result of execution
                                print "[TEST EXECUTION RESULT] : SUCCESS";
                            else:
                                tdkTestObj_Sys_ExeCmd.setResultStatus("FAILURE");
                                print "TEST STEP 7: SYS_ERROR_LoadAbove4  Marker should be present";
                                print "EXPECTED RESULT 7: SYS_ERROR_LoadAbove4 Marker should be present";
                                print "ACTUAL RESULT 7: SYS_ERROR_LoadAbove4  Marker is %s" %details;
                                #Get the result of execution
                                print "[TEST EXECUTION RESULT] : FAILURE";
                        else:
                            tdkTestObj_Sys_ExeCmd.setResultStatus("FAILURE");
                ...
                print "CPULOAD average value is not 4, Exiting Script"
                tdkTestObj_Sys_ExeCmd.setResultStatus("FAILURE");
        else:
            tdkTestObj_Sys_ExeCmd.setResultStatus("FAILURE");
            print "TEST STEP 2: Get the initial Line count of Telemetry Log file";
