...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ETHWAN_CheckPHYRate</name>
  <primitive_test_id/>
...
4. Unload module</automation_approch>
    ...
    <test_script>TS_ETHWAN_CheckPHYRate</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ETHWAN_CheckPHYRate');
obj1.configureTestCase(ip,port,'TS_ETHWAN_CheckPHYRate');
