...
<xml>
  ...
  <name>TS_ETHWAN_CheckTR069Support</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if device has TR069  support in EthWAN mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ETHWAN_15</test_case_id>
    <test_objective>To check if device has TR069 support in ETHWAN mode</test_objective>
...
3. If ethwan is enabled,Get and save the value of Device.ManagementServer.Username using ACS server
4. Unload module</automation_approch>
    <expected_output>Device.ManagementServer.Username should be retrieved through TR069 in ETHWAN mode</expected_output>
    <priority>High</priority>
    <test_stub_interface>ETHWAN</test_stub_interface>
    <test_script>TS_ETHWAN_CheckTR069Support</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ETHWAN_CheckTR069Support');
