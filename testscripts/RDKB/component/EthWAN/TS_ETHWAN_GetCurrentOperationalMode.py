...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ETHWAN_GetCurrentOperationalMode</name>
  <primitive_test_id/>
  <primitive_test_name>EthWAN_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>In ethwan mode, Device.DeviceInfo.X_RDKCENTRAL-COM_EthernetWAN.CurrentOperationalMode should return Ethernet else docsis</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_ETHWAN_02</test_case_id>
    <test_objective>In ethwan mode, Device.DeviceInfo.X_RDKCENTRAL-COM_EthernetWAN.CurrentOperationalMode should return Ethernet else docsis</test_objective>
...
Device.DeviceInfo.X_RDKCENTRAL-COM_EthernetWAN.CurrentOperationalMode</input_parameters>
    <automation_approch>1. Load module
2. Get the ethwan mode and check if it true or not
3. Get the current operating mode and validate
4. Unload module</automation_approch>
    <except_output>If ethwan mode is enabled, the current operating mode should be Ethernet. If it is disabled, the mode should be Docsis</except_output>
    <priority>High</priority>
    <test_stub_interface>ETHWAN</test_stub_interface>
    <test_script>TS_ETHWAN_GetCurrentOperationalMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ETHWAN_GetCurrentOperationalMode');
