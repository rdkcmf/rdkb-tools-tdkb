...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To get the value of ACS URL in ManagementServer in ETHWAN mode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ETHWAN_12</test_case_id>
    <test_objective>To get the value of ACS URL in ManagementServer in ETHWAN mode</test_objective>
...
Device.ManagementServer.URL</input_parameters>
    <automation_approch>1. Load module
2. Get the ethwan mode and check if it is true or not
3. If ethwan is enabled, check whether ACS URL in ManagementServer is not empty
4. Unload module</automation_approch>
    <expected_output>Should not get ACS URL in ManagementServer as empty</expected_output>
    <priority>High</priority>
    <test_stub_interface>ETHWAN</test_stub_interface>
    <test_script>TS_ETHWAN_GetACSURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ETHWAN_GetACSURL');
    ...
    if expectedresult in actualresult:
        ...
        if "true" == ethwanEnable:
            ...
            if expectedresult in actualresult and details != "":
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 2: Get the value of Device Management URL";
                print "EXPECTED RESULT 2: Should not get value of Device Management URL as empty";
                print "ACTUAL RESULT 2: ACS URL is %s" %details;
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : SUCCESS";
            else:
                #Set the result status of execution
                ...
                print "TEST STEP 2: Get the value of Device Management URL";
                print "EXPECTED RESULT 2: Should not get value of Device Management URL as empty";
                print "ACTUAL RESULT 2: Failed to get ACS URL";
                #Get the result of execution
