...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_LOGAGENT_PAM_DisableLog</name>
  <primitive_test_id/>
  <primitive_test_name>LogAgent_DoNothing</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Disable logging of PAM module and check if the logs are getting updated in PAMlog.txt.0</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_LOGAGENT_2</test_case_id>
    <test_objective>Disable logging of PAM module and check if the logs are getting updated in PAMlog.txt.0</test_objective>
...
3. Set false to PAM log enable status
...
8. Unload module</automation_approch>
    <except_output>The logs should not get updated in PAMlog.txt.0</except_output>
    <priority>High</priority>
    <test_stub_interface>LOG_AGENT</test_stub_interface>
    <test_script>TS_LOGAGENT_PAM_DisableLog</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_LOGAGENT_PAM_DisableLog');
sysobj.configureTestCase(ip,port,'TS_LOGAGENT_PAM_DisableLog');
