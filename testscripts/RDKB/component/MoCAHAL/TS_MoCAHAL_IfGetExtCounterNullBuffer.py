...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_MoCAHAL_IfGetExtCounterNullBuffer</name>
  <primitive_test_id/>
  <primitive_test_name>MoCAHAL_IfGetExtCounter</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test the HAL api moca_IfGetExtCounter() by passing a null buffer</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_MoCAHAL_28</test_case_id>
    <test_objective>Test the HAL api moca_IfGetExtCounter() by passing a null buffer</test_objective>
...
4. UnLoad mocahal module</automation_approch>
    ...
    <test_script>TS_MoCAHAL_IfGetExtCounterNullBuffer</test_script>
    <skipped>No</skipped>
