...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_MoCAHAL_IfGetStaticInfoNullBuffer</name>
  <primitive_test_id/>
  <primitive_test_name>MoCAHAL_IfGetStaticInfo</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test the HAL api moca_IfGetStaticInfo() by passing a null buffer</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_MoCAHAL_26</test_case_id>
    <test_objective>Test the HAL api moca_IfGetStaticInfo() by passing a null buffer</test_objective>
...
2. Invoke the HAL api moca_IfGetStaticInfo() by passing a null buffer
...
4. UnLoad mocahal module</automation_approch>
    <expected_output>Call to moca_IfGetStaticInfo() should fail</expected_output>
    <priority>High</priority>
    <test_stub_interface>mocahal</test_stub_interface>
    <test_script>TS_MoCAHAL_IfGetStaticInfoNullBuffer</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_MoCAHAL_IfGetStaticInfoNullBuffer');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1: Get the Static Information from the Local Node  by passing null buffer"
        print "EXPECTED RESULT 1: Should not get the static Information from the Local Node  by passing null buffer";
