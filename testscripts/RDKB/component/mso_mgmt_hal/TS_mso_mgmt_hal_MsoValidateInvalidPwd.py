...
<xml>
  ...
  <name>TS_mso_mgmt_hal_MsoValidateInvalidPwd</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To validate the invalid password using mso_validatepwd()</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_mso_mgmt_hal_4</test_case_id>
    <test_objective>To validate the invalid password using mso_validatepwd()</test_objective>
...
2.Pass the invalid password to mso_validatepwd()
...
5.Unload mso_mgmt_hal module</automation_approch>
    ...
    <test_script>TS_mso_mgmt_hal_MsoValidateInvalidPwd</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_mso_mgmt_hal_MsoValidateInvalidPwd');
sysobj.configureTestCase(ip,port,'TS_mso_mgmt_hal_MsoValidateInvalidPwd');
