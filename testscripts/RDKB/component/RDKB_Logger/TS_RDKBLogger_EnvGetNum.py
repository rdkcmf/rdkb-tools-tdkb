...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_RDKBLogger_EnvGetNum</name>
  <primitive_test_id/>
  <primitive_test_name>RDKBLogger_EnvGetNum</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This tests the getting of number from module.
Test Case ID: CT_RDKBLogger_05
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_5</test_case_id>
    <test_objective>This tests the getting of number from module.</test_objective>
...
API Name
RDKBLogger_EnvGetNum

Input:
module = "WIFI"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_EnvGetNum() stub function to get the number from the module.
5.RDKLogger stub function will call the rdk_logger_envGetNum() function of the rdk-logger component in ccsp.
...
The number associated with the module specified should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_EnvGetNum</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_EnvGetNum');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj = obj.createTestStep('RDKBLogger_EnvGetNum');
