...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_RDKBLogger_Dbg_Enabled_Status</name>
  <primitive_test_id/>
  <primitive_test_name>RDKBLogger_Dbg_Enabled_Status</primitive_test_name>
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_2</test_case_id>
    <test_objective>To check the debug enabled status functionality of RDK Logger.</test_objective>
...
4.From python script, invoke RDKBLogger_Dbg_Enabled_Status() stub function to get the value of EnableDbg.
5.RDKLogger stub function will call the rdk_dbg_enabled() function of the rdk-logger component in ccsp.
...
Debug enabled status should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Dbg_Enabled_Status</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Dbg_Enabled_Status');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj = obj.createTestStep('RDKBLogger_Dbg_Enabled_Status');
