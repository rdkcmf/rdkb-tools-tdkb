...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1434</id>
  <version>2</version>
  <name>TS_RDKBLogger_Log_None_All</name>
  <primitive_test_id/>
  <primitive_test_name>RDKBLogger_Log_All</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To log 5 different messages of INFO, NOTICE, WARNING, ERROR, FATAL levels with NONE ALL threshold.
Test Case ID: CT_RDKBLogger_27
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_23</test_case_id>
    <test_objective>To log 5 different messages of INFO, NOTICE, WARNING, ERROR, FATAL levels with NONE ALL threshold.</test_objective>
...
Input:
module = "TEST2"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_Log_All() stub function to log 5 different messages of INFO, NOTICE, WARNING, ERROR, FATAL levels with NONE ALL threshold.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_None_All</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_None_All');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj = obj.createTestStep('RDKBLogger_Log_All');
