...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_29</test_case_id>
...
module = "TEST4"
level = "TRACE4"
msg = "Test Trace4 message"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_Log_Msg() stub function to log a TRACE4 level message.
...
Trace4 level message should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_Trace4</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_Trace4');
