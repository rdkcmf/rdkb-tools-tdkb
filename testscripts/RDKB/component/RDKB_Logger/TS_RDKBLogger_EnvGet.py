...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_3</test_case_id>
    <test_objective>To get the logging level value of the specified module name in debug.ini</test_objective>
...
4.From python script, invoke RDKBLogger_EnvGet() stub function to get the logging level value of the module in debug.ini
...
Logging level value of the specified module should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_EnvGet</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_EnvGet');
