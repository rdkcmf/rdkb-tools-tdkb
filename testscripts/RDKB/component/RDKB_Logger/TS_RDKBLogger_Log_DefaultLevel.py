...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_RDKBLogger_Log_DefaultLevel</name>
  <primitive_test_id/>
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_14</test_case_id>
    <test_objective>To add a log message for a module with empty log level confguration.</test_objective>
...
4.From python script, invoke RDKBLogger_Log() stub function to add a log message for a module with empty log level confguration.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_DefaultLevel</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_DefaultLevel');
