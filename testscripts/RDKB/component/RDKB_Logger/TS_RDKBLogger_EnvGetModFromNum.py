...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_RDKBLogger_EnvGetModFromNum</name>
  <primitive_test_id/>
  <primitive_test_name>RDKBLogger_EnvGetModFromNum</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>This tests the get module from number functionality of rdk logger.
Test Case ID: CT_RDKBLogger_07
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_4</test_case_id>
    <test_objective>To get the module name based on the entry number in debug.ini.</test_objective>
...
4.From python script, invoke RDKBLogger_EnvGetModFromNum() stub function to get the module name based on the entry number in debug.ini
5.RDKLogger stub function will call the rdk_logger_envGetModFromNum() function of the rdk-logger component in ccsp.
...
Module name based on the entry number should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_EnvGetModFromNum</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_EnvGetModFromNum');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj = obj.createTestStep('RDKBLogger_EnvGetModFromNum');
