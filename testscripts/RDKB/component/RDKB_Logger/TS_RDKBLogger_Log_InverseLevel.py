...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1360</id>
  <version>2</version>
  <name>TS_RDKBLogger_Log_InverseLevel</name>
  <primitive_test_id/>
...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_19</test_case_id>
    <test_objective>To add a log message from TEST module with a particular log level disabled in debug.ini file.</test_objective>
...
Input:
module = "JAVA"
level = "INFO"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_Log() stub function to add a log message from TEST module with a particular log level disabled in debug.ini file.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_InverseLevel</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_InverseLevel');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj = obj.createTestStep('RDKBLogger_Log');
