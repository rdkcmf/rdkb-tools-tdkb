...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1366</id>
  <version>2</version>
  <name>TS_RDKBLogger_Log_InverseTrace</name>
  <primitive_test_id/>
  <primitive_test_name>RDKBLogger_Log_InverseTrace</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To add 9 log messages of TRACE1... TRACE9 levels for !TRACE threshold.
Test Case ID: CT_RDKBLogger_26
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_20</test_case_id>
    <test_objective>To add 9 log messages of TRACE1... TRACE9 levels for !TRACE threshold.</test_objective>
...
API Name
RDKBLogger_Log_InverseTrace

Input:
module = "TEST5"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_Log_InverseTrace() stub function to add 9 log messages of TRACE1... TRACE9 levels for !TRACE threshold.
...
Corresponding log message should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_InverseTrace</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_InverseTrace');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj = obj.createTestStep('RDKBLogger_Log_InverseTrace');
