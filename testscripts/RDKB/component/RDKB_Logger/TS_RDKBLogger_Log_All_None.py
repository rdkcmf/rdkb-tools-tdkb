...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_RDKBLogger_Log_All_None</name>
  <primitive_test_id/>
...
Test Case ID: CT_RDKLogger_28</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_12</test_case_id>
    <test_objective>To add 15 log messages of DEBUG, INFO, NOTICE, WARNING, ERROR, FATAL, TRACE1... TRACE9 levels with ALL NONE threshold.</test_objective>
...
4.From python script, invoke RDKBLogger_Log_None() stub function to add 15 log messages of DEBUG, INFO, NOTICE, WARNING, ERROR, FATAL, TRACE1 to TRACE9 levels with all none threshold.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_All_None</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_All_None');
