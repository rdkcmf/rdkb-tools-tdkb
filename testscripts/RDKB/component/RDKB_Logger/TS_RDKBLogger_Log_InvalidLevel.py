...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_18</test_case_id>
    <test_objective>To add a log msg with an invalid logging level.</test_objective>
...
Input:
module = "TEST"
level = "TEST"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_Log() stub function to add a log msg with an invalid logging level.
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_InvalidLevel</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_InvalidLevel');
