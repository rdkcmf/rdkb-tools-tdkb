...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_10</test_case_id>
    <test_objective>To test the RDK logger logging functionality</test_objective>
...
4.From python script, invoke RDKBLogger_Log() stub function to check the RDK logger logging functionality
5.RDKLogger stub function will call the logNameToEnum() function of the rdk-logger component in ccsp.
...
RDK Logger logging functionality status should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log');
