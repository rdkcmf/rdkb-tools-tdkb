...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_RDKBLogger_GetDefaultLevel</name>
  <primitive_test_id/>
...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_7</test_case_id>
...
Input:
module = "DEFAULT"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_EnvGet() stub function to get the default logging level of the module from the config file
...
Default logging level value should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_GetDefaultLevel</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_GetDefaultLevel');
