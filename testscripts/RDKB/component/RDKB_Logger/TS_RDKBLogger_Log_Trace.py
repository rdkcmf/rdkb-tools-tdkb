...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1365</id>
  <version>3</version>
  <name>TS_RDKBLogger_Log_Trace</name>
  <primitive_test_id/>
  <primitive_test_name>RDKBLogger_Log_Trace</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To add 9 log messages of TRACE1... TRACE9 levels for TRACE threshold.
Test Case ID: CT_RDKBLogger_25
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_25</test_case_id>
...
API Name
RDKBLogger_Log_Trace

Input:
module = "TEST4"</input_parameters>
    <automation_approch>1.Function which needs to be tested will be configured in Test Manager GUI.
2.Python Script will be generated by Test Manager with provided arguments in configure page. 
3.TM will load the RDKLogger library via Test agent
4.From python script, invoke RDKBLogger_Log_Trace() stub function to add 9 log messages of TRACE1... TRACE9 levels for TRACE threshold.
...
Log message should be logged in the Agent console/Component log
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_Trace</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_Trace');
...
if "SUCCESS" in result.upper():
    ...
    tdkTestObj = obj.createTestStep('RDKBLogger_Log_Trace');
