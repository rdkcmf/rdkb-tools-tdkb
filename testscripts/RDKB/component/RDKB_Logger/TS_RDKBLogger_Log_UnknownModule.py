...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1442</id>
  <version>4</version>
  <name>TS_RDKBLogger_Log_UnknownModule</name>
  <primitive_test_id/>
...
Test Type: Negative</synopsis>
  ...
  <test_cases>
    <test_case_id>TC_RDKLOGGER_35</test_case_id>
    <test_objective>To log a message from a module not configured in debug.ini file using default</test_objective>
...
4.From python script, invoke RDKBLogger_Log() stub function to log a message from a module not configured in debug.ini file using default 
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager</except_output>
    ...
    <test_script>TS_RDKBLogger_Log_UnknownModule</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
obj.configureTestCase(ip,port,'TS_RDKBLogger_Log_UnknownModule');
