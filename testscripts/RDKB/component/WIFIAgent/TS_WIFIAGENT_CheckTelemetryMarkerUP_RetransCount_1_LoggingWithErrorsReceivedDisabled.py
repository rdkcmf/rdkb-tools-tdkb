...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_203</test_case_id>
    <test_objective>Check if the telemetry for WiFi Packet Retries in the uplink direction for 2.4G "UP_RetransCount_1" is not getting logged in wifihealth.txt within the specified Log Interval after the RFC Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.ErrorsReceived.Enable is enabled and Device.WiFi.AccessPoint.1.X_COMCAST-COM_AssociatedDevicesErrorsReceivedStatsEnable is disabled.</test_objective>
...
6. If the enable parameter for 2.4G private AP is  not disabled, set to false and validate the set.
...
12. The difference between the final and initial number of "UP_RetransCount_1" markers in wifihealth.txt should be equal to 0 after disabling Device.WiFi.AccessPoint.1.X_COMCAST-COM_AssociatedDevicesErrorsReceivedStatsEnable.
13. Revert the telemetry log interval to initial value
14. Revert Device.WiFi.AccessPoint.1.X_COMCAST-COM_AssociatedDevicesErrorsReceivedStatsEnable if required.
...
16. Unload the modules</automation_approch>
    <expected_output>The telemetry for WiFi Packet Retries in the uplink direction for 2.4G "UP_RetransCount_1" should not be logged in wifihealth.txt within the specified Log Interval after the RFC Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.ErrorsReceived.Enable is enabled and Device.WiFi.AccessPoint.1.X_COMCAST-COM_AssociatedDevicesErrorsReceivedStatsEnable is disabled.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifiagent</test_stub_interface>
    <test_script>TS_WIFIAGENT_CheckTelemetryMarkerUP_RetransCount_1_LoggingWithErrorsReceivedDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_CheckTelemetryMarkerUP_RetransCount_1_LoggingWithErrorsReceivedDisabled');
sysObj.configureTestCase(ip,port,'TS_WIFIAGENT_CheckTelemetryMarkerUP_RetransCount_1_LoggingWithErrorsReceivedDisabled');
