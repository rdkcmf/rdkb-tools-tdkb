...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIAGENT_5GHzGetOpenandSecureSSIDNames</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To enable public wifi  and get the SSID names for 5GHz open and secure public wifi</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_155</test_case_id>
    <test_objective>To enable public wifi  and get the SSID names for 5GHz open and secure public wifi</test_objective>
...
4.Get the SSID name for 5G open and secure public wifi and check the name are not OutOfService
...
6.Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIAGENT_5GHzGetOpenandSecureSSIDNames</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHzGetOpenandSecureSSIDNames');
wifiobj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHzGetOpenandSecureSSIDNames');
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult and details != "":
                    ...
                    secureSSID="Device.WiFi.SSID.6.SSID";
                    publicSSID="Device.WiFi.SSID.10.SSID";
                    ...
                    if expectedresult in (actualresult1 and actualresult2)  and "OutofService"  not in (details1 and details2):
                        ...
                        #Set the result status of execution
                        tdkTestObj.setResultStatus("SUCCESS");
                        print "TEST STEP 5 :Get the SSID name for Secure and Open 5GHz public wifi";
                        print "EXPECTED RESULT 5: Should not get the name of Secure and Open 5GHz public wifi as OutofService";
