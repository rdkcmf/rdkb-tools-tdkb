...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIAGENT_5GHZ_GetOperatingStandard</name>
  <primitive_test_id/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHZ_GetOperatingStandard');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    #Get the list of operating standards
    ...
    if expectedresult in actualresult and flag == 1:
        ...
        print "TEST STEP 1: Get the list of operating standards"
        print "EXPECTED RESULT 1: operating standards should be from the expected list of values"
