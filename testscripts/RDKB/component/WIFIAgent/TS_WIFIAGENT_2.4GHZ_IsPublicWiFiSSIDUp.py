...
<xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIAGENT_2.4GHZ_IsPublicWiFiSSIDUp</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set Device.WiFi.SSID.5.Enable to true and check whether the status is Up</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_53</test_case_id>
    <test_objective>Set Device.WiFi.SSID.5.Enable to true and check whether the status is Up</test_objective>
...
3.Set DDevice.WiFi.SSID.5.Enable as true
3. Using WIFIAgent_Get, get Device.WiFi.SSID.5.Status
6. Restore value of Device.WiFi.SSID.5.Enable</automation_approch>
    <except_output>Device.WiFi.SSID.5.Status should be Up</except_output>
    <priority>High</priority>
    <test_stub_interface>WifiAgent</test_stub_interface>
    <test_script>TS_WIFIAGENT_2.4GHZ_IsPublicWiFiSSIDUp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHZ_IsPublicWiFiSSIDUp');
