...
<xml>
  ...
  <name>TS_WIFIAGENT_5GHZ_OperatingStdFromSupportedStds</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check Device.WiFi.Radio.2.OperatingStandards is a subset of SupportedStandards list</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_38</test_case_id>
    <test_objective>Check Device.WiFi.Radio.2.OperatingStandards is a subset of SupportedStandards list</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.WiFi.Radio.2.SupportedStandards
Device.WiFi.Radio.2.OperatingStandards</input_parameters>
...
5. Unload wifiagent module</automation_approch>
    <except_output>Device.WiFi.Radio.2.OperatingStandards is a subset of SupportedStandards list</except_output>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHZ_OperatingStdFromSupportedStds');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","Device.WiFi.Radio.2.SupportedStandards")
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj = obj.createTestStep('WIFIAgent_Get');
        tdkTestObj.addParameter("paramName","Device.WiFi.Radio.2.OperatingStandards")
        tdkTestObj.executeTestCase(expectedresult);
        actualresult = tdkTestObj.getResult();
        details = tdkTestObj.getResultDetails();
