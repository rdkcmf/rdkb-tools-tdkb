...
<xml>
  ...
  <name>TS_WIFIAGENT_5GHZ_SupportedStandards</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if SupportedStandards value is from the enumeration list a,b,g,n,ac</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_25</test_case_id>
    <test_objective>Check if SupportedStandards value is from the enumeration list a,b,g,n,ac</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.WiFi.Radio.2.SupportedStandards</input_parameters>
...
3.Check if supported standard value is from the list a,b,g,n,ac
...
5.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from wifiagentstub.</automation_approch>
    ...
    <test_script>TS_WIFIAGENT_5GHZ_SupportedStandards</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHZ_SupportedStandards');
