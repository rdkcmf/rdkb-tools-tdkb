...
<xml>
  ...
  <name>TS_WIFIAGENT_EnablePublicWiFi</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To enable Public WiFi and check whether the status of public wifi SSIDs are "up"</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_49</test_case_id>
    <test_objective>To enable Public WiFi and check whether the status of public wifi SSIDs are "up"</test_objective>
...
3. Set Device.DeviceInfo.X_COMCAST_COM_xfinitywifiEnable as true
...
6. Restore value of Device.DeviceInfo.X_COMCAST_COM_xfinitywifiEnable</automation_approch>
    <except_output>Status of SSID5 and SSID6 should be up when the xfinity is enabled</except_output>
    <priority>High</priority>
    <test_stub_interface>WifiAgent</test_stub_interface>
    <test_script>TS_WIFIAGENT_EnablePublicWiFi</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_EnablePublicWiFi');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        print "TEST STEP 1:Get values of Public WiFi params"
        print "TEST STEP 1 : Should get values of Public WiFi params"
        print "ACTUAL RESULT 1:%s" %orgValue
        print "[TEST EXECUTION RESULT] : SUCCESS";

        #Enable Public WiFi in DUT
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 2 : Should enable Public WiFi"
            print "ACTUAL RESULT 2:%s" %details
            print "[TEST EXECUTION RESULT] : SUCCESS";

            sleep(5);
            #check if public wifi ssid status is up or not
            ...
            if expectedresult in actualresult and "Up" in status1 and "Up" in status2:
                tdkTestObj.setResultStatus("SUCCESS");
            ...
            if expectedresult in actualresult:
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 4:Enable Public WiFi"
                print "TEST STEP 4 : Should enable Public WiFi"
