...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WiFiMesh_CheckBandSteering_WithMeshEnabled</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_76</test_case_id>
    <test_objective>Check if on enabling mesh, band steering parameter Device.WiFi.X_RDKCENTRAL-COM_BandSteering.Enable gets disabled</test_objective>
...
6. Check if band steering is in disabled state on enabling mesh
...
9. Unload wifiagent module</automation_approch>
    <expected_output>On enabling mesh, band steering parameter Device.WiFi.X_RDKCENTRAL-COM_BandSteering.Enable should get disabled</expected_output>
    <priority>High</priority>
    <test_stub_interface>WifiAgent</test_stub_interface>
    <test_script>TS_WiFiMesh_CheckBandSteering_WithMeshEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WiFiMesh_CheckBandSteering_WithMeshEnabled');
...
if "SUCCESS" in loadmodulestatus.upper():
	...
	if "bridge-static" == orgLanMode:
        ...
        if expectedresult in actualresult:
            ...
            #check if bandsteering is in disabled state
            tdkTestObj = obj.createTestStep('WIFIAgent_Get');
            ...
            if expectedresult in actualresult and "false" in status:
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 5: Check if bandsteering is disabled";
                print "EXPECTED RESULT 5: bandsteering should be disabled";
            ...
            if orgState == "false":
                ...
                if expectedresult in actualresult:
                    ...
                    print "ACTUAL RESULT 6: Details is %s " %details;
                    #Get the result of execution
                    print "[TEST EXECUTION RESULT] : SUCCESS";
                else:
                    #Set the result status of execution
