...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIAGENT_GetValuesOfWMMCapabilitANdUAPSDCapability</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_19</test_case_id>
    <test_objective>To Validate get WMMCapability and UAPSDCapability</test_objective>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_WIFIAGENT_GetValuesOfWMMCapabilitANdUAPSDCapability.py)
...
"</except_output>
    ...
    <test_script>TS_WIFIAGENT_GetValuesOfWMMCapabilitANdUAPSDCapability</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_GetValuesOfWMMCapabilitANdUAPSDCapability');
