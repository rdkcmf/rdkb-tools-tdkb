...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIAGENT_5GHZ_AutoChannelEnable</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test if AutoChannelEnable becomes false on manually setting channel value</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_29</test_case_id>
    <test_objective>Check if AutoChannelEnable becomes false when channel value is changed manually</test_objective>
...
3. Set Device.WiFi.Radio.2.AutoChannelEnable as true
...
5. After set, check if Device.WiFi.Radio.2.AutoChannelEnable has become false
6. Restrore values of Device.WiFi.Radio.2.AutoChannelEnable and Device.WiFi.Radio.2.Channel</automation_approch>
    <except_output>AutoChannelEnable becomes false when channel value is changed manually</except_output>
    <priority>High</priority>
    <test_stub_interface>WifiAgent</test_stub_interface>
    <test_script>TS_WIFIAGENT_5GHZ_AutoChannelEnable</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHZ_AutoChannelEnable');
