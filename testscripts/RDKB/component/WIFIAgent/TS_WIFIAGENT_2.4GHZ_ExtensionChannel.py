...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIAGENT_2.4GHZ_ExtensionChannel</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test if ExtensionChannel value is an enumeration of {AboveControlChannel, BelowControlChannel, Auto} for 2.4GHz Channel</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Test if ExtensionChannel value is an enumeration of {AboveControlChannel, BelowControlChannel, Auto} for 2.4GHz Channel</test_objective>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    ...
    <input_parameters>Device.WiFi.Radio.1.ExtensionChannel</input_parameters>
    <automation_approch>1. Load wifiagent module
2. Using WIFIAgent_Get, get Device.WiFi.Radio.1.ExtensionChannel
...
4. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_WIFIAGENT_2.4GHZ_ExtensionChannel</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHZ_ExtensionChannel');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    #Get the list of Current Extension Channel
    tdkTestObj = obj.createTestStep('WIFIAgent_Get');
    tdkTestObj.addParameter("paramName","Device.WiFi.Radio.1.ExtensionChannel")
