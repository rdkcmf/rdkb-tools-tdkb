...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WIFIAGENT_EnableBssHotSpot</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_15</test_case_id>
    <test_objective>To Validate AccessPoint.1.X_CISCO_COM_BssHotSpot</test_objective>
...
( eg: "Device.WiFi.AccessPoint.1.X_CISCO_COM_BssHotSpot" )
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_WIFIAGENT_EnableBssHotSpot.py)
3.Execute the generated Script(TS_WIFIAGENT_EnableBssHotSpot.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_WIFIAGENT_EnableBssHotSpot</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_EnableBssHotSpot');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","Device.WiFi.AccessPoint.1.X_CISCO_COM_BssHotSpot");
    ...
    if expectedresult in actualresult:
        ...
        print "EXPECTED RESULT 1: Should Set the Bss Hotspot Enable Value to True";
        print "ACTUAL RESULT 1: %s" %details;
        #Get the result of execution
        print "[TEST EXECUTION RESULT] : %s" %actualresult;
        print "Enable Bss Hotspot Function is SUCCESS"
    else:
        ...
        print "ACTUAL RESULT 1: %s" %details;
        print "[TEST EXECUTION RESULT] : %s" %actualresult;
        print "Enable Bss Hotspot Function is FAILURE"        
