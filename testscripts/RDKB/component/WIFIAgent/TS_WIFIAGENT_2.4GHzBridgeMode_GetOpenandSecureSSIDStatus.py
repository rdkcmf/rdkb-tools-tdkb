...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIAGENT_2.4GHzBridgeMode_GetOpenandSecureSSIDStatus</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To enable public wifi  and get the SSID status for 2.4GHz open and secure public wifi  in bridge mode</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_158</test_case_id>
    <test_objective>To enable public wifi  and get the SSID status for 2.4GHz open and secure public wifi  in bridge mode</test_objective>
...
5.Get the SSID status for 2.4G open and secure public wifi and check the status is up
6.Revert back the public wifi parameters
7.Unload the module</automation_approch>
    <expected_output>With public wifi enabled and device in bridge mode 2G open and secure public wifi are expected to be up</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAGENT</test_stub_interface>
    <test_script>TS_WIFIAGENT_2.4GHzBridgeMode_GetOpenandSecureSSIDStatus</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHzBridgeMode_GetOpenandSecureSSIDStatus');
wifiobj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHzBridgeMode_GetOpenandSecureSSIDStatus');
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult and details != "":
                    ...
                    if expectedresult in actualresult:
                        ...
                        publicSSID="Device.WiFi.SSID.9.Enable";
                        tdkTestObj = wifiobj.createTestStep('WIFIAgent_Get');
