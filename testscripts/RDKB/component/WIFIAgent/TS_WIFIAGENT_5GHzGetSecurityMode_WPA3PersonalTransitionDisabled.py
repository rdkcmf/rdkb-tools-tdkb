...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIAGENT_5GHzGetSecurityMode_WPA3PersonalTransitionDisabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>TO check the 5GHz Access Point Security Mode with WPA3 Personal Transition Disabled</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_135</test_case_id>
    <test_objective>This test case is to check security mode of  5Ghz Access point with WPA3 Personal Transition Disabled</test_objective>
...
4.Check the security mode enabled for Access point 5GHz and is expected to be WPA2-Personal
5.Revert the set value
5.Unload the module</automation_approch>
    <expected_output>with   WPA3 Personal Transition disabled  security mode  for Access point 5GHz  is expected to be WPA2-Personal </expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAGENT</test_stub_interface>
    <test_script>TS_WIFIAGENT_5GHzGetSecurityMode_WPA3PersonalTransitionDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHzGetSecurityMode_WPA3PersonalTransitionDisabled');
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult and  value!= "":
                ...
                if "WPA2-Personal" in value:
                    #Set the result status of execution
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 3: Get the security mode of 5GHZ WIFI with WPA3 Transition disabled";
                    print "EXPECTED RESULT 3 Should get the security mode of 5GHZ WIFI as WPA2-Personal"
