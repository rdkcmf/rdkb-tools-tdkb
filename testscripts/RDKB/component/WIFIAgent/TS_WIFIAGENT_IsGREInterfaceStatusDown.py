...
<xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIAGENT_IsGREInterfaceStatusDown</name>
  <primitive_test_id/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_IsGREInterfaceStatusDown');
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if expectedresult in actualresult:
                    ...
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 4: Disable the interface";
                    print "EXPECTED RESULT 4: Should disable the interface"
