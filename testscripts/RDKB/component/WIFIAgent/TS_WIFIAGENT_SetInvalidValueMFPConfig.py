...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIAGENT_SetInvalidValueMFPConfig</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set a Invalid value to MFP Config Security Access Point</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_140</test_case_id>
    <test_objective>This test case is to set a Invalid value to MFP Config Security Access Point</test_objective>
...
2.Get the current value for MFP Config Security Access point
3.Set a invalid value like unknown and the set is expected to be a failure
4.Revert set in case of failure
5.Unload the module</automation_approch>
    <expected_output>MFP Config Security Access point should not accept a invalid value</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAGENT</test_stub_interface>
    <test_script>TS_WIFIAGENT_SetInvalidValueMFPConfig</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_SetInvalidValueMFPConfig');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj.addParameter("ParamValue","unknown");
