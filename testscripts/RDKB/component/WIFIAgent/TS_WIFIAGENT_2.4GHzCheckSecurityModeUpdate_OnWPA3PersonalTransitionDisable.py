...
<xml>
  ...
  <name>TS_WIFIAGENT_2.4GHzCheckSecurityModeUpdate_OnWPA3PersonalTransitionDisable</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_180</test_case_id>
...
4. Set Device.WiFi.AccessPoint.1.Security.ModeEnabled to WPA3-Personal mode
...
6. Set Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition to true and then set Device.WiFi.AccessPoint.1.Security.ModeEnabled to WPA3-Personal-Transition.
...
11. Unload the module.</automation_approch>
    <expected_output>Device.WiFi.AccessPoint.1.Security.ModeEnabled should update to WPA2-Personal from WPA3 Modes such as WPA3-Personal and WPA3-Personal-Transition whenever the WPA3 RFC Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition.Enable is disabled.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifiagent</test_stub_interface>
    <test_script>TS_WIFIAGENT_2.4GHzCheckSecurityModeUpdate_OnWPA3PersonalTransitionDisable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHzCheckSecurityModeUpdate_OnWPA3PersonalTransitionDisable');
    ...
    if expectedresult in actualresult:
        ...
        if pre_req_set == 1:
            ...
            for mode in wpa3_modes:
                ...
                actualresult, details = SetParameterValue(tdkTestObj, "Device.WiFi.AccessPoint.1.Security.ModeEnabled", mode, "string");
                ...
                if expectedresult in actualresult :
                    ...
                    step = step + 1;
                    tdkTestObj = obj.createTestStep("WIFIAgent_Get");
                    actualresult, details = GetParameterValue(tdkTestObj, "Device.WiFi.AccessPoint.1.Security.ModeEnabled");
                            ...
                            if expectedresult in actualresult :
                                ...
                                if expectedresult in actualresult:
                                    ...
                                    if rfc_enable == "false" :
                                        ...
                                        print "\nTEST STEP %d : Get the Security Mode using Device.WiFi.AccessPoint.1.Security.ModeEnabled and check if the mode is changes to WPA2-Personal after WPA3 RDC Disable" %step;
                                        print "EXPECTED RESULT %d : Should successfully get Device.WiFi.AccessPoint.1.Security.ModeEnabled and should be WPA2-Personal after WPA3 RFC Disable" %step;
