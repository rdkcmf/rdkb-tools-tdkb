...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>17</version>
  <name>TS_WIFIAGENT_2.4GHzSetInterworkingConfiguration</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_SetMultiple</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check if set operation of Interworking Configuration using Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters is successful when the Interworking RFC, Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WiFi-Interworking.Enable and the Interworking Service, Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable are enabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_223</test_case_id>
    <test_objective>To check if set operation of Interworking Configuration using Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters is successful when the Interworking RFC, Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WiFi-Interworking.Enable and the Interworking Service, Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable are enabled.</test_objective>
...
paramType : boolean
paramName : Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable
paramValue : true/false
paramType : boolean
ParmName : Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters
...
3. Check if the Interworking enable, Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable is enabled. If not, enable it and validate with get.
4. Check if the initial value of Interworking configuration can be retrieved using Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters.
5. Set Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters to a new configuration and validate the SET with GET.
6. Revert Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable if required.
...
8. Unload the wifiagent module.</automation_approch>
    <expected_output>Set operation of Interworking Configuration using Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters should be successful when the Interworking RFC, Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WiFi-Interworking.Enable and the Interworking Service, Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable are enabled.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifiagent</test_stub_interface>
    <test_script>TS_WIFIAGENT_2.4GHzSetInterworkingConfiguration</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
wifiobj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHzSetInterworkingConfiguration');
...
if "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in actualresult and details != "" :
        ...
        #Get the interworking enable status for AP 9
        if proceed_flag == 0 :
            step = step + 1;
            param_service = "Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable";
            print "\nTEST STEP %d : Get the initial enable status of Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable" %step;
            ...
            if expectedresult in actualresult and details != "" :
                ...
                if service_enable_initial != "true":
                    ...
                    print "\nTEST STEP %d: Set Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable to %s" %(step, setValue);
                    print "EXPECTED RESULT %d: Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable should be set to %s successfully" %(step, setValue);
                    ...
                    print "Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable is already enabled, SET operation not required";

                #Get the Interworking configuration
                if proceed_flag == 0:
                    step = step + 1;
                    param_config = "Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters"
                    print "\nTEST STEP %d : Get the initial Interworking configuration using Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters" %step;
                    ...
                    if expectedresult in actualresult and details != "" :
                        ...
                        if expectedresult in actualresult:
                            ...
                            #Revalidate with GET
                            step = step + 1;
                            print "\nTEST STEP %d : Get the current Interworking configuration using Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingService.Parameters" %step;
                    ...
                    tdkTestObj.setResultStatus("FAILURE");
                    print "Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable is not enabled successfully, cannot proceed...";

                #Revert the interworking service enable
                if service_revert == 1:
                    step = step + 1;
                    print "\nTEST STEP %d: Revert Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable to %s" %(step, service_enable_initial);
                    print "EXPECTED RESULT %d: Device.WiFi.AccessPoint.9.X_RDKCENTRAL-COM_InterworkingServiceEnable should be reverted to %s successfully" %(step, service_enable_initial);
