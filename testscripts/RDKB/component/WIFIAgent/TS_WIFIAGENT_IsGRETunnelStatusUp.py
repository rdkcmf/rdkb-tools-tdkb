...
<xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIAGENT_IsGRETunnelStatusUp</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set Device.X_COMCAST-COM_GRE.Tunnel.1.Enable  to true and check whether the tunnel status is Up or not</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To set Device.X_COMCAST-COM_GRE.Tunnel.1.Enable  to true and check whether the tunnel status is Up or not</test_objective>
...
3.Set Device.X_COMCAST-COM_GRE.Tunnel.1.Enable as true
...
6. Restore value of Device.X_COMCAST-COM_GRE.Tunnel.1.Enable</automation_approch>
    <except_output>Device.X_COMCAST-COM_GRE.Tunnel.1.Status should be Up</except_output>
    <priority>High</priority>
    <test_stub_interface>WifiAgent</test_stub_interface>
    <test_script>TS_WIFIAGENT_IsGRETunnelStatusUp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_IsGRETunnelStatusUp');
    ...
    if expectedresult in actualresult:
	    ...
	    tdkTestObj = obj.createTestStep('WIFIAgent_Get');
	        ...
	        if expectedresult in actualresult:
                    ...
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 4: Enable the Tunnel";
                    print "EXPECTED RESULT 4: Should enable the Tunnel"
	            ...
	            #check if Tunnel status is up or not
                    ...
                    if expectedresult in actualresult and "Up" in status:
                        tdkTestObj.setResultStatus("SUCCESS");
                        print "TEST STEP 5: Check if Tunnel staus is Up";
                        print "EXPECTED RESULT 5: Tunnel staus should be Up";
