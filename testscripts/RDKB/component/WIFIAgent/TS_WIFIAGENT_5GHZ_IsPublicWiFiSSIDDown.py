...
<xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIAGENT_5GHZ_IsPublicWiFiSSIDDown</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Set</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Set Device.WiFi.SSID.6.Enable to false and check whether the status is down</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_52</test_case_id>
    <test_objective>Set Device.WiFi.SSID.6.Enable to false and check whether the status is down</test_objective>
...
3.Set DDevice.WiFi.SSID.6.Enable as false
3. Using WIFIAgent_Get, get Device.WiFi.SSID.6.Status
6. Restore value of Device.WiFi.SSID.6.Enable</automation_approch>
    <except_output>Device.WiFi.SSID.6.Status should be Down</except_output>
    <priority>High</priority>
    <test_stub_interface>WifiAgent</test_stub_interface>
    <test_script>TS_WIFIAGENT_5GHZ_IsPublicWiFiSSIDDown</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHZ_IsPublicWiFiSSIDDown');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        setvalues = ["44","68.86.15.199","68.86.15.171","true","false","true"];
