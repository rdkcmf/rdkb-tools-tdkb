...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_WIFIAGENT_GetHealth</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_GetHealth</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Get Health API Validation</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_9</test_case_id>
    <test_objective>To Validate Get Component Helath Function for WIFI Agent</test_objective>
...
Health of WIFIAGENT log from DUT should be available in Agent Console Log
CheckPoint 2:
...
Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_WIFIAGENT_GetHealth</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_GetHealth');
