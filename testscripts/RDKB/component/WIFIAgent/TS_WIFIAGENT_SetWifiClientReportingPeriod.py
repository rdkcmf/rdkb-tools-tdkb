...
<xml>
  ...
  <name>TS_WIFIAGENT_SetWifiClientReportingPeriod</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set the Wifi Client Reporting Period with all the supported values</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_103</test_case_id>
    <test_objective>This test case is to check if  Wifi Client Reporting Period  can be set to all  its  supported periods</test_objective>
...
TDKB_TR181Stub_Set</api_or_interface_used>
    <input_parameters>ParamName -Device.WiFi.X_RDKCENTRALCOM_Report.WifiClient.ReportingPeriod
ParamValues - 1,5,15,30,60,300,900,1800,3600,10800,21600,43200,86400</input_parameters>
    <automation_approch>1.Load tdkbtr181 module.
2.Do a get on Device.WiFi.X_RDKCENTRALCOM_Report.WifiClient.ReportingPeriod  and store the initial value.
...
6.Unload the module</automation_approch>
    <expected_output>All the supported values to Device.WiFi.X_RDKCENTRALCOM_Report.WifiClient.ReportingPeriod  should be set successfully.</expected_output>
    <priority>High</priority>
    <test_stub_interface>TDKB-TR181</test_stub_interface>
    <test_script>TS_WIFIAGENT_SetWifiClientReportingPeriod</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_SetWifiClientReportingPeriod');
