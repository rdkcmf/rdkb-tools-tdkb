...
<xml>
  ...
  <name>TS_WIFIAGENT_ForceDisable_Set2GWiFiParams</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if radioenable,KeyPassphrase,AccessPoint parameters for 2G are not writable when WiFi Force Disable is enabled</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_129</test_case_id>
    <test_objective>This test case is to check if radioenable,KeyPassphrase,AccessPoint parameters for 2G are not writable when WiFi Force Disable is enabled</test_objective>
...
"Device.WiFi.Radio.1.Enable" ,"Device.WiFi.AccessPoint.1.Enable","Device.WiFi.AccessPoint.1.Security.X_COMCAST-COM_KeyPassphrase"</input_parameters>
...
Device.WiFi.Radio.1.Enable" ,"Device.WiFi.AccessPoint.1.Enable","Device.WiFi.AccessPoint.1.Security.X_COMCAST-COM_KeyPassphrase" ,and this write operation is expected to fail
...
6.Unload the module</automation_approch>
    <expected_output>Write operation on wifi parameters should fail and "WIFI_ATTEMPT_TO_CHANGE_CONFIG_WHEN_FORCE_DISABLED " message should be present in WiFilog.txt.0  each time a set operation is done when WiFi Force Disable is enabled</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAGENT</test_stub_interface>
    <test_script>TS_WIFIAGENT_ForceDisable_Set2GWiFiParams</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_ForceDisable_Set2GWiFiParams');
obj1.configureTestCase(ip,port,'TS_WIFIAGENT_ForceDisable_Set2GWiFiParams');
