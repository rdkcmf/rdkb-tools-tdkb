...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_WIFIAGENT_5GHZ_RadioLastChange</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check if LastChange value change on enabling/disabling Radio.2</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_34</test_case_id>
    <test_objective>Check if LastChange value change on enabling/disabling Radio.2</test_objective>
...
Device.WiFi.Radio.2.LastChange</input_parameters>
    <automation_approch>1. Load wifiagent module
2. Using WIFIAgent_Get, get and save Device.WiFi.Radio.2.Enable
3. Using WIFIAgent_Get, get and save Device.WiFi.Radio.2.LastChange
4. Using WIFIAgent_Set, toggle value of Device.WiFi.Radio.2.Enable
5. Using WIFIAgent_Get, get  the value of Device.WiFi.Radio.2.LastChange and compare it with previous value
6. Check if lastchange value is less than the previously saved value
7. Restrore values of Device.WiFi.Radio.2.Enable, Device.WiFi.Radio.2.LastChange
8. Unload wifiagent module</automation_approch>
    <except_output>LastChange value should change on enabling/disabling Radio.2</except_output>
    <priority>High</priority>
    <test_stub_interface>WifiAgent</test_stub_interface>
    <test_script>TS_WIFIAGENT_5GHZ_RadioLastChange</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_5GHZ_RadioLastChange');
