...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_WIFIAGENT_DisableSNRMarker_FoAllVAP</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Test to disable SNR telemetry markers for all available Virtual access points.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_88</test_case_id>
    <test_objective>Test to disable SNR telemetry markers for all available Virtual access points.</test_objective>
...
3.Set the SNR list as "" to disable for all virtual access points
...
7. Unload wifiagent module</automation_approch>
    <expected_output>Should successfully disable SNR telemetry markers for all available Virtual access points.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAGENT</test_stub_interface>
    <test_script>TS_WIFIAGENT_DisableSNRMarker_FoAllVAP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_DisableSNRMarker_FoAllVAP');
