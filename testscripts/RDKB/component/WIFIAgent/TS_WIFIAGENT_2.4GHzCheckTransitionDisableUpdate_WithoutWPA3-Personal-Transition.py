...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIAGENT_2.4GHzCheckTransitionDisableUpdate_WithoutWPA3-Personal-Transition</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_186</test_case_id>
...
11. Unload the module</automation_approch>
    ...
    <test_script>TS_WIFIAGENT_2.4GHzCheckTransitionDisableUpdate_WithoutWPA3-Personal-Transition</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHzCheckTransitionDisableUpdate_WithoutWPA3-Personal-Transition');
