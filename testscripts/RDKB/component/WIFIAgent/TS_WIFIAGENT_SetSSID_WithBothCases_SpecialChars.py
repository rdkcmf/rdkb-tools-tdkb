...
<xml>
  ...
  <name>TS_WIFIAGENT_SetSSID_WithBothCases_SpecialChars</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if setting a SSID name having  alphabets in both Upper and lower cases along with special characters is success</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_85</test_case_id>
    <test_objective>Check if setting a SSID name having  alphabets in both Upper and lower cases along with special characters is success</test_objective>
...
3.Set the SSID name as "Test_SSID", so that it has alphabets in both Upper and lower cases along with special characters
...
7. Unload wifiagent module</automation_approch>
    <expected_output>Setting a SSID name having  alphabets in both Upper and lower cases along with special characters should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAGENT</test_stub_interface>
    <test_script>TS_WIFIAGENT_SetSSID_WithBothCases_SpecialChars</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_SetSSID_WithBothCases_SpecialChars');
