...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_16</test_case_id>
    <test_objective>To validate UAPSD Enabled</test_objective>
...
( eg: "Device.WiFi.AccessPoint.1.UAPSDEnable" )
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_WIFIAGENT_EnableUAPSD.py)
3.Execute the generated Script(TS_WIFIAGENT_EnableUAPSD.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_WIFIAGENT_EnableUAPSD</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
