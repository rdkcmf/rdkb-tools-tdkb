...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_WIFIAGENT_EnableWMM</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_17</test_case_id>
    <test_objective>To validate WMM Enabled</test_objective>
...
( eg: "Device.WiFi.AccessPoint.1.WMMEnable" )
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_WIFIAGENT_EnableWMM.py)
3.Execute the generated Script(TS_WIFIAGENT_EnableWMM.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_WIFIAGENT_EnableWMM</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_EnableWMM');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","Device.WiFi.AccessPoint.1.WMMEnable");
    ...
    if expectedresult in actualresult:
        ...
        print "EXPECTED RESULT 1: Should Set the Enable access point WMM value to true";
        print "ACTUAL RESULT 1: %s" %details;
        #Get the result of execution
        print "[TEST EXECUTION RESULT] : %s" %actualresult;
        print "Enable WMM Function is SUCCESS"
    else:
        ...
        print "ACTUAL RESULT 1: %s" %details;
        print "[TEST EXECUTION RESULT] : %s" %actualresult;
        print "Enable WMM Function is FAILURE"
