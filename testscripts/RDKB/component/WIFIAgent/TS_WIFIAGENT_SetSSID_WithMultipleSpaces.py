...
<xml>
  ...
  <name>TS_WIFIAGENT_SetSSID_WithMultipleSpaces</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if  setting a 32 characters long SSID name with multiple white spaces, numbers and special characters, is success</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_86</test_case_id>
    <test_objective>Check if  setting a 32 characters long SSID name with multiple white spaces, numbers and special characters, is success</test_objective>
...
3.Set the SSID name as "testssid  12345678#12345678#1234", so that it is 32 characters long with multiple white spaces, numbers and special characters
...
7. Unload wifiagent module</automation_approch>
    <expected_output>Setting a 32 characters long SSID name with multiple white spaces, numbers and special characters, should be success</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAGENT</test_stub_interface>
    <test_script>TS_WIFIAGENT_SetSSID_WithMultipleSpaces</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_SetSSID_WithMultipleSpaces');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        #Change SSID name
        setSSID = "testssid  12345678#12345678#1234"
	...
	tdkTestObj.addParameter("paramType","string")
        ...
        if expectedresult in actualresult:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print "TEST STEP 2: Set a 32 characters long SSID name with multiple white spaces, numbers and special characters";
            print "EXPECTED RESULT 2: Should  set a 32 characters long SSID name with multiple white spaces, numbers and special characters";
