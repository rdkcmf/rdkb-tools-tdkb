...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIAGENT_EnableAccessPointSSIDAdvertisement</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_14</test_case_id>
    <test_objective>To validate Access Point SSID Advertisement enabled</test_objective>
...
( eg: "Device.WiFi.AccessPoint.1.SSIDAdvertisementEnabled" )
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_WIFIAGENT_EnableAccessPointSSIDAdvertisement.py)
3.Execute the generated Script(TS_WIFIAGENT_EnableAccessPointSSIDAdvertisement.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_WIFIAGENT_EnableAccessPointSSIDAdvertisement</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_EnableAccessPointSSIDAdvertisement');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    tdkTestObj.addParameter("paramName","Device.WiFi.AccessPoint.1.SSIDAdvertisementEnabled");
    ...
    if expectedresult in actualresult:
        ...
        print "EXPECTED RESULT 1: Should Set the Access Point SSID Advertisement Enable Value to True";
        print "ACTUAL RESULT 1: %s" %details;
        #Get the result of execution
        print "[TEST EXECUTION RESULT] : %s" %actualresult;
        print "Enable Access Point SSID Advertisement is SUCCESS:Value set to true"
    else:
        ...
        print "ACTUAL RESULT 1: %s" %details;
        print "[TEST EXECUTION RESULT] : %s" %actualresult;
        print "Enable Access Point SSID Advertisement is FAILURE"        
