...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WIFIAGENT_2.4GHzSetSAEPassPhrase_WithWPA3SecurityModes</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_178</test_case_id>
...
4. Get the initial SAE Passphrase using Device.WiFi.AccessPoint.1.Security.SAEPassphrase and store it.
5. Set the Device.WiFi.AccessPoint.1.Security.ModeEnabled wo WPA3-Personal and validate with get.
6. Check if the SET operation of Device.WiFi.AccessPoint.1.Security.SAEPassphrase to a valid new value returns success and validate with get.
7. Set the Device.WiFi.AccessPoint.1.Security.ModeEnabled wo WPA3-Personal-Transition and validate with get.
8. Check if the SET operation of Device.WiFi.AccessPoint.1.Security.SAEPassphrase to a valid new value returns success and validate with get.
9. Revert Device.WiFi.AccessPoint.1.Security.SAEPassphrase to initial value
10. Revert the WPA3 RFC Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition.Enable status if required
11. Revert Device.WiFi.AccessPoint.1.Security.ModeEnabled to initial mode.
12. Unload the module.</automation_approch>
    ...
    <test_script>TS_WIFIAGENT_2.4GHzSetSAEPassPhrase_WithWPA3SecurityModes</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_2.4GHzSetSAEPassPhrase_WithWPA3SecurityModes');
