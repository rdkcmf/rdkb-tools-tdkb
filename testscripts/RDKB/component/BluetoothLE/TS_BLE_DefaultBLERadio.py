...
<xml>
  ...
  <name>TS_BLE_DefaultBLERadio</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check if the default value of Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.BLERadio after factory reset is False</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Check if the default value of Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.BLERadio after factory reset is False</test_objective>
    ...
    <input_parameters>Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.BLERadio 
...
9. Unload tdkbtr181 module</automation_approch>
    <expected_output>Default value of Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.BLERadio after factory reset should be True</expected_output>
    <priority>High</priority>
    <test_stub_interface>tdkbtr181</test_stub_interface>
    <test_script>TS_BLE_DefaultBLERadio</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_BLE_DefaultBLERadio');
obj1.configureTestCase(ip,port,'TS_BLE_DefaultBLERadio');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if expectedresult in actualresult:
        ...
        if BLERadioOrg == "false":
            ...
            if expectedresult in actualresult:
                ...
                print "EXPECTED RESULT 2: Should set the enable status of BLERadio as true";
                print "ACTUAL RESULT 2: BLERadio set is success";
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : SUCCESS";
            else:
                #Set the result status of execution
	...
	#save device's current state before it goes for reboot
	    ...
	    tdkTestObj = obj.createTestStep('TDKB_TR181Stub_Get');
    	    ...
    	    if expectedresult in actualresult and newBLERadio == "false":
    	        #Set the result status of execution
    	        tdkTestObj.setResultStatus("SUCCESS");
    	        print "TEST STEP 4: Get the enable status of BLERadio after factory reset";
    	        print "EXPECTED RESULT 4: Should get the default enable status of BLERadio as false"
    	        print "ACTUAL RESULT 4: Default BLERadio Enable status is %s" %newBLERadio;
    	        #Get the result of execution
    	        print "[TEST EXECUTION RESULT] : SUCCESS";
	    else:
		#Set the result status of execution
            ...
            if expectedresult in actualresult:
                #Set the result status of execution
                tdkTestObj.setResultStatus("SUCCESS");
                print "TEST STEP 5: Revert  enable status of BLERadio same as previous status";
                print "EXPECTED RESULT 5: Should revert the enable status of BLERadio same as previous status";
                print "ACTUAL RESULT 5: BLERadio revert is success";
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : SUCCESS";
            else:
                #Set the result status of execution
                ...
                print "TEST STEP 5: Revert  enable status of BLERadio same as previous status";
                print "EXPECTED RESULT 5: Should revert the enable status of BLERadio same as previous status";
                print "ACTUAL RESULT 5: BLERadio revert failed";
                #Get the result of execution
                print "[TEST EXECUTION RESULT] : FAILURE";
