...
int wifi_getDeclineBARequestEnable(int radioIndex, unsigned char *enable);
int wifi_setDeclineBARequestEnable(int radioIndex, unsigned char enable);
int wifi_getDfsEnable(int radioIndex, unsigned char *enable);
int wifi_setDfsEnable(int radioIndex, unsigned char enable);
int wifi_setRadioDfsRefreshPeriod(int radioIndex, long unsigned int uLongVar);
int wifi_getApBasicAuthenticationMode(int radioIndex, char* output);
int wifi_kickAssociatedDevice(int radioIndex, wifi_device_t* dev);
int wifi_getAssociatedDeviceDetail(int apIndex, int devIndex, wifi_device_t *dev);
int wifi_setDTIMInterval(int radioIndex, int output);
int wifi_getApVlanID(int radioIndex, int* output);
int wifi_pushChannel(int radioIndex, int output);
int wifi_getIndexFromName(char* ssidName, int *output);
